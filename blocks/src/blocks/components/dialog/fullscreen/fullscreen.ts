...
const openButton = document.getElementById('open-dialog-button-fullscreen') as ButtonComponent;
const dialog = document.getElementById('dialog-fullscreen') as IDialogComponent;
const closeIconButton = document.getElementById('close-dialog-icon-button-fullscreen') as IconButtonComponent;
const closeButton = document.getElementById('close-dialog-button-fullscreen') as ButtonComponent;
