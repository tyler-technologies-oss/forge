...
const openButton = document.getElementById('open-dialog-button-top-sheet') as IButtonComponent;
const dialog = document.getElementById('dialog-top-sheet') as IDialogComponent;
const closeIconButton = document.getElementById('close-dialog-icon-button-top-sheet') as IIconButtonComponent;
const closeButton = document.getElementById('close-dialog-button-top-sheet') as IButtonComponent;
