...
const openButton = document.getElementById('open-dialog-button-demo') as IButtonComponent;
const dialog = document.getElementById('dialog-demo') as IDialogComponent;
const closeIconButton = document.getElementById('close-dialog-icon-button-demo') as IIconButtonComponent;
const closeButton = document.getElementById('close-dialog-button-demo') as IButtonComponent;
