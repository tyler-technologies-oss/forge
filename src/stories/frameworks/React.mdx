...
> As for May 2024, React 19 is in beta now has [support for custom elements](https://custom-elements-everywhere.com/#react-beta) natively.
>
> This means that you can use Forge components directly in React without any additional libraries.
