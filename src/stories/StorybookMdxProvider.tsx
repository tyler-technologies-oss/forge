...
export const StorybookMdxComponents: Record<string, FC> = {
  ...
  h1: (props: any) => <h1 {...props} className="forge-typography--headline3" style={{marginTop: '16px'}}>{props.children}</h1>,
  h2: (props: any) => <h2 {...props} className="forge-typography--headline5 forge-docs-core--header1">{props.children}</h2>,
  h3: (props: any) => <h3 {...props} className="forge-typography--subtitle1-secondary forge-docs-core--header2">{props.children}</h3>,
  p: (props: any) => <p {...props} className="forge-typography--body1 forge-docs-core--body1" />,
  ...
  li: ({ children }: any) => <li className="forge-typography--body1" >{children}</li>,
