...
> **Note:** The design for the banner specifically requests that the button's background be white. Due to
...
<Canvas of={BannerStories.CSSOnly} />

To use the CSS-only banner component, include the following CSS file in your project:
