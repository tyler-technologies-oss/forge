...
There is a great website called [Custom Elements Everywhere](https://custom-elements-everywhere.com/) that does a great job at describing this, and they even provide
...
Tyler Technologies makes heavy use of Angular and is by far our most supported framework adapter library. Angular has great built-in compatibility with Web Components,
...
Vue, like Angular, offers great built-in support for Web Components. We do not currently offer an adapter library for Vue at this time.
