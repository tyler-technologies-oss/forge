...
```scss
@use '@tylertech/forge/styles/theme/theme';
@use '@tylertech/forge/styles/theme/theme-values';
...
@mixin theme-properties() {
  ...
  @include theme.provide-theme(theme-values.$property-values-dark);
