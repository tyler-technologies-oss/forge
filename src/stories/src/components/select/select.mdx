...
<PropertyDef name="popupElement" type="IPopoverComponent | undefined" defaultValue="undefined">
...
Gets/sets whether this component is marked as required or not. Setting to `true` will display an asterisk next to the label.
...
<PropertyDef name="floatLabel" type="boolean" defaultValue="&quot;auto&quot;">

Controls the floating state of the label when "inset".
