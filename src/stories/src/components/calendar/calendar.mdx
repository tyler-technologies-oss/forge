import { DefaultTemplate as CalendarDemo } from './templates/default';
...
Sets the range of years selectable in the year menu. The value is two years or offsets from the current year for the start and end of the range, separated by a colon.
...
| `--mdc-theme-border-color`                | Controls the border-color theme color used throughout the component.
