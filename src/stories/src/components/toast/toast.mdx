...
> **Note:** pass `0` to the `duration` property/attribute to force the toast element to stay open indefinitely.
...
<PropertyDef name="dismissible" type="boolean" defaultValue="false">
...
<MethodDef name="show(): void">

  Shows the toast. Does **not** append it to the DOM.

</MethodDef>

<MethodDef name="hide(): Promise<void>">
