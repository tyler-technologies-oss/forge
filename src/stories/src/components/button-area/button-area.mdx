...
| Name      | Values
| :---------| :-----------------
| `click`   | The button area emit a native HTML `click` event whenever it or the slotted button is clicked. Add the listener to the `<forge-button-area>` element to receive all events.
