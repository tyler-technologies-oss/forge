import { DefaultTemplate as FilePickerDemo } from './templates/default';
...
> This component does not display the files the user is attempting to upload. **To see examples of how this is implemented, check out our [file picker recipes page.](https://forge.tylertech.com/recipes/file-picker);
...
<LiveDemo
  codeHtml={FilePickerDefaultCodeHtml()}
  codeTs={FilePickerDefaultCodeTs()}>
  <FilePickerDemo/>
</LiveDemo>
...
<LiveDemo
  codeHtml={FilePickerCompactCodeHtml()}
  codeTs={FilePickerCompactCodeTs()}>
  <FilePickerDemo compact={true} borderless={true}/>
</LiveDemo>
...
| `--mdc-theme-border-color`                          | Controls the border color of the default variant.
