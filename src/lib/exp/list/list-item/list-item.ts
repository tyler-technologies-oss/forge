...
import { ListItemAdapterExp } from './list-item-adapter';
import { ListItemFoundationExp } from './list-item-foundation';
...
export interface IListItemComponentExp extends ICustomElement {
  href: string;
  target: string;
...
declare global {
  interface HTMLElementTagNameMap {
    'forge-list-item-exp': IListItemComponentExp;
  }

  interface HTMLElementEventMap {
    'forge-list-item-exp-select': CustomEvent<IListItemExpSelectEventData>;
  }
}

/**
 * @tag forge-list-item-exp
 * 
 ...
 * 
 * @event {CustomEvent<IListItemExpSelectEventData>} forge-list-item-exp-select - Fires when the list item is selected.
 * 
 ...
 */
@CustomElement({
  name: LIST_ITEM_CONSTANTS_EXP.elementName,
  dependencies: [
    StateLayerComponent,
    FocusIndicatorComponent
  ]
})
export class ListItemComponentExp extends HTMLElement implements IListItemComponentExp {
  public static get observedAttributes(): string[] {
    return [
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.HREF,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.TARGET,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.STATIC,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.NON_INTERACTIVE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.DISABLED,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.SELECTED,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.ACTIVE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.VALUE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.DENSE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.INDENTED,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.TWO_LINE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.THREE_LINE,
      LIST_ITEM_CONSTANTS_EXP.observedAttributes.WRAP
    ];
  }

  private _foundation: ListItemFoundationExp;

  constructor() {
    super();
    attachShadowTemplate(this, template, styles);
    this._foundation = new ListItemFoundationExp(new ListItemAdapterExp(this));
  }
  ...
  public attributeChangedCallback(name: string, oldValue: string, newValue: string): void {
    switch (name) {
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.HREF:
        this.href = newValue;
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.TARGET:
        this.target = newValue;
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.NON_INTERACTIVE:
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.STATIC:
        this.nonInteractive = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.DISABLED:
        this.disabled = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.SELECTED:
        this.selected = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.ACTIVE:
        this.active = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.VALUE:
        this.value = newValue;
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.DENSE:
        this.dense = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.INDENTED:
        this.indented = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.TWO_LINE:
        this.twoLine = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.THREE_LINE:
        this.threeLine = coerceBoolean(newValue);
        break;
      case LIST_ITEM_CONSTANTS_EXP.observedAttributes.WRAP:
