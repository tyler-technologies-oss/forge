 ...
 *
 * @property {SplitViewPanelResizable} resizable - Controls which side of the panel the resize handle appears on.
 * @property {number | string} size - The initial size along the axis of orientation.
 * @property {number | string} min - The smallest size the panel can take along its axis of orientation.
 ...
 * @property {boolean} open - Controls the open state of the panel.
 * @property {boolean} disabled - Whether resize interactions are disabled or enabled.
 * @property {boolean} allowClose - Whether the panel can be closed via keyboard interaction.
 * @property {boolean} autoClose - Whether the panel automatically closes when it reaches a size of 0.
 * @property {number} autoCloseThreshold - The size at which the panel auto closes.
 * 
 * @attribute {SplitViewPanelResizable} resizable - Controls which side of the panel the resize handle appears on.
 * @attribute {number | string} size - The initial size along the axis of orientation.
 * @attribute {number | string} min - The smallest size the panel can take along its axis of orientation.
 ...
 * @attribute {boolean} open - Controls the open state of the panel.
 * @attribute {boolean} disabled - Whether resize interactions are disabled or enabled.
 * @attribute {boolean} allow-close - Whether the panel can be closed via keyboard interaction.
 * @attribute {boolean} auto-close - Whether the panel automatically closes when it reaches a size of 0.
 * @attribute {number} auto-close-threshold - The size at which the panel auto closes.
 * 
 * 
 * @cssprop --forge-split-view-panel-size - The size of the panel along the axis of orientation.
 * @cssprop --forge-split-view-panel-cursor - The cursor to display when hovering over the panel.
 */
@CustomElement({
