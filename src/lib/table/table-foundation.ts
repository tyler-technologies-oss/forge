import { createPredicate, getEventPath, ICustomElementFoundation, isNumber, isObject, ItemManager, matchesPredicate } from '@tylertech/forge-core';
...
export interface ITableFoundation extends ICustomElementFoundation {
  data: any[];
