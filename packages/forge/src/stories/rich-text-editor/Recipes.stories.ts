    ...
    return html`
      ...
      <form class="form-demo" @submit=${handleSubmit}>
        ...
        <div class="form-actions">
          <forge-button type="reset" variant="outlined"><button type="reset">Reset</button></forge-button>
          <forge-button type="submit" variant="raised"><button type="submit">Submit</button></forge-button>
        </div>
    ...
    return html`
      ...
      <div class="output-demo">
        ...
        <div class="output-buttons">
          <forge-button variant="outlined"><button @click=${(e: Event) => show(e, 'json')}>JSON</button></forge-button>
          <forge-button variant="outlined"><button @click=${(e: Event) => show(e, 'html')}>HTML</button></forge-button>
          <forge-button variant="outlined"><button @click=${(e: Event) => show(e, 'markdown')}>Markdown</button></forge-button>
        </div>
