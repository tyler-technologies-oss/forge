...
export const TimeRange: Story = {
  ...standaloneStoryParams,
  render: () => html`
    <forge-date-time-field style="width: 360px" picker="dtf-time-range-picker" time-mode="range" label="Meeting" placeholder="Select date and time range">
...
export const Standalone: Story = {
  ...standaloneStoryParams,
  render: () => html`
    <forge-date-time-field style="width: 320px" label="Date and time" placeholder="Type a date and time">
