...
IconRegistry.define([tylIconPlace, tylIconArrowDropDown]);
...
function setChipsDisabledState(isDisabled: boolean): void {
  const chips = [...simpleChipField.querySelectorAll('forge-chip'), ...autocompleteChipField.querySelectorAll('forge-chip')];
