...
import { defineProcessStepComponent, defineProcessStepperComponent } from './process-stepper/index.js';
...
export * from './process-stepper/index.js';
...
export function defineComponents(): void {
  ...
  defineProfileCardComponent();
  defineProcessStepperComponent();
  defineProcessStepComponent();
