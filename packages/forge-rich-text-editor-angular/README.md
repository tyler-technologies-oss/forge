...
```bash
npm install @tylertech/forge-rich-text-editor-angular @tylertech/forge-rich-text-editor
```
...
```ts
import { ForgeRteModule } from '@tylertech/forge-rich-text-editor-angular';
