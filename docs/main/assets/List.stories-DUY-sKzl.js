import{E as t,x as e}from"./iframe-DvHT05vf.js";import{g as O,s as A,a as V}from"./utils-BkQyWQOx.js";import{I as N,u as D,l as P,v as W,c as q,d as K,s as U,w as Y,x as G,y as J,p as Q}from"./icon-kuXwuZAY.js";import{o as H}from"./style-map-IqHka1N5.js";import{e as r}from"./class-map-CHWzxEPM.js";import{s as X}from"./decorators-BogDvg6r.js";import"./service-adapter-CffG5Lhq.js";import"./list-4e1XYY1E.js";import"./drawer-B9FH5M3o.js";import"./index-5CPwzmQS.js";import"./avatar-BsRR3KLE.js";import"./checkbox-kUFMdwTc.js";import"./label-BLML_zmV.js";import"./button-BWI_T2KS.js";import"./focus-indicator-BkOItUgJ.js";import"./state-layer-gAgMwMHF.js";import"./button-toggle-group-DRjdDVgO.js";import"./icon-button-DAXknCev.js";import"./switch-CFDEw83b.js";import"./expansion-panel-CtPm9dI4.js";const{action:Z}=__STORYBOOK_MODULE_ACTIONS__;N.define([D,P,W,q,K,U,Y,G,J,Q]);const j="forge-list",z="forge-list-item",tt="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",et=Z("forge-list-item-select"),nt={title:"Components/List",render:n=>{const w=V(n),M=w?H(w):t,v=[];for(let i=0;i<4;i++){const a=n.wrap?`List item ${i+1} ${tt}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${a}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${a}</a>`:e`<span>${a}</span>`;v.push(e`
