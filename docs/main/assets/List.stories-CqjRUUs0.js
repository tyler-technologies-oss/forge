import{x as e,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as R}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{a as _,g,s as C}from"./utils-K-xB8EYC.js";import{I as N}from"./icon-CiIDkczu.js";import{k as V,c as F,l as M,j as P,m as D,n as H,o as W,p as q,g as z}from"./index-CWt9cj6R.js";import{t as B}from"./index-fxMNKkgx.js";import{o as G}from"./style-map-D0ILlpbs.js";import{s as J}from"./decorators-CJfHUot4.js";import"./constants-BMnwgo1j.js";import"./list-CoNOG_pF.js";import"./drawer-CPahDgEn.js";import"./index-Dh0vMUMR.js";import"./avatar-ByFQ3pzx.js";import"./checkbox-D7eDHrDc.js";import"./label-D6-42vki.js";import"./button-CvtGTUrx.js";import"./focus-indicator-WHVXAnYX.js";import"./state-layer-CoXZFfb6.js";import"./button-toggle-group-5oeOUIjG.js";import"./icon-button-HggojrXv.js";import"./switch-CcHPf55S.js";import"./expansion-panel-Bqyu8R51.js";N.define([V,F,M,P,B,D,H,W,q,z]);const d="forge-list",p="forge-list-item",K="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",Q=R("forge-list-item-select"),U={title:"Components/List",render:t=>{const m=_(t),O=m?G(m):i,c=[];for(let o=0;o<4;o++){const f=t.wrap?`List item ${o+1} ${K}`:`List item ${o+1}`,A=t.variant==="button"?e`<button type="button" .disabled=${t.disabled}>${f}</button>`:t.variant==="anchor"?e`<a href="javascript: void(0);">${f}</a>`:e`<span>${f}</span>`;c.push(e`
