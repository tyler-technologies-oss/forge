import"./feature-detection-CY6TVbRZ.js";import{I as m}from"./icon-D5yjdXv8.js";import"./index-CiLSBptl.js";import{z as g,A as p}from"./index-RsKXMDm2.js";import"./lit-element-CYrSCkDY.js";import{x as h}from"./lit-html-CuBe1DX_.js";import{e as u}from"./class-map-CuXcqkpw.js";import{g as _,c as b}from"./utils-CXSdATrE.js";import"./switch-Clw9p9oC.js";m.define([g,p]);const r="forge-switch",y={title:"Components/Switch",render:c=>{var o=b(r,c);return o.textContent="off/on",o},component:r,parameters:{actions:{disable:!0}},argTypes:{..._({tagName:r,exclude:["icon","form","labels","name","on","defaultOn","selected"],controls:{labelPosition:{control:"select",options:["start","end"]}}})}},e={},s={parameters:{controls:{include:["on","dense","disabled"]}},args:{checked:!1,dense:!1,disabled:!1},render:({checked:c,dense:o,disabled:f})=>h`
