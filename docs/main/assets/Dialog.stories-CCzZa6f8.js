import"./constants-DjE6emXm.js";import{D as o}from"./dialog-CnAjkfPt.js";import"./backdrop-BKmy5m9d.js";import{I as N}from"./icon-DHpZ4R73.js";import"./index-Dh0vMUMR.js";import{x as w}from"./index-ByifSpfC.js";import"./lit-element-Dk2-kgKT.js";import{Q as F,k as P}from"./lit-html-DZH-Jm0H.js";import{R as Y}from"./class-map-D93gIiBE.js";import{s as G}from"./decorators-DvEJi2JG.js";import{c as H,g as U}from"./utils-CRuDW25z.js";import{a}from"./chunk-454WOBUV-CM0pFb8Z.js";import"./icon-button-XdSjYqUR.js";import"./focus-indicator-_fDu4ZqT.js";import"./state-layer-DTKAXCUq.js";import"./button-C5f1g9CL.js";import"./scaffold-R2qvsZCm.js";import"./toolbar-CtEd8mqT.js";const j=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=H("forge-dialog",f);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
...
}`,...($=(L=c.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};var A,O,k;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    preset: 'bottom-sheet'
  }
}`,...(k=(O=d.parameters)==null?void 0:O.docs)==null?void 0:k.source}}};var q,I,R;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    fullscreen: true
  }
}`,...(R=(I=g.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};var _,z,M;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      mode: {
        control: 'select',
