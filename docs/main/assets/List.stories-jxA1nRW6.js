import"./lit-element-Dk2-kgKT.js";import{k as e,D as t}from"./lit-html-DZH-Jm0H.js";import{a as st}from"./chunk-454WOBUV-CM0pFb8Z.js";import{b as Z,g as j,s as tt}from"./utils-DY7h9u6A.js";import{I as rt}from"./icon-DHpZ4R73.js";import{o as at,f as lt,p as ct,m as dt,n as gt,q as mt,r as ft,s as ht,j as pt}from"./index-ByifSpfC.js";import{t as bt}from"./index-fxMNKkgx.js";import{s as et}from"./style-map-DxfbqtuX.js";import{R as a}from"./class-map-D93gIiBE.js";import{s as ut}from"./decorators-DvEJi2JG.js";import"./constants-DjE6emXm.js";import"./list-C2bUECg8.js";import"./drawer-BaSOALQ_.js";import"./index-Dh0vMUMR.js";import"./avatar-Cja6atCs.js";import"./checkbox-DohAEIBZ.js";import"./label-BKvMlVMw.js";import"./button-C5f1g9CL.js";import"./focus-indicator-_fDu4ZqT.js";import"./state-layer-DTKAXCUq.js";import"./button-toggle-group-BJ7gYCrU.js";import"./icon-button-XdSjYqUR.js";import"./switch-BL3gYf9s.js";import"./expansion-panel-Da14WzAs.js";rt.define([at,lt,ct,dt,bt,gt,mt,ft,ht,pt]);const z="forge-list",O="forge-list-item",$t="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",wt=st("forge-list-item-select"),vt={title:"Components/List",render:n=>{const w=Z(n),M=w?et(w):t,v=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${$t}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;v.push(e`
  ...
  `)],argTypes:{...j({tagName:z,exclude:["active","noninteractive"]}),variant:{control:{type:"select"},options:["anchor","button","static"]},...j({tagName:O,exclude:["active","value","noninteractive"]}),selectedValue:{control:{type:"select"},options:["list-item-1","list-item-2","list-item-3","list-item-4"]},disabled:{control:{type:"boolean"},if:{arg:"variant",eq:"button"}}},args:{variant:"static",withStartIcon:!1,withEndIcon:!1,withAvatar:!1,withStartCheckbox:!1,withEndCheckbox:!1,withStartRadio:!1,withEndRadio:!1,withStartSwitch:!1,withEndSwitch:!1,disabled:!1,dense:!1,indented:!1,twoLine:!1,threeLine:!1,wrap:!1,selected:!1}},f={},h={args:{variant:"button"}},p={args:{variant:"anchor"}},b={...tt,render:()=>e`
    ...
    `},$={render:({variant:n,indented:w,wrap:M,dense:v,disabled:i,twoLine:r,threeLine:o,withStartIcon:x,withEndIcon:_,withAvatar:_t,withStartCheckbox:y,withEndCheckbox:I,withStartRadio:L,withEndRadio:S,withStartSwitch:T,withEndSwitch:k,selectedValue:E,...nt})=>{const C=Z(nt),it=C?et(C):t,ot={"forge-list":!0,"forge-list--indented":w,"forge-list--wrap":M,"forge-list--dense":v,"forge-list--two-line":r,"forge-list--three-line":o},l=({area:s})=>e`<svg class=${a({"forge-icon":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Forge design system logo</title><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.9 3.2h-7.5c-.4 0-.7.2-.9.5l-1.6 2.9c-.3.5-.1 1.2.4 1.5.2.1.4.1.5.1h7.5c.4 0 .7-.2.9-.5l1.6-2.9c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.1-.5-.1zm-3.6 6.2H9.8c-.4 0-.8.2-1 .6l-1.6 2.7c-.2.3-.2.8 0 1.1l3.8 6.5c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l5.3-9.2c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.2-.5-.2zm-6.9-4.6c.3-.5.1-1.2-.4-1.5-.2-.1-.4-.1-.6-.1H3c-.6 0-1.1.5-1.1 1.1 0 .2.1.4.1.5l2.7 4.6.5.9c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l3.3-5.5z"/></svg>`,c=({area:s,id:m})=>e`<div class=${a({"forge-checkbox":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})}>
      ...
      <div class="list-demo" style=${it}>
        <ul class=${a(ot)}>
          <li class=${a({"forge-list-item":!0,"forge-list-item--selected":E==="list-item-1"})}>
            ${x?l({area:"start"}):t}
            ...
            ${k?g({area:"end",id:"li-sw-1"}):t}
          </li>
          <li class=${a({"forge-list-item":!0,"forge-list-item--selected":E==="list-item-2"})}>
            ${x?l({area:"start"}):t}
            ...
            ${k?g({area:"end",id:"li-sw-2"}):t}
          </li>
          <li class=${a({"forge-list-item":!0,"forge-list-item--selected":E==="list-item-3"})}>
            ${x?l({area:"start"}):t}
            ...
            ${k?g({area:"end",id:"li-sw-3"}):t}
          </li>
          <li class=${a({"forge-list-item":!0,"forge-list-item--selected":E==="list-item-4"})}>
            ${x?l({area:"start"}):t}
            ...
            ${k?g({area:"end",id:"li-sw-4"}):t}
          </li>
        </ul>
      </div>
    `}};var A,V,H;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:"{}",...(H=(V=f.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var R,F,B;h.parameters={...h.parameters,docs:{...(R=h.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    variant: 'button'
  }
}`,...(B=(F=h.parameters)==null?void 0:F.docs)==null?void 0:B.source}}};var N,D,P;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    variant: 'anchor'
  }
}`,...(P=(D=p.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};var W,q,G;b.parameters={...b.parameters,docs:{...(W=b.parameters)==null?void 0:W.docs,source:{originalSource:`{
