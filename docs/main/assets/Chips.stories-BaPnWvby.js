import{I as b,h as $,i as y,j as S,k as A}from"./icon-Uwxy940_.js";import{E as n,x as t}from"./iframe-TK8e1Aaz.js";import{o as h}from"./style-map-Dgjp8MB5.js";import{e as c}from"./class-map-CzvfW8is.js";import{g,G as _,a as u}from"./utils-f-9lfKsg.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-D_Xb1ibY.js";import"./chip-set-CRWUNY7s.js";import"./focus-indicator-r6jPcSl0.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
