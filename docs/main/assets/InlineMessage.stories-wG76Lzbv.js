import{x as r,E as l}from"./iframe-CTkCllpu.js";import{g as p,s as g,G as u,c as f,a as v}from"./utils-f-9lfKsg.js";import"./service-adapter-CffG5Lhq.js";import{I as h,s as x}from"./icon-Uwxy940_.js";import"./index-DTwfV0k0.js";import{o as y}from"./style-map-CeqcTeQ5.js";import"./inline-message-e4Sp2zCL.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...p({tagName:t,controls:{theme:{control:{type:"select"},options:u}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
