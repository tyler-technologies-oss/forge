import"./lit-element-CYrSCkDY.js";import{E as i,x as c}from"./lit-html-CuBe1DX_.js";import{a as x}from"./index-B-lxVbXh.js";import{g as D,s as l,b as O}from"./utils-wd6cBJ9K.js";import{o as V}from"./style-map-CeP1Mntv.js";import{n as j}from"./index-RsKXMDm2.js";import{t as k}from"./index-fxMNKkgx.js";import{I as E}from"./icon-D5yjdXv8.js";import"./feature-detection-CY6TVbRZ.js";import"./tab-bar-BcTLttPU.js";const m="forge-tab-bar",W=x("forge-tab-bar-change"),w=x("forge-tab-select");E.define([j,k]);const F={title:"Components/Tabs",render:e=>{const n={...O(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const B=Object.entries(n).length?V(n):i,C=Array.from({length:e.scrollButtons?20:3}).map((L,P)=>c`<forge-tab>
