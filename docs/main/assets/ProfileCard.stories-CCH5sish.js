import{x as o}from"./iframe-BnNJ1c1D.js";import{I as r,g as t}from"./icon-kuXwuZAY.js";import{s as i}from"./decorators-D1sM3mtL.js";import"./service-adapter-CffG5Lhq.js";import"./card-DcVk1ksh.js";import"./button-n5lu2Cl0.js";import"./focus-indicator-Di6NUjCA.js";import"./state-layer-gAgMwMHF.js";import"./icon-button-DfbAxSv9.js";import"./index-5CPwzmQS.js";import"./toolbar-U0axkpKl.js";const a="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";r.define(t);const n={title:"Recipes/Card/Profile",decorators:[i(a)],render:()=>o`
    <forge-card>
      <div class="container">
        <div class="avatar">
