import{I as b,h as $,i as y,j as S,k as A}from"./icon-kuXwuZAY.js";import{E as n,x as t}from"./iframe-B8zg2wYV.js";import{o as h}from"./style-map-CHnVwOO4.js";import{e as c}from"./class-map-tU5YBpOZ.js";import{g,G as _,a as u}from"./utils-CxJfPz5j.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-DRWYbyA5.js";import"./chip-set-VAfmZU9u.js";import"./focus-indicator-Ds03J1-R.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
