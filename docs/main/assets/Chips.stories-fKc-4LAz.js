import{I as b,h as $,i as y,j as S,k as A}from"./icon-kuXwuZAY.js";import{E as n,x as t}from"./iframe-CEEPYUDx.js";import{o as h}from"./style-map-hTTnOORa.js";import{e as c}from"./class-map-B58L_GlP.js";import{g,G as _,a as u}from"./utils-BR-ouvDH.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-DPUrpprj.js";import"./chip-set-Boj1lkjX.js";import"./focus-indicator-DHIn80Ep.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
