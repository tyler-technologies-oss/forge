import{x as e,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as R}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{a as _,g,s as C}from"./utils-Cceq4NFH.js";import{I as N}from"./icon-CRQudG-b.js";import{n as V,f as F,o as M,m as P,p as D,q as H,r as W,s as q,j as z}from"./index-TSSE1zcJ.js";import{t as B}from"./index-fxMNKkgx.js";import{o as G}from"./style-map-D0ILlpbs.js";import{s as J}from"./decorators-EVhofM2Q.js";import"./constants-D32Jr2uy.js";import"./list-dUPbNzHI.js";import"./drawer-DOjyXyQF.js";import"./index-Dh0vMUMR.js";import"./avatar-DwiD4Mn-.js";import"./checkbox-Chjo1vae.js";import"./label-CcpeGv-c.js";import"./button-BF9wbu_o.js";import"./focus-indicator-DCOk5mvy.js";import"./state-layer-BRvIemvG.js";import"./button-toggle-group-b68KB2vb.js";import"./icon-button-BIREJzI3.js";import"./switch-DWALD2Z-.js";import"./expansion-panel-D2Iuz2e0.js";N.define([V,F,M,P,B,D,H,W,q,z]);const d="forge-list",p="forge-list-item",K="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",Q=R("forge-list-item-select"),U={title:"Components/List",render:t=>{const m=_(t),O=m?G(m):i,c=[];for(let o=0;o<4;o++){const f=t.wrap?`List item ${o+1} ${K}`:`List item ${o+1}`,A=t.variant==="button"?e`<button type="button" .disabled=${t.disabled}>${f}</button>`:t.variant==="anchor"?e`<a href="javascript: void(0);">${f}</a>`:e`<span>${f}</span>`;c.push(e`
