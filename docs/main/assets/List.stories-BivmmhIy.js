import"./lit-element-JplMEnZc.js";import{x as e,E as t}from"./lit-html-paDGiEfB.js";import{a as st}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{b as Z,g as j,s as tt}from"./utils-BbKlM6X4.js";import{I as rt}from"./icon-DB7kP3Ec.js";import{o as at,f as lt,p as ct,m as dt,n as gt,q as mt,r as ft,s as ht,j as pt}from"./index-ByifSpfC.js";import{t as bt}from"./index-fxMNKkgx.js";import{o as et}from"./style-map-C9nPWcxA.js";import{e as a}from"./class-map-D55lQyt8.js";import{s as ut}from"./decorators-DOnQS6BC.js";import"./feature-detection-DRCh51Sa.js";import"./list-ByS02Pjt.js";import"./drawer-CNuX1Oi_.js";import"./index-BmocOEUj.js";import"./avatar-D_XGi29H.js";import"./checkbox-DKABHoWa.js";import"./label-BV_ZyirU.js";import"./button-DaDzbT7D.js";import"./focus-indicator-DzT8BbE-.js";import"./state-layer-IxmMcKDT.js";import"./button-toggle-group-BMa49BMk.js";import"./icon-button-Cj-mvUQ9.js";import"./switch-BXC-NkYO.js";import"./expansion-panel-CM9p7cL3.js";rt.define([at,lt,ct,dt,bt,gt,mt,ft,ht,pt]);const z="forge-list",O="forge-list-item",$t="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",wt=st("forge-list-item-select"),vt={title:"Components/List",render:n=>{const w=Z(n),M=w?et(w):t,v=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${$t}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;v.push(e`
