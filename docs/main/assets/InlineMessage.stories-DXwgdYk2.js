import{x as f}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as h,g as y,s as x,G as v}from"./utils-BeGdvWla.js";import"./constants-DjE6emXm.js";import{I as Q}from"./icon-DjINFoyU.js";import"./index-Dh0vMUMR.js";import{n as S}from"./index-CIZ3m0iD.js";import"./inline-message-qfCQAk-7.js";const s="forge-inline-message";Q.define(S);const I={title:"Components/Inline Message",render:o=>{const a=h(s,o);return a.textContent=o.text,a},component:s,parameters:{actions:{disable:!0}},argTypes:{...y({tagName:s,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},e={},n={...x,render:({text:o})=>f`
