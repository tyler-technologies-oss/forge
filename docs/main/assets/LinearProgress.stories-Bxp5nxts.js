import{x as u}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as S,g as y,s as f}from"./utils-SjbeXOvg.js";import"./constants-CmaEVTEu.js";import"./linear-progress-DkhIk2Qx.js";const a="forge-linear-progress",L={title:"Components/Linear Progress",render:b=>{const o=S(a,b);return o.setAttribute("aria-label","Linear progress demo"),o},component:a,parameters:{actions:{disable:!0}},argTypes:{...y({tagName:a})},args:{}},r={},e={...f,render:()=>u` <forge-linear-progress determinate progress="0.5" aria-label="Linear progress demo"></forge-linear-progress> `},s={...f,render:()=>u` <forge-linear-progress determinate progress="0.33" buffer="0.66" aria-label="Linear progress buffer demo"></forge-linear-progress> `};var t,n,m;r.parameters={...r.parameters,docs:{...(t=r.parameters)==null?void 0:t.docs,source:{originalSource:"{}",...(m=(n=r.parameters)==null?void 0:n.docs)==null?void 0:m.source}}};var i,p,g;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
