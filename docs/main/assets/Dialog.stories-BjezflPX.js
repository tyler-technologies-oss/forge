import"./feature-detection-CY6TVbRZ.js";import{D as o}from"./dialog-C3DUV3Gv.js";import"./backdrop-jq8rFG8Z.js";import{I as N}from"./icon-D5yjdXv8.js";import"./index-CiLSBptl.js";import{A as w}from"./index-RsKXMDm2.js";import"./lit-element-CYrSCkDY.js";import{x as P,B as F}from"./lit-html-CuBe1DX_.js";import{e as Y}from"./class-map-CuXcqkpw.js";import{s as G}from"./decorators-CS5VvIVh.js";import{c as H,g as U}from"./utils-wd6cBJ9K.js";import{a}from"./index-B-lxVbXh.js";import"./icon-button-4fx-LScl.js";import"./focus-indicator-NbLDNrYT.js";import"./state-layer-sxQMIn2c.js";import"./button-CutPPNni.js";import"./scaffold-BHN26cwL.js";import"./toolbar-D4yu8hpj.js";const j=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=H("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
...
}`,...(q=(O=d.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var M,I,_;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    fullscreen: true
  }
