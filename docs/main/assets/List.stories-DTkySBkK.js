import{x as e,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as R}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{a as _,g,s as C}from"./utils-Dtr3SQvK.js";import{I as N}from"./icon-DHVNhAh1.js";import{o as V,f as F,p as M,m as P,n as D,q as H,r as W,s as q,j as z}from"./index-CIZ3m0iD.js";import{t as B}from"./index-fxMNKkgx.js";import{o as G}from"./style-map-D0ILlpbs.js";import{s as J}from"./decorators-EVhofM2Q.js";import"./constants-ngK8be3i.js";import"./list-w9uxrOZD.js";import"./drawer-Bpov1tN_.js";import"./index-Dh0vMUMR.js";import"./avatar-CwCdFbd4.js";import"./checkbox-BCGc4uqs.js";import"./label-BSpLsvKH.js";import"./button-GqT3ELiS.js";import"./focus-indicator-C4Z5XP1c.js";import"./state-layer-BisR_hRI.js";import"./button-toggle-group-BCHiADOy.js";import"./icon-button-DNIpFQC2.js";import"./switch-BtH834SF.js";import"./expansion-panel-BGj9a3C4.js";N.define([V,F,M,P,B,D,H,W,q,z]);const d="forge-list",p="forge-list-item",K="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",Q=R("forge-list-item-select"),U={title:"Components/List",render:t=>{const m=_(t),O=m?G(m):i,c=[];for(let o=0;o<4;o++){const f=t.wrap?`List item ${o+1} ${K}`:`List item ${o+1}`,A=t.variant==="button"?e`<button type="button" .disabled=${t.disabled}>${f}</button>`:t.variant==="anchor"?e`<a href="javascript: void(0);">${f}</a>`:e`<span>${f}</span>`;c.push(e`
