import"./lit-element-CgJqSpuc.js";import{E as i,x as c}from"./lit-html-paDGiEfB.js";import{a as x}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{b as j,g as D,s as l}from"./utils-BotWY70o.js";import{o as O}from"./style-map-C9nPWcxA.js";import{j as V}from"./index-ByifSpfC.js";import{t as k}from"./index-fxMNKkgx.js";import{I as E}from"./icon-FszQmWVN.js";import"./constants-CFf81ck9.js";import"./tab-bar-BCdqTWWu.js";const m="forge-tab-bar",W=x("forge-tab-bar-change"),w=x("forge-tab-select");E.define([V,k]);const F={title:"Components/Tabs",render:e=>{const n={...j(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const B=Object.entries(n).length?O(n):i,C=Array.from({length:e.scrollButtons?20:3}).map((L,P)=>c`<forge-tab>
