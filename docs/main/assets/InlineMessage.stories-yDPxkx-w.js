import"./lit-element-CgJqSpuc.js";import{x as r,E as l}from"./lit-html-paDGiEfB.js";import{c as Q,g as C,s as I,b as z,G as M}from"./utils-BY68bB8K.js";import"./constants-CFf81ck9.js";import{I as A}from"./icon-FszQmWVN.js";import"./index-BmocOEUj.js";import{n as O}from"./index-ByifSpfC.js";import{o as V}from"./style-map-C9nPWcxA.js";import"./inline-message-CWU9IALL.js";const t="forge-inline-message";A.define(O);const $={title:"Components/Inline Message",render:e=>{const a=Q(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...C({tagName:t,controls:{theme:{control:{type:"select"},options:M}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...I,render:({text:e})=>r`
