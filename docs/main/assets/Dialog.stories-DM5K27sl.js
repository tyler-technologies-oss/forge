import{j as R,x as P}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as l}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{y as k}from"./index-TSSE1zcJ.js";import{I as z}from"./icon-DdNu5rAq.js";import{c as M,g as Y}from"./utils-SjbeXOvg.js";import"./constants-CmaEVTEu.js";import"./icon-button-Cqg7QjNu.js";import"./focus-indicator-CexacDHl.js";import"./index-Dh0vMUMR.js";import"./state-layer-DjEoH8hN.js";import"./button-DqH9YfaW.js";import{D as o}from"./dialog-CONMYZvL.js";import"./backdrop-CtoG1b-d.js";import"./scaffold-D4eQ8OsK.js";import"./toolbar-Ckx80VFe.js";import{s as j}from"./decorators-CJfHUot4.js";const F=l("forge-dialog-close"),G=l("forge-dialog-before-close"),q=l("forge-dialog-move-start"),w=l("forge-dialog-move"),B=l("forge-dialog-move-end"),$=I=>{z.define(k);const d=document.createElement("div"),c=document.createElement("forge-button");c.variant="raised",c.innerText="Open dialog",c.addEventListener("click",()=>e.open=!0),d.appendChild(c);const e=M("forge-dialog",I);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",N=>{F(N),e.open=!1}),e.addEventListener("forge-dialog-before-close",G),e.addEventListener("forge-dialog-move-start",q),e.addEventListener("forge-dialog-move",w),e.addEventListener("forge-dialog-move-end",B),d.appendChild(e);const x=P`
    <forge-scaffold>
