import"./service-adapter-CffG5Lhq.js";import{D as o}from"./dialog-CGP43TQA.js";import"./backdrop-CaFxRXEM.js";import{I as h,C as b}from"./tyler-icons-CBdZU-Tr.js";import"./index-DTwfV0k0.js";import{b as y,D as S}from"./iframe-Dth6_egW.js";import{e as E}from"./class-map-Bd6-8ZDp.js";import{s as T}from"./decorators-Jd5OEl0M.js";import{c as C,g as D}from"./utils-CWixVBNc.js";import"./icon-button-CF_eJVHZ.js";import"./focus-indicator-B-dA_pS-.js";import"./state-layer-DGD4bZzf.js";import"./button-CCXfLiyX.js";import"./scaffold-CspBWUuL.js";import"./toolbar-DM62Euqg.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),L=a("forge-dialog-before-close"),x=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=C("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",L),e.addEventListener("forge-dialog-move-start",x),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
