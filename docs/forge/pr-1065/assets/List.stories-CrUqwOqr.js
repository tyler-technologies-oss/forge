import{A as t,b as e}from"./iframe-B5XvQRU6.js";import{s as O,b as V,g as z}from"./utils-CbU1ENex.js";import{I as P,u as D,l as W,v as q,d as K,t as U,s as Y,w as G,x as J,y as Q,p as X}from"./tyler-icons-CBdZU-Tr.js";import{o as H}from"./style-map-FQ6vWITG.js";import{e as a}from"./class-map-IsaJv0mY.js";import{s as Z}from"./decorators-D96Mc7ku.js";import"./service-adapter-CffG5Lhq.js";import"./list-ClcgP27W.js";import"./drawer-D79-TANn.js";import"./index-DTwfV0k0.js";import"./avatar-BdtYvV7l.js";import"./checkbox-CaYb8270.js";import"./label-BZ12QAw3.js";import"./button-Bm8BiMvu.js";import"./focus-indicator-BCZS7QTD.js";import"./state-layer-DGD4bZzf.js";import"./button-toggle-group-CMqjJA2E.js";import"./icon-button-CZj7QIrK.js";import"./switch-Bz-qPRzf.js";import"./expansion-panel-huBiB0DZ.js";import"./open-icon-BIuINibX.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
