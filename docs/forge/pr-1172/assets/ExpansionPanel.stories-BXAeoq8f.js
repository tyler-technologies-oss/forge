import{b as p,A as b}from"./iframe-DVkCwayn.js";import{s as x,g as q,b as v}from"./utils-DdM9-TOU.js";import{o as y}from"./style-map-BF6zZzkZ.js";import{n as c,e as m}from"./ref-s-JXIu1k.js";import{e as $}from"./class-map-3YYmKfcP.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Dzu2UNzD.js";import"./open-icon-C63OJEFz.js";import"./card-Cz1s75aV.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
