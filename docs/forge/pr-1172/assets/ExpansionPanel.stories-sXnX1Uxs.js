import{b as p,A as b}from"./iframe-Ct7_Im3r.js";import{s as x,g as q,b as v}from"./utils-YUGVIsXY.js";import{o as y}from"./style-map-B8AA-CCH.js";import{n as c,e as m}from"./ref-5hIHDzHG.js";import{e as $}from"./class-map-BnItZqTF.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DKywKqIa.js";import"./open-icon-qT7GFCH0.js";import"./card-Cd2DEfI2.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
