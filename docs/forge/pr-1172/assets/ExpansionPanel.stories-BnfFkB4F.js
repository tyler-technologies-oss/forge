import{b as p,A as b}from"./iframe-ZvzVysMB.js";import{s as x,g as q,b as v}from"./utils-D5x2rMta.js";import{o as y}from"./style-map-BYFhBNXo.js";import{n as c,e as m}from"./ref-9F0ZFO8q.js";import{e as $}from"./class-map-DS_zoLL-.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DR1Mvixy.js";import"./open-icon-DjVhjUr1.js";import"./card-B0LsWTph.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
