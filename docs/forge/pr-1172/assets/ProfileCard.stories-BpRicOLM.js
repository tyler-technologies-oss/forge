import{b as o}from"./iframe-DQLkTsj5.js";import{I as r,k as t}from"./tyler-icons-DPuUJ4cJ.js";import{s as a}from"./decorators-OLNLdARR.js";import"./service-adapter-DlT-lJx7.js";import"./card-C3gFyNEB.js";import"./button-DT_Na7FY.js";import"./icon-button-CMY5cmct.js";import"./toolbar-Bm2frJkv.js";const i="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";r.define(t);const n={title:"Recipes/Card/Profile",decorators:[a(i)],render:()=>o`
    <forge-card>
      <div class="container">
        <div class="avatar">
