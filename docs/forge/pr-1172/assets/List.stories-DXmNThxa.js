import{A as t,b as e}from"./iframe-BaLQ_A2d.js";import{s as O,b as V,g as z}from"./utils-CElmhe9Y.js";import"./service-adapter-DlT-lJx7.js";import{I as P,e as D,f as W,g as q,d as K,t as U,w as Y,x as G,y as J,z as Q,s as X}from"./tyler-icons-DfIaYIv7.js";import{o as H}from"./style-map-CyLVt2T4.js";import{e as a}from"./class-map-Bpya0c63.js";import{s as Z}from"./decorators-Dq8gzDyS.js";import"./list-CtFWDf9k.js";import"./list-item-Bra_7jX-.js";import"./drawer-seV_42ug.js";import"./avatar-BzhNyOik.js";import"./checkbox-DQTRdMdm.js";import"./key-action-lsAysfb-.js";import"./index-5CPwzmQS.js";import"./radio-group-BqfKTB-V.js";import"./label-BIsRcMc6.js";import"./switch-aCewe0Hv.js";import"./expansion-panel-B_L_Rszi.js";import"./open-icon-Z3xYPoD8.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
