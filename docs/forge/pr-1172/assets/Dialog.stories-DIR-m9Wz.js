import"./service-adapter-DlT-lJx7.js";import{a as o}from"./dialog-D41xgR_D.js";import{I as h,D as b}from"./tyler-icons-DPuUJ4cJ.js";import{b as y,D as S}from"./iframe-DQLkTsj5.js";import{e as E}from"./class-map-EigTEi9S.js";import{s as T}from"./decorators-OLNLdARR.js";import{c as D,g as C}from"./utils-RooUwGan.js";import"./icon-button-CMY5cmct.js";import"./button-DT_Na7FY.js";import"./scaffold-D8DtzjhO.js";import"./toolbar-Bm2frJkv.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),L=a("forge-dialog-before-close"),x=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=D("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",L),e.addEventListener("forge-dialog-move-start",x),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
...
}`,...m.parameters?.docs?.source}}};const z=["Demo","RightSheet","LeftSheet","TopSheet","BottomSheet","Fullscreen","CSSOnly"],K=Object.freeze(Object.defineProperty({__proto__:null,BottomSheet:d,CSSOnly:m,Demo:l,Fullscreen:g,LeftSheet:i,RightSheet:n,TopSheet:c,__namedExportsOrder:z,default:k},Symbol.toStringTag,{value:"Module"}));export{m as C,K as D,l as a};
