import{A as r,b as t}from"./iframe-BaLQ_A2d.js";import{s as o,b as $,g as S}from"./utils-CElmhe9Y.js";import{o as h}from"./style-map-CyLVt2T4.js";import{I as A,s as I,t as _}from"./tyler-icons-DfIaYIv7.js";import"./service-adapter-DlT-lJx7.js";import"./tab-panel-COnKVwN9.js";const{action:y}=__STORYBOOK_MODULE_ACTIONS__,v="forge-tab-bar",p=y("forge-tab-bar-change"),u=y("forge-tab-activate");A.define([I,_]);const B={title:"Components/Tabs",render:e=>{const a={...$(e)};e.vertical?a["max-width"]="200px":e.scrollButtons&&(a["max-width"]="500px");const f=Object.entries(a).length?h(a):r,m=Array.from({length:e.scrollButtons?20:3}).map((T,d)=>t`<forge-tab>
