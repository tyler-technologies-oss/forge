import{b as p,A as b}from"./iframe-BxUalrPu.js";import{s as x,g as q,b as v}from"./utils-u3kxOSSj.js";import{o as y}from"./style-map-CFHob2v6.js";import{n as c,e as m}from"./ref-BYfBindC.js";import{e as $}from"./class-map-dsSq2Txk.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DvBkj4vS.js";import"./open-icon-B_3-VfI2.js";import"./card-B9wqRYc9.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
