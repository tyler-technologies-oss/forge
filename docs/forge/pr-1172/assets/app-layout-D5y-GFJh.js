var x=a=>{throw TypeError(a)};var T=(a,o,e)=>o.has(a)||x("Cannot "+e);var r=(a,o,e)=>(T(a,o,"read from private field"),e?e.call(a):o.get(a)),f=(a,o,e)=>o.has(a)?x("Cannot add the same private member more than once"):o instanceof WeakSet?o.add(a):o.set(a,e),p=(a,o,e,i)=>(T(a,o,"write to private field"),i?i.call(a,e):o.set(a,e),e),s=(a,o,e)=>(T(a,o,"access private method"),e);import{r as z,b as m}from"./iframe-DQLkTsj5.js";import{n as S}from"./property-CTzj-79N.js";import{r as I}from"./state-DlRZK4E4.js";import{n as R}from"./query-assigned-nodes-D8SsSM9e.js";import{n as Q}from"./when-CI7b_ccM.js";import{t as Y,C as q,a as j}from"./service-adapter-DlT-lJx7.js";import{K as G,I as K,D as F,U as J}from"./tyler-icons-DPuUJ4cJ.js";import{B as V}from"./base-lit-element-D917_3Iy.js";import{t as d}from"./utils-DU-9AqTO.js";import{A as W,a as X}from"./app-bar-menu-button-Ds3KQZba.js";import{D as Z}from"./dialog-D41xgR_D.js";import{D as ee}from"./drawer-seV_42ug.js";import{M as te}from"./mini-drawer-Bw1AxUWG.js";import{I as re}from"./icon-button-CMY5cmct.js";import{S as ae}from"./scaffold-D8DtzjhO.js";import{T as oe}from"./toolbar-Bm2frJkv.js";const se="data-forge-app-layout-close",ie=":host{--_drawer-width: var(--forge-app-layout-drawer-width, 320px);--_dialog-width: var(--forge-app-layout-dialog-width, 320px);--_mini-drawer-z-index: var(--forge-app-layout-mini-drawer-z-index, 3);display:block;height:100%}forge-app-bar{--forge-app-bar-logo-font-size: 40px;--forge-app-bar-columns: auto 1fr auto}:host(:state(small)) forge-app-bar{--forge-app-bar-row-padding: 0}slot[name=app-bar-logo]{--forge-icon-font-size: var(--forge-app-bar-logo-font-size)}.drawer-container.mini-hover{z-index:var(--_mini-drawer-z-index);overflow:visible}forge-drawer{--forge-drawer-width: var(--_drawer-width)}.close-drawer-button{padding-inline-start:var(--forge-spacing-xxsmall, 4px)}.left-sheet-dialog{--forge-dialog-width: var(--_dialog-width)}.left-sheet-dialog::part(surface){display:block}";var ne=Object.defineProperty,c=(a,o,e,i)=>{for(var g=void 0,u=a.length-1,N;u>=0;u--)(N=a[u])&&(g=N(o,e,g)||g);return g&&ne(o,e,g),g},A,P,B;const U="forge-app-layout";var h,n,t,$,E,L,b,C,_,w,y,D,O,H,k,M;const v=class v extends(B=V,P=q,A=j,B){constructor(){super();f(this,t);f(this,h);f(this,n);f(this,b);f(this,_);f(this,w);f(this,y);f(this,D);this.appTitle="",this.appTitleHref="",this.breakpoint=960,this.useMiniDrawer=!1,this.miniHover=!1,this._leftDrawerOpen=!1,this._isLargeScreen=!1,p(this,h,null),p(this,b,e=>{this._isLargeScreen=e.matches,s(this,t,C).call(this),s(this,t,H).call(this,this._isLargeScreen?"large":"small")}),p(this,_,()=>{this._isLargeScreen||(this._leftDrawerOpen=!this._leftDrawerOpen,d(r(this,n),"drawer-open",this._leftDrawerOpen),d(r(this,n),"drawer-closed",!this._leftDrawerOpen),s(this,t,O).call(this),s(this,t,k).call(this,this._leftDrawerOpen))}),p(this,w,()=>{s(this,t,$).call(this)}),p(this,y,e=>{e.target.name==="navigation"&&this.requestUpdate()}),p(this,D,e=>{e.composedPath().some(u=>u instanceof HTMLElement&&u.hasAttribute(se))&&this.closeDrawer()}),p(this,n,this.attachInternals())}get isLargeScreen(){return this._isLargeScreen}connectedCallback(){super.connectedCallback(),s(this,t,E).call(this)}firstUpdated(e){super.firstUpdated(e),s(this,t,C).call(this),s(this,t,O).call(this)}updated(e){super.updated(e),e.has("breakpoint")&&(s(this,t,L).call(this),s(this,t,E).call(this))}disconnectedCallback(){super.disconnectedCallback(),s(this,t,L).call(this)}closeDrawer(){this._isLargeScreen||s(this,t,$).call(this)}render(){const e=m`<slot name="navigation" @slotchange=${r(this,y)}></slot>`;return m`
      <forge-scaffold>
