import{b as d,A as v}from"./iframe-DYfaiaSN.js";import{o as y}from"./style-map-D7k4fVqL.js";import{n as i,e as s}from"./ref-CR8Qnowg.js";import{e as h}from"./class-map-DvS7WAH5.js";import{s as x,g as b,b as C,O as c}from"./utils-MqJhgfu0.js";import{s as p}from"./decorators-Dmjtae0F.js";import"./service-adapter-8tADcN_b.js";import"./button-ZAHl1mBc.js";import{V as l}from"./overlay-CaDNztMl.js";const S=".clipping-container{height:500px;border:1px solid var(--forge-theme-outline);overflow:auto}.clipping-container.force-containment{transform:translateZ(0);border:2px dashed var(--forge-theme-error)}.clipping-container.use-small-container{height:150px}.overlay-content{width:300px;padding:8px;border:1px dashed var(--forge-theme-primary);background-color:var(--forge-theme-surface)}.scroll-container{height:250%;width:250%;display:flex;align-items:center;justify-content:center}",{action:$}=__STORYBOOK_MODULE_ACTIONS__,m="forge-overlay",E=$("forge-overlay-light-dismiss"),O={title:"Components/Overlay",render:e=>{const o=C(e),u=o?y(o):v,a=s(),r=s(),f={"clipping-container":!0,"force-containment":e.forceContainment,"use-small-container":e.useSmallContainer};window.requestAnimationFrame(()=>{a.value?.scrollIntoView({block:"center",inline:"center"})});function g(){r.value&&(r.value.open=!r.value.open)}return d`
  ...
  `)],render:()=>(document.addEventListener("contextmenu",_),d`
    ...
    `)};function _(e){e.preventDefault();const o=document.getElementById("context-overlay");o.open?o.anchorElement=l.fromEvent(e):(o.anchorElement=l.fromEvent(e),o.open=!0)}n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...t.parameters?.docs?.source}}};const A=["Demo","ContextMenu"],V=Object.freeze(Object.defineProperty({__proto__:null,ContextMenu:t,Demo:n,__namedExportsOrder:A,default:O},Symbol.toStringTag,{value:"Module"}));export{t as C,n as D,V as O};
