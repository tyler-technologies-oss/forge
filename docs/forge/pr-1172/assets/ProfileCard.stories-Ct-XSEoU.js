import{b as o}from"./iframe-DVkCwayn.js";import{I as r,g as t}from"./tyler-icons-Cgf0s-mg.js";import{s as a}from"./decorators-D3I7OoUh.js";import"./service-adapter-8tADcN_b.js";import"./card-Cz1s75aV.js";import"./button-CS24bbOS.js";import"./icon-button-Bo2inTOg.js";import"./toolbar-DdsEVZdr.js";const i="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";r.define(t);const n={title:"Recipes/Card/Profile",decorators:[a(i)],render:()=>o`
    <forge-card>
      <div class="container">
        <div class="avatar">
