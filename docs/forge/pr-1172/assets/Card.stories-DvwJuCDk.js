import{A as m,b as n}from"./iframe-DYfaiaSN.js";import{r as p,s as c,b as g,g as f,c as b}from"./utils-MqJhgfu0.js";import"./service-adapter-8tADcN_b.js";import{I as v,H as y}from"./tyler-icons-Bp7ZiT47.js";import{s as q}from"./decorators-Dmjtae0F.js";import{e as h}from"./class-map-DvS7WAH5.js";import{o as x}from"./style-map-D7k4fVqL.js";import"./card-CUH5-0T0.js";import"./icon-button-D2n_W3_x.js";import"./button-ZAHl1mBc.js";import"./scaffold-l7cEUk27.js";import"./toolbar-CNHgvtZs.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",C={title:"Components/Card",render:a=>{const s=b(i,a);return s.textContent=a.text,s},component:i,decorators:[q(S)],parameters:{actions:{disable:!0}},argTypes:{...f({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...c,render:()=>(v.define([y]),n`
      <div class="demo-card">
        <forge-card>
  ...
  `},o={...p,render:({text:a,raised:s,...l})=>{const d=g(l),u=d?x(d):m;return n` <div class="forge-card" class=${h({"forge-card":!0,"forge-card--raised":s})} style=${u}>${a}</div> `}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"{}",...e.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...o.parameters?.docs?.source}}};const M=["Demo","Styled","Scaffold","CSSOnly"],E=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:o,Demo:e,Scaffold:t,Styled:r,__namedExportsOrder:M,default:C},Symbol.toStringTag,{value:"Module"}));export{E as C,e as D,r as S,o as a,t as b};
