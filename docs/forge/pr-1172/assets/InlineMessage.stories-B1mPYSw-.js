import{A as l,b as r}from"./iframe-DwkZy6ch.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-CElmhe9Y.js";import"./service-adapter-DlT-lJx7.js";import{I as h,w as x}from"./tyler-icons-9EkLoMUE.js";import{o as y}from"./style-map-dMaxBFya.js";import"./inline-message-BXrlbIvc.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
