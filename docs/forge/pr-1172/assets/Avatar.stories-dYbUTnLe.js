import{b as s,A as c}from"./iframe-DYfaiaSN.js";import{s as l,g as f,b as v}from"./utils-MqJhgfu0.js";import{I as b,e as y}from"./tyler-icons-Bp7ZiT47.js";import"./service-adapter-8tADcN_b.js";import{o as S}from"./style-map-D7k4fVqL.js";import"./avatar-C9vR8wIV.js";import{A}from"./avatar-constants-DxjrDML2.js";import"./icon-button-D2n_W3_x.js";const g="forge-avatar",I={title:"Components/Avatar",render:({text:r,letterCount:m,imageUrl:p,...d})=>{const i=v(d),u=i?S(i):c;return s`<forge-avatar
      style=${u}
      text=${r}
...
}`,...n.parameters?.docs?.source}}};const h=["Demo","WithImage","WithIcon","WithIconButton","CSSOnly"],P=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:n,Demo:e,WithIcon:t,WithIconButton:o,WithImage:a,__namedExportsOrder:h,default:I},Symbol.toStringTag,{value:"Module"}));export{P as A,n as C,e as D,t as W,a,o as b};
