import{b as p,A as b}from"./iframe-IbY4Oy7g.js";import{s as x,g as q,b as v}from"./utils-D5x2rMta.js";import{o as y}from"./style-map-CgF03eRt.js";import{n as c,e as m}from"./ref-BXzTffM2.js";import{e as $}from"./class-map-3CuaVSER.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Cvj0tLEi.js";import"./open-icon-7uwpke22.js";import"./card-BPj2HYBm.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
