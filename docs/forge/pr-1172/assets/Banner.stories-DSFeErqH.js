import{b as s}from"./iframe-DYfaiaSN.js";import{I as d,g as f}from"./tyler-icons-Bp7ZiT47.js";import"./service-adapter-8tADcN_b.js";import{B as l}from"./banner-CjZTk562.js";import"./icon-button-D2n_W3_x.js";import"./button-ZAHl1mBc.js";import{s as a,g,c as u,G as b}from"./utils-MqJhgfu0.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,m="forge-banner",p=c("forge-banner-dismissed"),v=c("forge-banner-before-dismiss"),h={title:"Components/Banner",render:i=>{const t=u("forge-banner",i);return t.addEventListener("forge-banner-dismissed",p),t.addEventListener("forge-banner-before-dismiss",v),t.innerHTML=i.text,t},component:m,argTypes:{...g({tagName:m,exclude:["canDismiss"],controls:{theme:{control:"select",options:[...b,"info-secondary"]}}})},args:{theme:l.defaults.THEME,text:"Minim sunt eu laborum labore minim.",dismissed:!1,persistent:!1}},e={},n={...a,render:()=>s`
  ...
  \`
}`,...o.parameters?.docs?.source}}};const y=["Default","Themed","Combined","CSSOnly"],E=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:o,Combined:r,Default:e,Themed:n,__namedExportsOrder:y,default:h},Symbol.toStringTag,{value:"Module"}));export{E as B,r as C,e as D,n as T,o as a};
