import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-B0WPf66k.js";import{b as t,A as n}from"./iframe-Br1mfaAs.js";import{o as h}from"./style-map-uCa2RWxd.js";import{e as c}from"./class-map-BPyADrvv.js";import{b as u,g,G as _}from"./utils-DLgMzbe-.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-BH_9srRb.js";import"./chip-set-B4X1ulOL.js";import"./focus-indicator-BiiSvd6u.js";import"./state-layer-u9rLNX9t.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
