import{b as r}from"./iframe-DdV2iuG_.js";import{s as d,c as p,g as I,G as C}from"./utils-DxN0EQW6.js";import{h as v,g as h,d as y,p as _,r as S,t as $,I as w}from"./tyler-icons-B0WPf66k.js";import{e as E}from"./class-map-DQex70EF.js";import"./service-adapter-CffG5Lhq.js";import"./icon-button-DQB-EJrG.js";import"./focus-indicator-07M8Fer4.js";import"./state-layer-u9rLNX9t.js";import"./index-DTwfV0k0.js";import"./circular-progress-Ctu3rS_y.js";import"./badge-BnRRgkig.js";import"./label-4ji4r2Ao.js";import"./button-bCaYwppL.js";import"./button-toggle-group-Ci2FxStP.js";import"./checkbox-DD5Zzpcl.js";import"./switch-DEFMgGbu.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";w.define([$,_,S,v,h,y]);const T=O("click"),x={title:"Components/Icon Button",render:o=>{const e=p(m,o);if(e.addEventListener("click",T),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=_.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=S.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=$.name,e.appendChild(n)}return e},component:m,argTypes:{...I({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:C},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
