import{b as p,A as b}from"./iframe-FS6UuRTf.js";import{s as x,g as q,b as v}from"./utils-Dyztg_A4.js";import{o as y}from"./style-map-EJs35e7b.js";import{n as c,e as m}from"./ref-Dw8cL2_y.js";import{e as $}from"./class-map-RGHtdqCY.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BE8OXyYA.js";import"./open-icon-Cbokgsj5.js";import"./card-D6VfsD4a.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
