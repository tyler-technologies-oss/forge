import{b as p,A as b}from"./iframe-BqpmPwq_.js";import{s as x,g as q,b as v}from"./utils-Dyztg_A4.js";import{o as y}from"./style-map-DSsT6G9H.js";import{n as c,e as m}from"./ref-Cu2ViM8E.js";import{e as $}from"./class-map-BwRwiTuv.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-fbEqa6VA.js";import"./open-icon-CU8SdVAE.js";import"./card-CoIYVQUN.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
