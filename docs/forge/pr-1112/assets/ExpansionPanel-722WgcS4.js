import{j as e,M as s,T as r,C as o}from"./blocks-BFS-vXbr.js";import{useMDXComponents as a}from"./index-DroSh8Z6.js";import{C as l}from"./CustomArgTypes-CXF69wwr.js";import{C as c}from"./CssOnlyInformation-Clmstrqb.js";import{E as d,D as p,W as h,a as x,N as u,C as g}from"./ExpansionPanel.stories-CINm34Iw.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-BqpmPwq_.js";import"./utils-Dyztg_A4.js";import"./style-map-DSsT6G9H.js";import"./directive-jorct-Oe.js";import"./ref-Cu2ViM8E.js";import"./base-lit-element-Duab_X8r.js";import"./class-map-BwRwiTuv.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-fbEqa6VA.js";import"./dom-utils-B5Tbf4eK.js";import"./state-Ba4gi5YA.js";import"./query-assigned-elements-43hYArgI.js";import"./base-DVmwUFg0.js";import"./utils-DU-9AqTO.js";import"./index-DTwfV0k0.js";import"./open-icon-CU8SdVAE.js";import"./tyler-icons-iDvhFOMC.js";import"./base-component-D7FTQsYl.js";import"./base-adapter-D-ThygVj.js";import"./constants-HtjJ9Nou.js";import"./feature-detection-DaAsmZBy.js";import"./card-CoIYVQUN.js";function i(t){const n={blockquote:"blockquote",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:d}),`
`,e.jsx(r,{}),`
...
`,e.jsx(n.p,{children:"Content within an expansion panel remains findable by the browser. When a user's find-in-page search matches text in a closed expansion panel, the panel will open to reveal the text."}),`
`]}),`
...
`,e.jsxs(n.p,{children:["A button in the ",e.jsx(n.code,{children:"header"})," slot of the expansion panel will automatically control toggling the ",e.jsx(n.code,{children:"open"}),` state of the panel.
...
`]}),`
`,e.jsx(o,{of:x}),`
`,e.jsx(n.h2,{id:"open-icon",children:"Open Icon"}),`
`,e.jsxs(n.p,{children:["A ",e.jsx(n.code,{children:"<forge-open-icon>"})," that's in the ",e.jsx(n.code,{children:"header"})," slot of the expansion panel, or that's a child of the expansion panel's trigger button, has its ",e.jsx(n.code,{children:"open"})," state automatically synced to the ",e.jsx(n.code,{children:"open"}),` state of the expansion panel.
You can also set `,e.jsx(n.code,{children:"openIcon"})," to the ",e.jsx(n.code,{children:"id"})," of a ",e.jsx(n.code,{children:"<forge-open-icon>"})," elsewhere in the document."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Tip:"})," The same guidance about trigger button timing applies here. An ",e.jsx(n.code,{children:"openIconElement"})," property exists to pass the open icon by reference as well."]}),`
`]}),`
`,e.jsxs(n.h2,{id:"using-the-forge-ignore-attribute",children:["Using the ",e.jsx(n.code,{children:"forge-ignore"})," Attribute"]}),`
`,e.jsxs(n.p,{children:[`It is common to place interactive elements within an expansion panel "header" slot. However, you may want to prevent the expansion panel from automatically
expanding/collapsing when the interactive element is clicked. To do this you can use the `,e.jsx(n.code,{children:"forge-ignore"}),` attribute for convenience. This attribute will
...
`,e.jsxs(n.p,{children:["The only thing to keep in mind is that ARIA attributes such as ",e.jsx(n.code,{children:"aria-expanded"})," and ",e.jsx(n.code,{children:"aria-controls"})," will not be automatically managed for elements with the ",e.jsx(n.code,{children:"forge-ignore"}),` attribute,
...
`,e.jsxs(n.p,{children:["Expansion panels with the same ",e.jsx(n.code,{children:"name"})," attribute will form a named group, where only one panel can be open at a time. When a panel in the group is opened, any other open panel in the group will automatically close."]}),`
`,e.jsx(o,{of:u}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Tip:"})," Named groups can be used to create accordion behavior without using a ",e.jsx(n.code,{children:"<forge-accordion>"})," component."]}),`
`]}),`
...
`]}),`
`,e.jsx(c,{})]})}function _(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{_ as default};
