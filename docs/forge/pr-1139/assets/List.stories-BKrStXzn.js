import{A as t,b as e}from"./iframe-BBqNUtqv.js";import{s as O,b as V,g as z}from"./utils-BiqwBWR2.js";import"./service-adapter-8tADcN_b.js";import"./icon-BeLCtqW2.js";import{I as P,u as D,l as W,v as q,d as K,t as U,s as Y,w as G,x as J,y as Q,p as X}from"./tyler-icons-fQPhzpbf.js";import{o as H}from"./style-map-D28ERKrd.js";import{e as a}from"./class-map-CEvcAoEA.js";import{s as Z}from"./decorators-D6cvJtbR.js";import"./list-mhgDPYym.js";import"./drawer-DQMV3LVJ.js";import"./avatar-Moz453hk.js";import"./checkbox-D6rV2_uo.js";import"./key-action-CgbRjzwr.js";import"./index-5CPwzmQS.js";import"./label-DyOrl3sk.js";import"./button-BtXQ1IZV.js";import"./focus-indicator-CE-2THdp.js";import"./state-layer-Cd1l0S13.js";import"./button-toggle-group-Cv8-wtIl.js";import"./icon-button-ChuE_xy5.js";import"./switch-B2rzTqQ2.js";import"./expansion-panel-C5OOA5Mj.js";import"./open-icon-BWY2qJ40.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
...
}`,...v.parameters?.docs?.source}}};const ot=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","Multicolumn","CSSOnly"],kt=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:v,Demo:h,Expandable:$,Interactive:p,Multicolumn:w,NavigationMenu:b,WithAnchor:u,__namedExportsOrder:ot,default:it},Symbol.toStringTag,{value:"Module"}));export{v as C,h as D,$ as E,p as I,kt as L,w as M,b as N,u as W};
