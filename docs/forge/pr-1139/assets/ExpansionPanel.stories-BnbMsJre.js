import{b as p,A as b}from"./iframe-BK3r3gy1.js";import{s as x,g as q,b as v}from"./utils-ZPyYhNMY.js";import{o as y}from"./style-map-B-zzhRls.js";import{n as c,e as m}from"./ref-CHUXG27-.js";import{e as $}from"./class-map-DK01xFt-.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Hh-RCnGo.js";import"./open-icon-CFmphaM2.js";import"./card-Ck5qVP45.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
