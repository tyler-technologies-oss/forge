import{b as p,A as b}from"./iframe-BGuHuM4N.js";import{s as x,g as q,b as v}from"./utils-BX30PoUy.js";import{o as y}from"./style-map-BGPvCepg.js";import{n as c,e as m}from"./ref-ZcWaSb20.js";import{e as $}from"./class-map-C-JnDd7B.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-D2TuKYSN.js";import"./open-icon-ClW9RMht.js";import"./card-DNw80FtE.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
