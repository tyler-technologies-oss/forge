import{b as p,A as b}from"./iframe-D7yGoXUc.js";import{s as x,g as q,b as v}from"./utils-BAJ2NYw0.js";import{o as y}from"./style-map-C8dNO4ii.js";import{n as c,e as m}from"./ref-CbecROYn.js";import{e as $}from"./class-map-kTxnXz5K.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DSi6tOfF.js";import"./open-icon-D7LqGRIa.js";import"./card-BKah7p5A.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
