import{b as p,A as b}from"./iframe-TpqQ2uGz.js";import{s as x,g as q,b as v}from"./utils-C7Mtdcaw.js";import{o as y}from"./style-map-BW9CtvpG.js";import{n as c,e as m}from"./ref-DOtJqPn_.js";import{e as $}from"./class-map-Dk6jWQyG.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DK3C1ggp.js";import"./open-icon-BEusXDQy.js";import"./card-DjwY97xN.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
