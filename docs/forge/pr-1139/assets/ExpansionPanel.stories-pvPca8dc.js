import{b as p,A as b}from"./iframe-Cw7KEIxV.js";import{s as x,g as q,b as v}from"./utils-Bhs_gPRq.js";import{o as y}from"./style-map-Dl9y62GE.js";import{n as c,e as m}from"./ref-B2w24QbC.js";import{e as $}from"./class-map-EV2mT7D9.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-D403CMyO.js";import"./open-icon-70jJ1VZg.js";import"./card-DeUlfnMO.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
