import{b as p,A as b}from"./iframe-B462tM34.js";import{s as x,g as q,b as v}from"./utils-B2BxP4Jm.js";import{o as y}from"./style-map-DEt194QJ.js";import{n as c,e as m}from"./ref-DxamPMHM.js";import{e as $}from"./class-map-zf-3cj2J.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Dbnu_NzH.js";import"./open-icon-DjJUyhC2.js";import"./card-B7RDTVpu.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
