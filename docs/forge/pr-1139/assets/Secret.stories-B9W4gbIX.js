import{b,A as _}from"./iframe-BBqNUtqv.js";import{s as x,g as S,b as v,c as q}from"./utils-BiqwBWR2.js";import{o as h}from"./style-map-D28ERKrd.js";import{n as f,e as g}from"./ref-BmdVJOHD.js";import"./service-adapter-8tADcN_b.js";import"./secret-D7mU6Ite.js";import"./icon-button-ChuE_xy5.js";import"./focus-indicator-CE-2THdp.js";import"./state-layer-Cd1l0S13.js";import"./icon-BeLCtqW2.js";import"./tyler-icons-fQPhzpbf.js";import"./button-BtXQ1IZV.js";import"./tooltip-CtTv4J1q.js";import"./overlay-CRZNSrJB.js";const y="forge-secret",k={title:"Components/Secret",tags:["new"],render:o=>{const n=v(o),s=n?h(n):_,e=q(y,o);return e.textContent=o.text,s&&e.setAttribute("style",String(s)),e},component:y,parameters:{actions:{disable:!0}},argTypes:{...S({tagName:y,exclude:["name"],controls:{variant:{control:"select",options:["blur","masked","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",unmaskedCharacters:"",block:!1,buttonPosition:"end",showOnHover:!1}},l={},u={...x,render:()=>b`
...
}`,...m.parameters?.docs?.source}}};const R=["Demo","NamedGroup","Block","CssOnly","CssOnlyBlock"],U=Object.freeze(Object.defineProperty({__proto__:null,Block:d,CssOnly:p,CssOnlyBlock:m,Demo:l,NamedGroup:u,__namedExportsOrder:R,default:k},Symbol.toStringTag,{value:"Module"}));export{d as B,p as C,l as D,u as N,U as S,m as a};
