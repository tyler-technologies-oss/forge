import{b as p,A as b}from"./iframe-BtA9eWQP.js";import{s as x,g as q,b as v}from"./utils-C7Mtdcaw.js";import{o as y}from"./style-map-D4iQcRdW.js";import{n as c,e as m}from"./ref-CU8WOHSN.js";import{e as $}from"./class-map-BH3B5StU.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DoAd-WeN.js";import"./open-icon-BZomUqG9.js";import"./card-CC2nQesl.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
