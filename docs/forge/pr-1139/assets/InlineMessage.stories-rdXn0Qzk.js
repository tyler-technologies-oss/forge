import{A as l,b as r}from"./iframe-BGuHuM4N.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-BX30PoUy.js";import"./service-adapter-8tADcN_b.js";import{I as h,s as x}from"./tyler-icons-B-fG3G81.js";import{o as y}from"./style-map-BGPvCepg.js";import"./inline-message-CzR1CZl4.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
