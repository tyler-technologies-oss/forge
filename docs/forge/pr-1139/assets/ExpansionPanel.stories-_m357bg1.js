import{b as p,A as b}from"./iframe-BYO1bXoJ.js";import{s as x,g as q,b as v}from"./utils-CJ7ikJXH.js";import{o as y}from"./style-map-qfztkuLE.js";import{n as c,e as m}from"./ref-B7ZGxmyW.js";import{e as $}from"./class-map-PpCHXYFJ.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Dx3PbgF2.js";import"./open-icon-Dg4qPtaB.js";import"./card-5StB8P4_.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
