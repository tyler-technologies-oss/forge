import{b as p,A as b}from"./iframe-CXxaXhZf.js";import{s as x,g as q,b as v}from"./utils-BX30PoUy.js";import{o as y}from"./style-map-BYXRzPk8.js";import{n as c,e as m}from"./ref-DlHgqExc.js";import{e as $}from"./class-map-CY1bu9fM.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CYLw8fCt.js";import"./open-icon-lLuJHHxt.js";import"./card-DQaN4qiP.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
