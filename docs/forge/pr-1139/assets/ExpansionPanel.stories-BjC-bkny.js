import{b as p,A as b}from"./iframe-DYu_YUNV.js";import{s as x,g as q,b as v}from"./utils-qcABQWBJ.js";import{o as y}from"./style-map-CBVsS_js.js";import{n as c,e as m}from"./ref-Bchxmirw.js";import{e as $}from"./class-map-DRS5Dwbr.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-7bZlh6FY.js";import"./open-icon-B2Ol7IGG.js";import"./card-DnZbTBgU.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
