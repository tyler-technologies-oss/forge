import{A as l,b as t}from"./iframe-BBqNUtqv.js";import{s as _,b as T,g as z,G as k}from"./utils-BiqwBWR2.js";import{o as I}from"./style-map-D28ERKrd.js";import{e as S}from"./class-map-CEvcAoEA.js";import{n as L,e as w}from"./ref-BmdVJOHD.js";import{s as x}from"./decorators-D6cvJtbR.js";import"./service-adapter-8tADcN_b.js";import"./base-field-Di1zrDqT.js";import"./focus-indicator-CE-2THdp.js";import"./label-DyOrl3sk.js";import"./key-action-CgbRjzwr.js";import"./index-5CPwzmQS.js";import"./button-BtXQ1IZV.js";import"./state-layer-Cd1l0S13.js";import"./button-toggle-group-Cv8-wtIl.js";import"./checkbox-D6rV2_uo.js";import"./icon-button-ChuE_xy5.js";import"./icon-BeLCtqW2.js";import"./tyler-icons-fQPhzpbf.js";import"./switch-B2rzTqQ2.js";const E="forge-field",B={title:"Components/Field",component:E,render:e=>{const a=T(e),f=a?I(a):l,s=w();function c({target:n}){s.value&&(s.value.floatLabel=!!n.value)}return t`
      <forge-field
        ${L(s)}
  ...
  `},d={parameters:{controls:{include:["label","value","supportText","showStartIcon","inset","invalid","disabled","variant","shape","density","multiline","showStartIcon","select"]}},args:{showStartIcon:!1,inset:!1,select:!1},decorators:[x(`
    ...
    `)],render:({label:e,value:a,supportText:f,showStartIcon:s,multiline:c,inset:n,invalid:A,disabled:g,variant:u,shape:M,density:m,select:O,...F})=>{const i=w(),h=T(F),V=h?I(h):l,C={"forge-field":!0,"forge-field--invalid":A,"forge-field--rounded":M==="rounded","forge-field--plain":u==="plain","forge-field--tonal":u==="tonal","forge-field--filled":u==="filled","forge-field--raised":u==="raised","forge-field--extra-small":m==="extra-small","forge-field--small":m==="small","forge-field--large":m==="large","forge-field--extra-large":m==="extra-large"},y=t`<label for="my-css-only-input" class=${S({"forge-typography--label2":!n})}>${e}</label>`;function v({target:o}){$(o,{animate:!0})}function $(o,{animate:P=!1}){const b=!!o.value;i.value?.classList.toggle("forge-field--float-label",b),P&&(i.value?.classList.toggle("forge-field--float-label-in",b),i.value?.classList.toggle("forge-field--float-label-out",!b))}a&&requestAnimationFrame(()=>{const o=i.value?.querySelector("input,select,textarea");o&&$(o,{animate:!1})});const H=t`<textarea @input=${n?v:l} id="my-css-only-input" .disabled=${g} .value=${a}></textarea>`,R=t`<input @input=${n?v:l} type="text" id="my-css-only-input" .disabled=${g} value=${a} />`,q=t`
    ...
    `;return t`
      ${n?l:y}
      <div ${L(i)} class=${S(C)} style=${V}>
        ${n?y:l}
        ${s?t`<svg class="forge-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
}`,...d.parameters?.docs?.source}}};const D=["Demo","StaticField","CSSOnly"],pe=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:d,Demo:r,StaticField:p,__namedExportsOrder:D,default:B},Symbol.toStringTag,{value:"Module"}));export{d as C,r as D,pe as F,p as S};
