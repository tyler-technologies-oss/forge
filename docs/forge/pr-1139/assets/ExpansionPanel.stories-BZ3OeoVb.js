import{b as p,A as b}from"./iframe-CWXjUqeX.js";import{s as x,g as q,b as v}from"./utils-C7Mtdcaw.js";import{o as y}from"./style-map-CJYhNJUS.js";import{n as c,e as m}from"./ref-CALptolr.js";import{e as $}from"./class-map-BgXYF72p.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DZWLJIM8.js";import"./open-icon-DvKyXOVq.js";import"./card-C_anAd8K.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
