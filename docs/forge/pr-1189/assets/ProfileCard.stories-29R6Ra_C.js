import{b as o}from"./iframe-CYwqMFpx.js";import{I as r,k as t}from"./icon-Tt8SKUgI.js";import{s as a}from"./decorators-CSsLSkmc.js";import"./service-adapter-gy1PbA1l.js";import"./card-N-G0In5S.js";import"./button-DHU_VBE6.js";import"./icon-button-DFwZyKlJ.js";import"./toolbar-BV7So2Bl.js";const i="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";r.define(t);const n={title:"Recipes/Card/Profile",decorators:[a(i)],render:()=>o`
    <forge-card>
      <div class="container">
        <div class="avatar">
