import{b as p,A as b}from"./iframe-CYwqMFpx.js";import{s as x,g as q,b as v}from"./utils-BUEgyQuR.js";import{o as y}from"./style-map-iGxuQpg8.js";import{n as c,e as m}from"./ref-CbKdd-hM.js";import{e as $}from"./class-map-BU8lYIPj.js";import"./service-adapter-gy1PbA1l.js";import"./expansion-panel-DX-93Wln.js";import"./open-icon-DQI1fgBS.js";import"./card-N-G0In5S.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
