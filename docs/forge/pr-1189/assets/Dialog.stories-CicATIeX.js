import"./service-adapter-gy1PbA1l.js";import{a as o}from"./dialog-DGghfkK0.js";import{I as h,D as b}from"./icon-DaCKLlYs.js";import{b as y,D as S}from"./iframe-DhPPATOI.js";import{e as E}from"./class-map-CEQgffN4.js";import{s as T}from"./decorators-BUCTEMc-.js";import{c as D,g as C}from"./utils-BUEgyQuR.js";import"./icon-button-C2v-Sinx.js";import"./button-D5tK2bf-.js";import"./scaffold-BVJBr1z1.js";import"./toolbar-7MtW3mBN.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),L=a("forge-dialog-before-close"),x=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=D("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",L),e.addEventListener("forge-dialog-move-start",x),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
