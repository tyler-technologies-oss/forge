import{b as p,A as b}from"./iframe-DhPPATOI.js";import{s as x,g as q,b as v}from"./utils-BUEgyQuR.js";import{o as y}from"./style-map-CcP_kdqL.js";import{n as c,e as m}from"./ref-BhDBbNSW.js";import{e as $}from"./class-map-CEQgffN4.js";import"./service-adapter-gy1PbA1l.js";import"./expansion-panel-B0kFDtRV.js";import"./open-icon-CD6pRoqI.js";import"./card-xZjk_lrn.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
