import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-DujtuLyJ.js";import{b as t,A as n}from"./iframe-C0tv50se.js";import{o as h}from"./style-map-Cm5o70SV.js";import{e as c}from"./class-map-Dh7hYSBM.js";import{b as u,g,G as _}from"./utils-QdjzOY7l.js";import"./avatar-z0f_NAt9.js";import"./chip-set-BIwgzayx.js";import"./focus-indicator-CI-XZz-0.js";import"./state-layer-RJ83GVyt.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
