import{b as p,A as b}from"./iframe-C8qvgkWs.js";import{s as x,g as q,b as v}from"./utils-DJhy9_a3.js";import{o as y}from"./style-map-ei5Sap-n.js";import{n as c,e as m}from"./ref-CPsBlk0J.js";import{e as $}from"./class-map-CWLweCHy.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BqGfEZM0.js";import"./open-icon-CxHpZY5S.js";import"./card-BijNrRDy.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
