import{u as t,j as e,M as r}from"./blocks-DrDFpA5a.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Cylg7AIw.js";import"./iframe-CYwqMFpx.js";import"./_commonjsHelpers-CqkleIqs.js";function o(s){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Getting Started/Installation"}),`
...
`,e.jsx(n.p,{children:"You will then need to import the components you are using within your application to register them in the browser's custom element registry."}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import '@tylertech/forge/button';
import '@tylertech/forge/text-field';
`})}),`
`,e.jsx(n.p,{children:"If you're prototyping, it can be handy to pull in all components:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`import '@tylertech/forge';
`})}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`Note: make sure to import the components as early as possible in your application bootstrapping process to ensure they are
registered with the browser before your application is rendered to avoid FOUC (Flash of Unstyled Content).`}),`
`]}),`
