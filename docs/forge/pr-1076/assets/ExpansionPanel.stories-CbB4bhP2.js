import{b as p,A as f}from"./iframe-BUvWK7Gm.js";import{s as b,g as x,b as v}from"./utils-D8X1NLZa.js";import{o as y}from"./style-map-BiPVbLS3.js";import{n as u,e as c}from"./ref-wShc1pHg.js";import{e as q}from"./class-map-IMI5Z3Jd.js";import"./service-adapter-CoGDs2_3.js";import"./expansion-panel-Fnf-xp2Z.js";import"./open-icon-C85rqQKN.js";import"./card-DZFfX2Zm.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",$=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),L={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):f,t=c();function m(g){$(),t.value?.setAttribute("aria-expanded",g.detail.toString())}return p`
