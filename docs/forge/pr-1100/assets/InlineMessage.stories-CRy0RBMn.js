import{A as l,b as r}from"./iframe-Of55AveD.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-BUOWcVje.js";import"./service-adapter-CoGDs2_3.js";import{I as h,s as x}from"./tyler-icons-B4xXB1kz.js";import"./index-DTwfV0k0.js";import{o as y}from"./style-map-C2VnxdVh.js";import"./inline-message-9zvVMjFA.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
