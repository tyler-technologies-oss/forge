import{b as p,A as b}from"./iframe-54dvmREw.js";import{s as x,g as q,b as v}from"./utils-CHhwppm_.js";import{o as y}from"./style-map-Z_yVS67s.js";import{n as c,e as m}from"./ref-DBaS59-1.js";import{e as $}from"./class-map-BovTmPJY.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-D64QXYyR.js";import"./open-icon-BGtJLnPm.js";import"./card-BIM78596.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
