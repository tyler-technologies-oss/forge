import{b as p,A as b}from"./iframe-KAvO3ccT.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-DBla6-y8.js";import{n as c,e as m}from"./ref-CGggkWyE.js";import{e as $}from"./class-map-CKj0Y-2z.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-B8e6E0H2.js";import"./open-icon-DZfKtTGb.js";import"./card-Dq3841Rq.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
