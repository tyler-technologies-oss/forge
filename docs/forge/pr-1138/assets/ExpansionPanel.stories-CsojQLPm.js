import{b as p,A as b}from"./iframe-DUkN5F6u.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-B7EY9ftD.js";import{n as c,e as m}from"./ref-BICBVzb6.js";import{e as $}from"./class-map-CfY3KtTY.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CAbXM4YB.js";import"./open-icon-CnAVOSV2.js";import"./card-6J-3YmIr.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
