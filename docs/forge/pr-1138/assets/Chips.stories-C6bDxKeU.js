import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-ChHIax3p.js";import{b as t,A as n}from"./iframe-D8QRU-tV.js";import{o as h}from"./style-map-UpbrRikP.js";import{e as c}from"./class-map-u3X-Wut3.js";import{b as u,g,G as _}from"./utils-QQyHyWEl.js";import"./avatar-DDIdQUFA.js";import"./chip-set-B1TmUbcT.js";import"./focus-indicator-azdGC1n3.js";import"./state-layer-Dj8VLfkk.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
