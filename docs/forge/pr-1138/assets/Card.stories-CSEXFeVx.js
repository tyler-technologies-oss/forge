import{A as m,b as n}from"./iframe-D8QRU-tV.js";import{r as p,s as c,b as g,g as f,c as b}from"./utils-QQyHyWEl.js";import"./service-adapter-8tADcN_b.js";import{I as v,E as y}from"./tyler-icons-ChHIax3p.js";import{s as q}from"./decorators-kZolpHyN.js";import{e as h}from"./class-map-u3X-Wut3.js";import{o as x}from"./style-map-UpbrRikP.js";import"./card-Dv5hDNhO.js";import"./icon-button-BGlfW1oY.js";import"./focus-indicator-azdGC1n3.js";import"./state-layer-Dj8VLfkk.js";import"./button-DSNQ_5yA.js";import"./scaffold-D_SIXSFE.js";import"./toolbar-DEZsnsSE.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",C={title:"Components/Card",render:a=>{const s=b(i,a);return s.textContent=a.text,s},component:i,decorators:[q(S)],parameters:{actions:{disable:!0}},argTypes:{...f({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...c,render:()=>(v.define([y]),n`
      <div class="demo-card">
        <forge-card>
