import"./service-adapter-CoGDs2_3.js";import{D as o}from"./dialog-BidBU9U3.js";import"./backdrop-DBJsfqA2.js";import{I as h,C as b}from"./tyler-icons-DRTyRvfU.js";import"./index-DTwfV0k0.js";import{b as y,D as S}from"./iframe-DRFcLz4S.js";import{e as E}from"./class-map-3UjCUFW0.js";import{s as T}from"./decorators-BeiQIKos.js";import{c as C,g as D}from"./utils-B1jcnhxN.js";import"./icon-button-0QvbX1ML.js";import"./focus-indicator-ChNze-x0.js";import"./state-layer-D7Damx7l.js";import"./button-ew--32EC.js";import"./scaffold-B5aByuW8.js";import"./toolbar-DKTN8__P.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),L=a("forge-dialog-before-close"),x=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=C("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",L),e.addEventListener("forge-dialog-move-start",x),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
