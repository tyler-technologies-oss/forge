import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-fP-z9z1i.js";import"./index-DTwfV0k0.js";import{b as t,A as n}from"./iframe-C07_izNT.js";import{o as h}from"./style-map-DKtD9blK.js";import{e as c}from"./class-map-Dpr8fGyd.js";import{b as u,g,G as _}from"./utils-B3m7KQiq.js";import"./avatar-Q39TJc0M.js";import"./chip-set-BdyeEYKz.js";import"./focus-indicator-CXn9rWMK.js";import"./state-layer-BsCfz34t.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
...
}`,...l.parameters?.docs?.source}}};const w=["Demo","Anchor","Avatar","CSSOnly"],H=Object.freeze(Object.defineProperty({__proto__:null,Anchor:s,Avatar:i,CSSOnly:l,Demo:o,__namedExportsOrder:w,default:C},Symbol.toStringTag,{value:"Module"}));export{s as A,H as C,o as D,i as a,l as b};
