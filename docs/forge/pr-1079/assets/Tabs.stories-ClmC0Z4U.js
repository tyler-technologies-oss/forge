import{A as i,b as c}from"./iframe-CvOKOd3F.js";import{s as l,g as f,b as g}from"./utils-zCyTXnrZ.js";import{o as v}from"./style-map-D9Aeadbf.js";import{I as y,p as S,t as I}from"./tyler-icons-DRTyRvfU.js";import"./service-adapter-CoGDs2_3.js";import"./index-DTwfV0k0.js";import"./tab-bar-BCSyRZMn.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",$=m("forge-tab-bar-change"),T=m("forge-tab-select");y.define([S,I]);const _={title:"Components/Tabs",render:e=>{const n={...g(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const u=Object.entries(n).length?v(n):i,p=Array.from({length:e.scrollButtons?20:3}).map((h,b)=>c`<forge-tab>
...
}`,...s.parameters?.docs?.source}}};const A=["Demo","Vertical","Clustered","Scrolling","WithIcons"],j=Object.freeze(Object.defineProperty({__proto__:null,Clustered:o,Demo:t,Scrolling:a,Vertical:r,WithIcons:s,__namedExportsOrder:A,default:_},Symbol.toStringTag,{value:"Module"}));export{o as C,t as D,a as S,j as T,r as V,s as W};
