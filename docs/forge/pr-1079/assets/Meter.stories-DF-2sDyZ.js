import{b as i}from"./iframe-CvOKOd3F.js";import{s as p,d as l,g as c}from"./utils-zCyTXnrZ.js";import"./service-adapter-CoGDs2_3.js";import"./meter-group-uWZdtsmz.js";import"./key-item-BbUCbjlP.js";const m="forge-meter",s=t=>{t.id="meter";const e=document.createElement("label");e.htmlFor="meter",e.textContent="Label",t.appendChild(e)},d={title:"Components/Meter",render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e},component:m,subcomponents:{"Meter Group":"forge-meter-group"},argTypes:{...c({tagName:m,exclude:["percentage"],controls:{value:{control:{type:"number",step:.1}},min:{control:{type:"number",step:.1}},max:{control:{type:"number",step:.1}},low:{control:{type:"number",step:.1}},high:{control:{type:"number",step:.1}},optimum:{control:{type:"number",step:.1}},valueMode:{control:{type:"inline-radio"},options:["manual","percentage","value"]},direction:{control:{type:"inline-radio"},options:["horizontal","vertical"]},shape:{control:{type:"inline-radio"},options:["default","rounded","squared"]},innerShape:{control:{type:"inline-radio"},options:["default","inherit"]},density:{control:{type:"select"},options:["small","medium","large"]},theme:{control:{type:"select"},options:["default","primary","secondary","tertiary","success","warning","error","info"]}}})},args:{value:.5,min:0,max:1,tickmarks:!1,valueMode:"manual",direction:"horizontal",shape:"default",innerShape:"default",density:"medium",theme:"default",muted:!1}},r={},o={render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e.setAttribute("low","0.33"),e.setAttribute("high","0.67"),e.setAttribute("optimum","1"),e}},n={...p,render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e.setAttribute("tickmarks",""),e.style.setProperty("--forge-meter-tickmarks","9"),e}},a={argTypes:{min:{control:{type:"number",step:.1}},max:{control:{type:"number",step:.1}},tickmarks:{control:{type:"boolean"}},direction:{control:{type:"inline-radio"},options:["horizontal","vertical"]},shape:{control:{type:"inline-radio"},options:["default","rounded","squared"]},innerShape:{control:{type:"inline-radio"},options:["default","inherit"]},density:{control:{type:"select"},options:["small","medium","large"]}},args:{min:0,max:1,tickmarks:!1,direction:"horizontal",shape:"default",innerShape:"default",density:"medium"},render:t=>i`
    <forge-meter-group
      id="meter-group"
      .min=${t.min}
      .max=${t.max}
