import{b as p,A as b}from"./iframe-DUO6sR7Q.js";import{s as x,g as q,b as v}from"./utils-JlLG_A5T.js";import{o as y}from"./style-map-DLsNm45v.js";import{n as c,e as m}from"./ref-BebHwDhL.js";import{e as $}from"./class-map-CaIjk2ba.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Bav1DQTs.js";import"./open-icon-BRYaepyM.js";import"./card-bhZ9tzd1.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
