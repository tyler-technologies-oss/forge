import{b as s}from"./iframe-CqmBxxxw.js";import{I as d,g as f}from"./tyler-icons-D-59dOyn.js";import"./service-adapter-CoGDs2_3.js";import{B as l}from"./banner-DgosgY5h.js";import"./icon-button-CRjf1LQA.js";import"./focus-indicator-BGIlkLsU.js";import"./state-layer-CDycYdPe.js";import"./button-DX_DhTaU.js";import{s as a,g,c as u,G as b}from"./utils-BQsOXphk.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,m="forge-banner",p=c("forge-banner-dismissed"),v=c("forge-banner-before-dismiss"),h={title:"Components/Banner",render:i=>{const t=u("forge-banner",i);return t.addEventListener("forge-banner-dismissed",p),t.addEventListener("forge-banner-before-dismiss",v),t.innerHTML=i.text,t},component:m,argTypes:{...g({tagName:m,exclude:["canDismiss"],controls:{theme:{control:"select",options:[...b,"info-secondary"]}}})},args:{theme:l.defaults.THEME,text:"Minim sunt eu laborum labore minim.",dismissed:!1,persistent:!1}},e={},n={...a,render:()=>s`
  ...
  \`
}`,...o.parameters?.docs?.source}}};const y=["Default","Themed","Combined","CSSOnly"],C=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:o,Combined:r,Default:e,Themed:n,__namedExportsOrder:y,default:h},Symbol.toStringTag,{value:"Module"}));export{C as B,r as C,e as D,n as T,o as a};
