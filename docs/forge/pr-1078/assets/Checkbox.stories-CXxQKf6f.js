import{b as c,A as d}from"./iframe-Bm6ogQZk.js";import{e as i}from"./class-map-fN18Hyul.js";import{o as m}from"./style-map-DyZSdUSh.js";import{g as b,b as p}from"./utils-DQ34OAOC.js";import"./service-adapter-8tADcN_b.js";import"./checkbox-Dktn9RJO.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";const{action:f}=__STORYBOOK_MODULE_ACTIONS__,r="forge-checkbox",h=f("forge-checkbox-change"),k={title:"Components/Checkbox",render:e=>{const o=p(e),t=o?m(o):d;return c`
      <forge-checkbox
        .checked=${e.checked}
...
}`,...a.parameters?.docs?.source}}};const g=["Demo","CSSOnly"],O=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:a,Demo:s,__namedExportsOrder:g,default:k},Symbol.toStringTag,{value:"Module"}));export{O as C,s as D,a};
