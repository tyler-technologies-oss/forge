import{j as e,M as r,T as a,C as s}from"./blocks-CRJnNqsD.js";import{useMDXComponents as o}from"./index-C1oxqWVj.js";import{C as c}from"./CustomArgTypes-HxN_QPlU.js";import{B as l,D as h}from"./ButtonArea.stories-Bhs2XbWg.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-CqmBxxxw.js";import"./utils-BQsOXphk.js";import"./style-map-B8hZhTlf.js";import"./directive-jorct-Oe.js";import"./service-adapter-CoGDs2_3.js";import"./tyler-icons-D-59dOyn.js";import"./feature-detection-DBnB2p_f.js";import"./base-lit-element-BxtlRWGv.js";import"./constants-uy-3DCWv.js";import"./card-CNCcq8o5.js";import"./utils-DU-9AqTO.js";import"./button-area-K02tIhA8.js";import"./event-utils-C1SDeUaq.js";import"./query-assigned-elements-43hYArgI.js";import"./base-DVmwUFg0.js";import"./ref-B4nT8hth.js";import"./icon-button-CRjf1LQA.js";import"./base-component-B5xZY7DP.js";import"./dom-utils-CBD4z_3d.js";import"./base-adapter-DZ7lVcI0.js";import"./base-button-core-pf_hX9qD.js";import"./with-label-aware-rB4nYfN7.js";import"./with-default-aria-qCwd8R18.js";import"./a11y-utils-OON17uxD.js";import"./focus-indicator-BGIlkLsU.js";import"./state-layer-CDycYdPe.js";import"./tooltip-D6IG9xiN.js";import"./overlay-CeKA2Vs0.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";import"./with-longpress-listener-CURrVc38.js";import"./dismissible-stack-xq-0Rg1q.js";import"./decorators-Dw4kKhXr.js";function i(n){const t={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:l}),`
`,e.jsx(a,{}),`
...
`})}),`
`,e.jsx(t.h2,{id:"usage-with-anchor-links",children:"Usage with anchor links"}),`
`,e.jsxs(t.p,{children:["The button area can be used with anchor (",e.jsx(t.code,{children:"<a>"}),") elements in addition to buttons:"]}),`
...
`,e.jsxs(t.p,{children:[e.jsx(t.strong,{children:"Note:"})," ",e.jsx(t.code,{children:"<a>"})," elements can't be disabled. Attempting to disable a ",e.jsx(t.code,{children:"<forge-button-area>"})," with an anchor element will have no effect."]}),`
`]}),`
...
`,e.jsxs(t.li,{children:["Always include a slotted ",e.jsx(t.code,{children:"<button>"})," or ",e.jsx(t.code,{children:"<a>"})," element or connect a visible button or ",e.jsx(t.code,{children:"<a>"})," element with the ",e.jsx(t.code,{children:"target"})," or ",e.jsx(t.code,{children:"targetElement"})," properties."]}),`
...
`]}),`
`]}),`
`,e.jsxs(t.li,{children:["Verify that pressing the space bar or enter key while focused on a button will activate the button area in the same manner as if it had been clicked with a mouse. When used with an ",e.jsx(t.code,{children:"<a>"})," element only the enter key should activate the button area."]}),`
...
`]})]})}function Q(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{Q as default};
