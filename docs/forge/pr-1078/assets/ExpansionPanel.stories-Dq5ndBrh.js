import{b as p,A as b}from"./iframe-DGoJ1nOJ.js";import{s as x,g as q,b as v}from"./utils-DQ34OAOC.js";import{o as y}from"./style-map-D2IpQ2U1.js";import{n as c,e as m}from"./ref-GvTJmLZV.js";import{e as $}from"./class-map-CeNVreM7.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-46Qrd-pr.js";import"./open-icon-MaY7KraM.js";import"./card-DOHfN5Yw.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
