import{A as t,b as e}from"./iframe-CqmBxxxw.js";import{s as O,b as V,g as z}from"./utils-BQsOXphk.js";import"./service-adapter-CoGDs2_3.js";import{I as P,u as D,l as W,v as q,d as K,t as U,s as Y,w as G,x as J,y as Q,p as X}from"./tyler-icons-D-59dOyn.js";import{o as H}from"./style-map-B8hZhTlf.js";import{e as a}from"./class-map-CzloGBZg.js";import{s as Z}from"./decorators-Dw4kKhXr.js";import"./list-DTk5X6mh.js";import"./drawer-CBK_snqa.js";import"./avatar-C2qvkq1x.js";import"./checkbox-Bv0J0WTO.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";import"./label-AubqXluV.js";import"./button-DX_DhTaU.js";import"./focus-indicator-BGIlkLsU.js";import"./state-layer-CDycYdPe.js";import"./button-toggle-group-D_Dzo2at.js";import"./icon-button-CRjf1LQA.js";import"./switch-DLphmdNU.js";import"./expansion-panel-Dv8zOBvR.js";import"./open-icon-Ppa_qRd_.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
...
}`,...v.parameters?.docs?.source}}};const ot=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","Multicolumn","CSSOnly"],Et=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:v,Demo:h,Expandable:$,Interactive:p,Multicolumn:w,NavigationMenu:b,WithAnchor:u,__namedExportsOrder:ot,default:it},Symbol.toStringTag,{value:"Module"}));export{v as C,h as D,$ as E,p as I,Et as L,w as M,b as N,u as W};
