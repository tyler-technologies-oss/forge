import{b as p,A as b}from"./iframe-Dwdbg1rc.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-CGlVke1D.js";import{n as c,e as m}from"./ref-DvFT0GFr.js";import{e as $}from"./class-map-CgbSzia_.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DBPsqlmD.js";import"./open-icon-Cmv7C5Ni.js";import"./card-CgwSvjOG.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
