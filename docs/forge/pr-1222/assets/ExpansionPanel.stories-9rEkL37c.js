import{b as p,A as b}from"./iframe-BPj94FGh.js";import{s as x,g as q,b as v}from"./utils-LbM5kS63.js";import{o as y}from"./style-map-DhpmFxzM.js";import{n as c,e as m}from"./ref-DehrBYte.js";import{e as $}from"./class-map-oMFnGZ1n.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BIsU606u.js";import"./open-icon-CUTwfP0D.js";import"./card-BOAJRdnh.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
