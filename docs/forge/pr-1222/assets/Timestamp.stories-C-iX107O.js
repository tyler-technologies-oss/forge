import"./service-adapter-8tADcN_b.js";import"./timestamp-BucHJv1R.js";import{b as o}from"./iframe-0q-2v6p2.js";import{s,g as y,d as p}from"./utils-DYC_LATD.js";const n="forge-timestamp",v={title:"Components/Timestamp",tags:["new"],render:e=>{const i=document.createElement("forge-timestamp");p(i,e);const r=new Date;return i.setAttribute("datetime",`${r.getFullYear()}-${r.getMonth()+1}-${r.getDate()}`),i},component:n,argTypes:{...y({tagName:n})},args:{}},t={},a={...s,render:()=>o`
