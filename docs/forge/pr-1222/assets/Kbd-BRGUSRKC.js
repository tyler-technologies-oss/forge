import{u as n,j as e,M as i,T as t,C as c}from"./blocks-BaP1oJZQ.js";import{C as l}from"./CustomArgTypes-CBta-QC2.js";import{K as h,D as o}from"./Kbd.stories-Dhgiml4d.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-BPj94FGh.js";import"./utils-LbM5kS63.js";import"./service-adapter-8tADcN_b.js";import"./kbd-DYjwD61B.js";import"./platform-C5RrLkNt.js";import"./utils-BBsKBbSu.js";import"./base-lit-element-CMZB93zd.js";import"./directive-CwRn8Fwj.js";import"./class-map-oMFnGZ1n.js";function d(s){const r={code:"code",h2:"h2",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...n(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:h}),`
`,e.jsx(t,{}),`
...
`,e.jsxs(r.table,{children:[e.jsx(r.thead,{children:e.jsxs(r.tr,{children:[e.jsx(r.th,{children:"Modifier key"}),e.jsx(r.th,{children:"Windows / Linux"}),e.jsx(r.th,{children:"Apple"})]})}),e.jsxs(r.tbody,{children:[e.jsxs(r.tr,{children:[e.jsx(r.td,{children:"Control"}),e.jsx(r.td,{children:e.jsx(r.code,{children:"Ctrl"})}),e.jsx(r.td,{children:e.jsx(r.code,{children:"⌃"})})]}),e.jsxs(r.tr,{children:[e.jsx(r.td,{children:"Shift"}),e.jsx(r.td,{children:e.jsx(r.code,{children:"⇧"})}),e.jsx(r.td,{children:e.jsx(r.code,{children:"⇧"})})]}),e.jsxs(r.tr,{children:[e.jsx(r.td,{children:"Alt"}),e.jsx(r.td,{children:e.jsx(r.code,{children:"Alt"})}),e.jsx(r.td,{children:e.jsx(r.code,{children:"⌥"})})]}),e.jsxs(r.tr,{children:[e.jsx(r.td,{children:"Meta"}),e.jsx(r.td,{children:e.jsx(r.code,{children:"Meta"})}),e.jsx(r.td,{children:e.jsx(r.code,{children:"⌘"})})]})]})]}),`
...
`]})]})}function C(s={}){const{wrapper:r}={...n(),...s.components};return r?e.jsx(r,{...s,children:e.jsx(d,{...s})}):d(s)}export{C as default};
