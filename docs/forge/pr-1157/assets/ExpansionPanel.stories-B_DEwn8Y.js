import{b as p,A as b}from"./iframe-MktPgWAA.js";import{s as x,g as q,b as v}from"./utils-C6q7qu_A.js";import{o as y}from"./style-map-6XxNn_yc.js";import{n as c,e as m}from"./ref-sTCHvy_k.js";import{e as $}from"./class-map-BGDlGpHN.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DTtFpcfh.js";import"./open-icon-CHtGuw8k.js";import"./card-BmiOFj5P.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
