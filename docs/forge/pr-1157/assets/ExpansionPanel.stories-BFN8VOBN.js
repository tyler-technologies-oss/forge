import{b as p,A as b}from"./iframe-B1NHwC0_.js";import{s as x,g as q,b as v}from"./utils-BzaDkCLg.js";import{o as y}from"./style-map-BMTxmd4x.js";import{n as c,e as m}from"./ref-D5o3ouzE.js";import{e as $}from"./class-map-YkwPdXZp.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-B-WN1Ywk.js";import"./open-icon-pvhrQChV.js";import"./card-BdIw2hYz.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
