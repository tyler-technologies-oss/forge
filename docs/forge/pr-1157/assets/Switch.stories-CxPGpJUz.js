import"./service-adapter-8tADcN_b.js";import{I as a,B as n,C as l}from"./tyler-icons-DbetBFcH.js";import{b as i}from"./iframe-TV9XAvMj.js";import{e as d}from"./class-map-BIzENm5v.js";import{g as f,c as m}from"./utils-BzaDkCLg.js";import"./switch-B11zG3es.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";a.define([n,l]);const r="forge-switch",g={title:"Components/Switch",render:c=>{const o=m(r,c);return o.textContent="off/on",o},component:r,parameters:{actions:{disable:!0}},argTypes:{...f({tagName:r,exclude:["icon","form","labels","name","on","defaultOn","selected"],controls:{labelPosition:{control:"select",options:["start","end"]}}})}},e={},s={parameters:{controls:{include:["on","dense","disabled"]}},args:{checked:!1,dense:!1,disabled:!1},render:({checked:c,dense:o,disabled:t})=>i`
