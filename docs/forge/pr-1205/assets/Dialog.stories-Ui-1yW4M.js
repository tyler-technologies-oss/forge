import"./service-adapter-DlT-lJx7.js";import{a as o}from"./dialog-qsRa4tTT.js";import{I as h,D as b}from"./tyler-icons-qc11a4hp.js";import{b as y,D as S}from"./iframe-B7LxWkL4.js";import{e as E}from"./class-map-Bp2Z4U3t.js";import{s as T}from"./decorators-B0FcLyta.js";import{c as D,g as C}from"./utils-BgSSl4hg.js";import"./icon-button-BsODWw2P.js";import"./button-BT0VAunK.js";import"./scaffold-C8LskKFX.js";import"./toolbar-DUE3t8Rm.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),L=a("forge-dialog-before-close"),x=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=D("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",L),e.addEventListener("forge-dialog-move-start",x),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
