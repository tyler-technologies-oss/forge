import{A as l,b as r}from"./iframe-B7LxWkL4.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-BgSSl4hg.js";import"./service-adapter-DlT-lJx7.js";import{I as h,w as x}from"./tyler-icons-qc11a4hp.js";import{o as y}from"./style-map-B4WdC4iL.js";import"./inline-message-D6TY8UzG.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
