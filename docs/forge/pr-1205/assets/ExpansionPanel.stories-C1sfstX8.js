import{b as p,A as b}from"./iframe-CdbO8ZWL.js";import{s as x,g as q,b as v}from"./utils-CjnDZgMw.js";import{o as y}from"./style-map-GYvMt1fF.js";import{n as c,e as m}from"./ref-DehyC0dt.js";import{e as $}from"./class-map-B443CMvP.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-YLFRr9Um.js";import"./open-icon-IasJz46n.js";import"./card-Cd5hCNYZ.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
