import{b as p,A as b}from"./iframe-BIG492RP.js";import{s as x,g as q,b as v}from"./utils-B5Iu1i3H.js";import{o as y}from"./style-map-Ce7RU_bJ.js";import{n as c,e as m}from"./ref-Dh0zIiDW.js";import{e as $}from"./class-map-Df6Ony9o.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-D6nx1nuk.js";import"./open-icon-AXjWx-Ql.js";import"./card-CqknZTDk.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
