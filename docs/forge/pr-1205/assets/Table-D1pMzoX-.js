import{u as i,j as e,M as l,T as s,C as o}from"./blocks-ZCF8jAuh.js";import{C as c}from"./CustomArgTypes-BrNnIXPT.js";import{C as d}from"./CssOnlyInformation-CSSpg61r.js";import{T as h,D as r,C as p}from"./Table.stories-CCn04sde.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DAoAvB82.js";import"./iframe-CGF9490j.js";import"./_commonjsHelpers-CqkleIqs.js";import"./utils-cbnKSSEt.js";import"./service-adapter-DlT-lJx7.js";import"./table-D4yIvrTD.js";import"./base-component-DokdPcmx.js";import"./base-adapter-C2s8cO2K.js";import"./dom-utils-D38acdAW.js";import"./tyler-icons-CM84cyec.js";import"./property-h_NQN_ax.js";import"./base-lit-element-BzArp5lX.js";import"./directive-CwRn8Fwj.js";import"./constants-Ds-UekRh.js";import"./feature-detection-Cxj81Y1H.js";import"./expansion-panel-BFvy7dNk.js";import"./class-map-C-Xl3VxB.js";import"./state-CvgusLtP.js";import"./query-assigned-elements-43hYArgI.js";import"./base-DVmwUFg0.js";import"./utils-DU-9AqTO.js";import"./key-action-lsAysfb-.js";import"./index-5CPwzmQS.js";import"./open-icon-BDuGFBPz.js";import"./checkbox-BjuLW923.js";import"./with-form-associated-gcPFdgdP.js";import"./with-element-internals-CJt7fDtX.js";import"./a11y-utils-a04gn1ZN.js";import"./with-label-aware-BP3asw-P.js";import"./focus-indicator-BuzCXwAm.js";import"./state-layer-BcVD1OXH.js";import"./checkbox-constants-BbWb-R-a.js";import"./text-field-V39Mt-6S.js";import"./base-field-D8CxI0Jj.js";import"./label-CtoUkODo.js";import"./button-constants-D5k34xES.js";import"./button-toggle-group-constants-lDTvG_dF.js";import"./icon-button-constants-BJvh1yHL.js";import"./switch-constants-DiyC_PIB.js";import"./icon-button-D1wmfd79.js";import"./base-button-BJYE3STx.js";import"./query-CtiAP21w.js";import"./tooltip-u84XDAZH.js";import"./overlay-iu-_ABPF.js";import"./with-longpress-listener-D-W76F-r.js";import"./dismissible-stack-xq-0Rg1q.js";import"./base-component-delegate-SNfm_5S4.js";import"./event-utils-C1SDeUaq.js";function a(t){const n={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:h}),`
`,e.jsx(s,{}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"footer"})," - The text to be displayed in the column footer."]}),`
...
`})}),`
`,e.jsx(n.h2,{id:"using-column-footers",children:"Using column footers"}),`
`,e.jsxs(n.p,{children:["To add a footer row to the table, set the ",e.jsx(n.code,{children:"include-footer"})," attribute (or ",e.jsx(n.code,{children:"includeFooter"})," property) to ",e.jsx(n.code,{children:"true"})," on the ",e.jsx(n.code,{children:"<forge-table>"})," element. Then configure each column with either a ",e.jsx(n.code,{children:"footer"})," string or a ",e.jsx(n.code,{children:"footerTemplate"})," callback to control what each cell in the footer row renders."]}),`
`,e.jsxs(n.p,{children:["Use ",e.jsx(n.code,{children:"footer"})," for simple static text:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`const columnConfigurations: IColumnConfiguration[] = [
...
tableEl.columnConfigurations = columnConfigurations;
`})}),`
`,e.jsxs(n.p,{children:["Use ",e.jsx(n.code,{children:"footerTemplate"})," for custom HTML content in footer cells:"]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["You can also apply custom styles to footer cells via the ",e.jsx(n.code,{children:"footerCellStyle"})," property on each column configuration."]}),`
`,e.jsx(o,{of:r}),`
...
`,e.jsx(o,{of:p}),`
`,e.jsx(d,{})]})}function pe(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{pe as default};
