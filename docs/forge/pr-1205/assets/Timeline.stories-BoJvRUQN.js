import"./service-adapter-DlT-lJx7.js";import"./badge-BfXwQdqa.js";import"./card-BggT-zBh.js";import{I as u,E as h,F as b,g as y,G as v}from"./tyler-icons-CM84cyec.js";import"./timestamp-BZgNY179.js";import{b as e}from"./iframe-CGF9490j.js";import{s as t,g as S,d as k}from"./utils-cbnKSSEt.js";u.define([h,b,y,v]);const d="forge-timeline",T={title:"Components/Timeline",tags:["new"],render:p=>{const g=document.createElement("forge-timeline");return k(g,p),[{content:"Project kickoff meeting completed"},{content:"Initial design mockups reviewed"},{content:"API endpoints finalized"},{content:"Code review session"}].forEach(c=>{const f=document.createElement("forge-timeline-item");f.textContent=c.content,g.appendChild(f)}),g},component:d,subcomponents:{"Timeline Item":"forge-timeline-item","Timeline Break":"forge-timeline-break"},argTypes:{...S({tagName:d})},args:{}},i={},n={...t,render:()=>e`
  ...
  \`
}`,...l.parameters?.docs?.source}}};const P=["Demo","WithIcons","WithBadges","WithBreak","SidebarOptions","Themed","WithDetail","WithTimestamps"],D=Object.freeze(Object.defineProperty({__proto__:null,Demo:i,SidebarOptions:o,Themed:a,WithBadges:r,WithBreak:m,WithDetail:s,WithIcons:n,WithTimestamps:l,__namedExportsOrder:P,default:T},Symbol.toStringTag,{value:"Module"}));export{i as D,o as S,D as T,n as W,s as a,m as b,a as c,l as d};
