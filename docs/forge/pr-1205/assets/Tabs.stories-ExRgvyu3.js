import{A as r,b as t}from"./iframe-BblV6lM6.js";import{s as o,b as $,g as S}from"./utils-BUKDVvEj.js";import{o as h}from"./style-map-BXri1jdm.js";import{I as A,p as I,t as _}from"./tyler-icons-DRA6bGfg.js";import"./service-adapter-8tADcN_b.js";import"./tab-panel-RqDD2zgC.js";const{action:y}=__STORYBOOK_MODULE_ACTIONS__,v="forge-tab-bar",p=y("forge-tab-bar-change"),u=y("forge-tab-activate");A.define([I,_]);const B={title:"Components/Tabs",render:e=>{const a={...$(e)};e.vertical?a["max-width"]="200px":e.scrollButtons&&(a["max-width"]="500px");const f=Object.entries(a).length?h(a):r,m=Array.from({length:e.scrollButtons?20:3}).map((T,d)=>t`<forge-tab>
