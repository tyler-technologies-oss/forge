import{b as p,A as b}from"./iframe-CGF9490j.js";import{s as x,g as q,b as v}from"./utils-cbnKSSEt.js";import{o as y}from"./style-map-cEBdjqsX.js";import{n as c,e as m}from"./ref-9RqS8T1P.js";import{e as $}from"./class-map-C-Xl3VxB.js";import"./service-adapter-DlT-lJx7.js";import"./expansion-panel-BFvy7dNk.js";import"./open-icon-BDuGFBPz.js";import"./card-BggT-zBh.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
