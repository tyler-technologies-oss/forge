import{b as p,A as b}from"./iframe-BJPqycEt.js";import{s as x,g as q,b as v}from"./utils-CRT-IimF.js";import{o as y}from"./style-map-DHKItbxO.js";import{n as c,e as m}from"./ref-sYcdSB-8.js";import{e as $}from"./class-map-BdMx4Flt.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CPQPdK-O.js";import"./open-icon-CB3evKBE.js";import"./card-N3qjjXm_.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
