import{b as p,A as b}from"./iframe-CDZPIrnA.js";import{s as x,g as q,b as v}from"./utils-BUKDVvEj.js";import{o as y}from"./style-map-Bi3yv2V9.js";import{n as c,e as m}from"./ref-MfegYF2C.js";import{e as $}from"./class-map-CEBNhYyz.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DPFk1rbx.js";import"./open-icon-CeNJR1p8.js";import"./card-BvL89Hpb.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
