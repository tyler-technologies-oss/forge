import{b as p,A as b}from"./iframe-Ce60v_-f.js";import{s as x,g as q,b as v}from"./utils-E9-_u7-I.js";import{o as y}from"./style-map-BUz1CkTX.js";import{n as c,e as m}from"./ref-CMg4kJ4M.js";import{e as $}from"./class-map-Cl0H5FBP.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CaAUr0KD.js";import"./open-icon-C5O7QBme.js";import"./card-M5cMUYXh.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
