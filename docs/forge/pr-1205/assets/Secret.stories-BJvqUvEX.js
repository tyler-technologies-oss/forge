import{b,A as _}from"./iframe-CDZPIrnA.js";import{s as x,g as S,b as v,c as q}from"./utils-BUKDVvEj.js";import{o as h}from"./style-map-Bi3yv2V9.js";import{n as f,e as g}from"./ref-MfegYF2C.js";import"./service-adapter-8tADcN_b.js";import"./secret-DDFgtS4_.js";import"./icon-button-BGGeCJn0.js";import"./focus-indicator-C6gjbqoY.js";import"./state-layer-BkRErCgp.js";import"./tyler-icons-D-GJLevi.js";import"./button-C0WR4Msg.js";import"./tooltip-DTYSc0BY.js";import"./overlay-DIU5fAP8.js";const y="forge-secret",k={title:"Components/Secret",tags:["new"],render:o=>{const n=v(o),s=n?h(n):_,e=q(y,o);return e.textContent=o.text,s&&e.setAttribute("style",String(s)),e},component:y,parameters:{actions:{disable:!0}},argTypes:{...S({tagName:y,exclude:["name"],controls:{variant:{control:"select",options:["blur","masked","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",unmaskedCharacters:"",block:!1,buttonPosition:"end",showOnHover:!1}},l={},u={...x,render:()=>b`
