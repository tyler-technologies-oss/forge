import{b as p,A as b}from"./iframe-C_-ty6fL.js";import{s as x,g as q,b as v}from"./utils-BGcxM-UF.js";import{o as y}from"./style-map-Ch9RkZxO.js";import{n as c,e as m}from"./ref-DB5uxAn9.js";import{e as $}from"./class-map-CgsGLsz3.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-R28_EX7C.js";import"./open-icon-g3bM26yh.js";import"./card-COk2gUDk.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
