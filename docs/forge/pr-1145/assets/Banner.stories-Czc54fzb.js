import{b as s}from"./iframe-BEWXVjd9.js";import{I as d,g as f}from"./tyler-icons-uVJIcwMo.js";import"./service-adapter-8tADcN_b.js";import{B as l}from"./banner-Dpiv3DnF.js";import"./icon-button-BVSucFuv.js";import"./focus-indicator-D-wWffhJ.js";import"./state-layer-B-p_OOit.js";import"./button-Bdps6HIR.js";import{s as a,g,c as u,G as b}from"./utils-GdTrqNrR.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,m="forge-banner",p=c("forge-banner-dismissed"),v=c("forge-banner-before-dismiss"),h={title:"Components/Banner",render:i=>{const t=u("forge-banner",i);return t.addEventListener("forge-banner-dismissed",p),t.addEventListener("forge-banner-before-dismiss",v),t.innerHTML=i.text,t},component:m,argTypes:{...g({tagName:m,exclude:["canDismiss"],controls:{theme:{control:"select",options:[...b,"info-secondary"]}}})},args:{theme:l.defaults.THEME,text:"Minim sunt eu laborum labore minim.",dismissed:!1,persistent:!1}},e={},n={...a,render:()=>s`
