import{b as p,A as b}from"./iframe-C327hvo9.js";import{s as x,g as q,b as v}from"./utils-C5IA10r7.js";import{o as y}from"./style-map-p6Wo-b4j.js";import{n as c,e as m}from"./ref-WQ1Ui3NT.js";import{e as $}from"./class-map-DhJNZqa-.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BiYK9idJ.js";import"./open-icon-DNb8wJJ7.js";import"./card-D210I_oC.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
