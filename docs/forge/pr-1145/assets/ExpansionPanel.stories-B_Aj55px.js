import{b as p,A as b}from"./iframe-D8Fp7kb4.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-CSnEFRuB.js";import{n as c,e as m}from"./ref-92wG4Wed.js";import{e as $}from"./class-map-puY9W6u4.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-C6jp7jI1.js";import"./open-icon-BdkBLVOl.js";import"./card-CKEhHV8W.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
