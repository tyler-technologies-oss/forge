import{A as m,b as n}from"./iframe-GQTf_D8N.js";import{r as p,s as c,b as g,g as f,c as b}from"./utils-GdTrqNrR.js";import"./service-adapter-8tADcN_b.js";import{I as v,E as y}from"./tyler-icons-CRSlnQfT.js";import{s as q}from"./decorators-CeOkcDyA.js";import{e as h}from"./class-map-D4JRUC1k.js";import{o as x}from"./style-map-CkYYj1vj.js";import"./card-BHpMGwdB.js";import"./icon-button-BiF83EQi.js";import"./focus-indicator-CM6xz98y.js";import"./state-layer-B-p_OOit.js";import"./button-G0DffrWD.js";import"./scaffold-ALuq0Bgn.js";import"./toolbar-DUvH1SqL.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",C={title:"Components/Card",render:a=>{const s=b(i,a);return s.textContent=a.text,s},component:i,decorators:[q(S)],parameters:{actions:{disable:!0}},argTypes:{...f({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...c,render:()=>(v.define([y]),n`
      <div class="demo-card">
        <forge-card>
