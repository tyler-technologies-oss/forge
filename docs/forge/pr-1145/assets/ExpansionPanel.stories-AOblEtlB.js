import{b as p,A as b}from"./iframe-B6X6CCJg.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-ClrYzvUa.js";import{n as c,e as m}from"./ref-BiXjdsnc.js";import{e as $}from"./class-map-Uz5IpKUQ.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-p9dU4FUN.js";import"./open-icon-DEET34hX.js";import"./card-oa78OT2Y.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
