import{b as p,A as b}from"./iframe-B0vKBzPk.js";import{s as x,g as q,b as v}from"./utils-QCscRJfA.js";import{o as y}from"./style-map-D0CagAox.js";import{n as c,e as m}from"./ref-BJS7kJ4X.js";import{e as $}from"./class-map-yF0k6MxY.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-KB_ZOHJc.js";import"./open-icon--hoiUnqy.js";import"./card-DVSlM5Jf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
