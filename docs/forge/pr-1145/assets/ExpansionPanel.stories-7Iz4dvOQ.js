import{b as p,A as b}from"./iframe-CX1-OGuF.js";import{s as x,g as q,b as v}from"./utils-C5IA10r7.js";import{o as y}from"./style-map-B2UznZRL.js";import{n as c,e as m}from"./ref-oqaQl1KO.js";import{e as $}from"./class-map-C-MhOG7K.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BcUvGhOD.js";import"./open-icon-DEYHpK_9.js";import"./card-D2jiCLO-.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
