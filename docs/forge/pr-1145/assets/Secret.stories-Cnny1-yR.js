import{b,A as _}from"./iframe-B6X6CCJg.js";import{s as x,g as S,b as v,c as q}from"./utils-GdTrqNrR.js";import{o as h}from"./style-map-ClrYzvUa.js";import{n as f,e as g}from"./ref-BiXjdsnc.js";import"./service-adapter-8tADcN_b.js";import"./secret-BfoZPCD9.js";import"./icon-button-DVpILH4C.js";import"./focus-indicator-BndqCjt1.js";import"./state-layer-CKPcsXao.js";import"./tyler-icons-BzkfCrj4.js";import"./button-CDju6yp8.js";import"./tooltip-CE7u4Ary.js";import"./overlay-CX_m1mvq.js";const y="forge-secret",k={title:"Components/Secret",tags:["new"],render:o=>{const n=v(o),s=n?h(n):_,e=q(y,o);return e.textContent=o.text,s&&e.setAttribute("style",String(s)),e},component:y,parameters:{actions:{disable:!0}},argTypes:{...S({tagName:y,exclude:["name"],controls:{variant:{control:"select",options:["blur","masked","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",unmaskedCharacters:"",block:!1,buttonPosition:"end",showOnHover:!1}},l={},u={...x,render:()=>b`
