import{b as p,A as b}from"./iframe-BWAobhOu.js";import{s as x,g as q,b as v}from"./utils-BmZ1G202.js";import{o as y}from"./style-map-CyeIkLVB.js";import{n as c,e as m}from"./ref-D9GSnhK_.js";import{e as $}from"./class-map-BUxfhnyt.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Co5SsV4d.js";import"./open-icon-u5IwX--f.js";import"./card-D9IB3zRq.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
