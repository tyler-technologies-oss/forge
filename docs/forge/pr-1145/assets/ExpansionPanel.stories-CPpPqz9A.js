import{b as p,A as b}from"./iframe-DV1hlnLt.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-CySXS6FI.js";import{n as c,e as m}from"./ref-DtPuOJ0U.js";import{e as $}from"./class-map-CeCwxORi.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DDioj5v9.js";import"./open-icon-3X5flIxh.js";import"./card-DkU6wYBo.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
