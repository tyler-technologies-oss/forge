import{A as t,b as e}from"./iframe-BWAobhOu.js";import{s as O,b as V,g as z}from"./utils-BmZ1G202.js";import"./service-adapter-8tADcN_b.js";import{I as P,u as D,l as W,v as q,d as K,t as U,s as Y,w as G,x as J,y as Q,p as X}from"./tyler-icons-C2isZNDF.js";import{o as H}from"./style-map-CyeIkLVB.js";import{e as a}from"./class-map-BUxfhnyt.js";import{s as Z}from"./decorators-B823tmM6.js";import"./list-BVxyNe29.js";import"./drawer-DV7w1-5L.js";import"./avatar-CNy2wjid.js";import"./checkbox-Cp8REoWi.js";import"./key-action-lsAysfb-.js";import"./index-5CPwzmQS.js";import"./radio-group-DTE-tpfW.js";import"./label-DsFbV3le.js";import"./switch-vKLgt2Nh.js";import"./expansion-panel-Co5SsV4d.js";import"./open-icon-u5IwX--f.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
