import{b as r}from"./iframe-YJCmrxG6.js";import{s as d,c as p,g as I,G as C}from"./utils-GdTrqNrR.js";import"./service-adapter-8tADcN_b.js";import{h as v,g as h,d as y,p as _,r as S,t as $,I as w}from"./tyler-icons-DNFgH8fO.js";import{e as E}from"./class-map-Bu2cILmJ.js";import"./icon-button-BWTcf7oJ.js";import"./focus-indicator-CxOgR2nG.js";import"./state-layer-CKPcsXao.js";import"./circular-progress-BvJErdQG.js";import"./badge-bCCD_8DS.js";import"./label-CCJpr-qV.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";w.define([$,_,S,v,h,y]);const T=O("click"),x={title:"Components/Icon Button",render:o=>{const e=p(m,o);if(e.addEventListener("click",T),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=_.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=S.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=$.name,e.appendChild(n)}return e},component:m,argTypes:{...I({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:C},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
...
}`,...b.parameters?.docs?.source}}};const A=["Demo","Variants","Toggle","Anchor","Themed","WithBadge","WithCircularProgress","WithLabel","CSSOnly"],V=Object.freeze(Object.defineProperty({__proto__:null,Anchor:l,CSSOnly:b,Demo:a,Themed:g,Toggle:c,Variants:i,WithBadge:s,WithCircularProgress:f,WithLabel:u,__namedExportsOrder:A,default:x},Symbol.toStringTag,{value:"Module"}));export{l as A,b as C,a as D,V as I,c as T,i as V,s as W,g as a,f as b,u as c};
