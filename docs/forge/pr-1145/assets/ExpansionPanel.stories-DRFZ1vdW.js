import{b as p,A as b}from"./iframe-C7CPvnqQ.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-EMyN7v-F.js";import{n as c,e as m}from"./ref-C5HbB2k5.js";import{e as $}from"./class-map-DdN_wwgF.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-oOL2TCa-.js";import"./open-icon-BLrEg7sh.js";import"./card-96ZPePb7.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
