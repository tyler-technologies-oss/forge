import{b as p,A as b}from"./iframe-1a1WEcnC.js";import{s as x,g as q,b as v}from"./utils-DCILK08P.js";import{o as y}from"./style-map-CddThOmV.js";import{n as c,e as m}from"./ref-DQcqqp7S.js";import{e as $}from"./class-map-DCAci6sF.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-wuU9dw90.js";import"./open-icon-OFzj_TSj.js";import"./card-xPI6EPAH.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
