import{b as p,A as b}from"./iframe-DolTQ_ZR.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-BJFAeG1t.js";import{n as c,e as m}from"./ref-CA0tA1rz.js";import{e as $}from"./class-map-B0v8p4X_.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-B5LIaFGu.js";import"./open-icon-BNLN8PKz.js";import"./card-BMdtMQOe.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
