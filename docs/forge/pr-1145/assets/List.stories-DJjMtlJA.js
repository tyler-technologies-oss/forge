import{A as t,b as e}from"./iframe-btN_zwTw.js";import{s as O,b as V,g as z}from"./utils-GdTrqNrR.js";import"./service-adapter-8tADcN_b.js";import{I as P,u as D,l as W,v as q,d as K,t as U,s as Y,w as G,x as J,y as Q,p as X}from"./tyler-icons-tV2RfHbB.js";import{o as H}from"./style-map-0lR2kakA.js";import{e as a}from"./class-map-B-1kwgPd.js";import{s as Z}from"./decorators-ZtmtxOxo.js";import"./list-DCfdNf-1.js";import"./drawer-BJC8mhbC.js";import"./avatar-CuBo6Kv8.js";import"./checkbox-BX1EqKj5.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";import"./radio-group-Cx-BD8az.js";import"./label-CCJpr-qV.js";import"./switch-DaaIQuPU.js";import"./expansion-panel-DW0u-XN6.js";import"./open-icon-0sGZhyMz.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
...
}`,...v.parameters?.docs?.source}}};const ot=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","Multicolumn","CSSOnly"],It=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:v,Demo:h,Expandable:$,Interactive:p,Multicolumn:w,NavigationMenu:b,WithAnchor:u,__namedExportsOrder:ot,default:it},Symbol.toStringTag,{value:"Module"}));export{v as C,h as D,$ as E,p as I,It as L,w as M,b as N,u as W};
