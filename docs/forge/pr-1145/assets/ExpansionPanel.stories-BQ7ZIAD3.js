import{b as p,A as b}from"./iframe-BEWXVjd9.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-CY-kgomW.js";import{n as c,e as m}from"./ref-T2_jy34F.js";import{e as $}from"./class-map-BM5qfmA4.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CnhvFm_A.js";import"./open-icon-Dtvp648c.js";import"./card-rfSxY5MP.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
