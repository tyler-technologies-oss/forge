import{b as p,A as b}from"./iframe-BoJb98tf.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-DUxnbQb9.js";import{n as c,e as m}from"./ref-kANzuwQs.js";import{e as $}from"./class-map-CxA89Rj1.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-C_n8azec.js";import"./open-icon-JgSiXo1g.js";import"./card-BQPdjJX6.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
