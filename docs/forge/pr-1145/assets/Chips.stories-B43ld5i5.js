import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-Cl-vuQBY.js";import{b as t,A as n}from"./iframe-CKUxNUwK.js";import{o as h}from"./style-map-rrsoiJjf.js";import{e as c}from"./class-map-AnOwaCzX.js";import{b as u,g,G as _}from"./utils-GdTrqNrR.js";import"./avatar-CGOk1_cO.js";import"./chip-set-B6W09Nan.js";import"./focus-indicator-Dxwlqb8p.js";import"./state-layer-B-p_OOit.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
