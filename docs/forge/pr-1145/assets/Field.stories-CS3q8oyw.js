import{A as l,b as t}from"./iframe-C_y89U-L.js";import{s as _,b as T,g as z,G as k}from"./utils-GdTrqNrR.js";import{o as I}from"./style-map-BWrzWQLh.js";import{e as S}from"./class-map-BA70O26E.js";import{n as L,e as w}from"./ref-BF06XuXK.js";import{s as x}from"./decorators-Bvd6TL_s.js";import"./service-adapter-8tADcN_b.js";import"./base-field-CmXaQlYT.js";import"./focus-indicator-_-X7rpwi.js";import"./label-CCJpr-qV.js";import"./key-action-CxixFCpG.js";import"./index-5CPwzmQS.js";const E="forge-field",B={title:"Components/Field",component:E,render:e=>{const a=T(e),f=a?I(a):l,s=w();function c({target:n}){s.value&&(s.value.floatLabel=!!n.value)}return t`
      <forge-field
        ${L(s)}
...
}`,...d.parameters?.docs?.source}}};const D=["Demo","StaticField","CSSOnly"],te=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:d,Demo:r,StaticField:p,__namedExportsOrder:D,default:B},Symbol.toStringTag,{value:"Module"}));export{d as C,r as D,te as F,p as S};
