import{b as p,A as b}from"./iframe-GQTf_D8N.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-CkYYj1vj.js";import{n as c,e as m}from"./ref-CEjLCg-2.js";import{e as $}from"./class-map-D4JRUC1k.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-B0hustO7.js";import"./open-icon-BpBH2r_J.js";import"./card-BHpMGwdB.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
