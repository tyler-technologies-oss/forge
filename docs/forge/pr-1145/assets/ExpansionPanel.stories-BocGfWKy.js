import{b as p,A as b}from"./iframe-CihVPDBI.js";import{s as x,g as q,b as v}from"./utils-DujU4KjQ.js";import{o as y}from"./style-map-CHSJtYS_.js";import{n as c,e as m}from"./ref-BfS8-bi1.js";import{e as $}from"./class-map-UpdrPKCk.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BZ6oAuO5.js";import"./open-icon-DXMeRJcG.js";import"./card-iJmmEwBJ.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
