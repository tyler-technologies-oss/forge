import{b as p,A as b}from"./iframe-BTmUWVwH.js";import{s as x,g as q,b as v}from"./utils-Cu3TicFl.js";import{o as y}from"./style-map-C6OJkCQH.js";import{n as c,e as m}from"./ref-DvIuYQtJ.js";import{e as $}from"./class-map-Bql9K1QM.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DEdhFBI3.js";import"./open-icon-06xTWQce.js";import"./card-DzWcAfpK.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
