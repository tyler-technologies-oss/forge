import{b,A as _}from"./iframe-DV1hlnLt.js";import{s as x,g as S,b as v,c as q}from"./utils-GdTrqNrR.js";import{o as h}from"./style-map-CySXS6FI.js";import{n as f,e as g}from"./ref-DtPuOJ0U.js";import"./service-adapter-8tADcN_b.js";import"./secret-D6TF95lF.js";import"./icon-button-DIIeI-ib.js";import"./focus-indicator-CSOOyR2s.js";import"./state-layer-B-p_OOit.js";import"./tyler-icons-dYOWTbWz.js";import"./button-kyjDGESX.js";import"./tooltip-BDO8tOZg.js";import"./overlay-d7QE-4pI.js";const y="forge-secret",k={title:"Components/Secret",tags:["new"],render:o=>{const n=v(o),s=n?h(n):_,e=q(y,o);return e.textContent=o.text,s&&e.setAttribute("style",String(s)),e},component:y,parameters:{actions:{disable:!0}},argTypes:{...S({tagName:y,exclude:["name"],controls:{variant:{control:"select",options:["blur","masked","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",unmaskedCharacters:"",block:!1,buttonPosition:"end",showOnHover:!1}},l={},u={...x,render:()=>b`
