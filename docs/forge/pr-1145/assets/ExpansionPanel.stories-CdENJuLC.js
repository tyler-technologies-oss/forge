import{b as p,A as b}from"./iframe-C_y89U-L.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-BWrzWQLh.js";import{n as c,e as m}from"./ref-BF06XuXK.js";import{e as $}from"./class-map-BA70O26E.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CDC5JYvk.js";import"./open-icon-DZBro1nZ.js";import"./card-CwrY8OUO.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
