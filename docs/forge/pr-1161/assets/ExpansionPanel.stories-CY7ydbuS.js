import{b as p,A as b}from"./iframe-CQm9tmuM.js";import{s as x,g as q,b as v}from"./utils-GdTrqNrR.js";import{o as y}from"./style-map-D4JYCmDE.js";import{n as c,e as m}from"./ref-C88kp1gx.js";import{e as $}from"./class-map-CHifizwq.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-sQ2l3aL0.js";import"./open-icon-CbcNYKdS.js";import"./card-D4pUN3M7.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
