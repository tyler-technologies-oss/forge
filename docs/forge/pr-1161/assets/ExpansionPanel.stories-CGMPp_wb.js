import{b as p,A as b}from"./iframe-BjSnTnt_.js";import{s as x,g as q,b as v}from"./utils-CO0dVEgQ.js";import{o as y}from"./style-map-CwWq24gX.js";import{n as c,e as m}from"./ref-D2lwpcfw.js";import{e as $}from"./class-map-TxyakdE7.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BoXOdb9_.js";import"./open-icon-CYX6WvgD.js";import"./card-BYnLDEow.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
