import{b as p,A as b}from"./iframe-BFW7YWlB.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-8ZOwW1pM.js";import{n as c,e as m}from"./ref-jxHzS_QW.js";import{e as $}from"./class-map-D48gKP3a.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-E8w8G0YP.js";import"./open-icon-DqYVi-aM.js";import"./card-MJdJuZf2.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
