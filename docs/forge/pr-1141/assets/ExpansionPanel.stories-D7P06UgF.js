import{b as p,A as b}from"./iframe-BuM4FWjo.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-vW2kOHO7.js";import{n as c,e as m}from"./ref-DROuKQqx.js";import{e as $}from"./class-map-DAcJT-2V.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-fMXDrspo.js";import"./open-icon-B6nubsGi.js";import"./card-CXNUkQpv.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
