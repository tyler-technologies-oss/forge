import{b as p,A as b}from"./iframe-DXVgdaHV.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-D9oL5vvA.js";import{n as c,e as m}from"./ref-Gs93cBxP.js";import{e as $}from"./class-map-oM0Z_Lrs.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-5QB7Y-LB.js";import"./open-icon-ChG1l_NL.js";import"./card-21X2i5QI.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
