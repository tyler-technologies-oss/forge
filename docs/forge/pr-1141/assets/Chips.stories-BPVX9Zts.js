import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-BKl8G81U.js";import{b as t,A as n}from"./iframe-B7ISy-Z8.js";import{o as h}from"./style-map-Dp5Ftkdg.js";import{e as c}from"./class-map-GkXfyAds.js";import{b as u,g,G as _}from"./utils-QQyHyWEl.js";import"./avatar-BGClYZB0.js";import"./chip-set-DN38c5q_.js";import"./focus-indicator-BWBykkMf.js";import"./state-layer-CK5iHsfr.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
