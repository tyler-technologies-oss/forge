import{b as p,A as b}from"./iframe-B7ISy-Z8.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-Dp5Ftkdg.js";import{n as c,e as m}from"./ref-Bt7B-JQx.js";import{e as $}from"./class-map-GkXfyAds.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel--36EdadW.js";import"./open-icon-CytoevY5.js";import"./card-JBozch0K.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
