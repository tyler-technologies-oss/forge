import"./service-adapter-8tADcN_b.js";import{I as b,h as $,i as y,j as S,k as A}from"./tyler-icons-DQMeF6yH.js";import{b as t,A as n}from"./iframe-BFW7YWlB.js";import{o as h}from"./style-map-8ZOwW1pM.js";import{e as c}from"./class-map-D48gKP3a.js";import{b as u,g,G as _}from"./utils-QQyHyWEl.js";import"./avatar-B3R-rdGi.js";import"./chip-set-6XoOlk7g.js";import"./focus-indicator-C_B6JppV.js";import"./state-layer-CK5iHsfr.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
