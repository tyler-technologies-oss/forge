import{b as c,A as m}from"./iframe-Asho65FF.js";import{s as l,g as u,b as d,c as p}from"./utils-BnVlj7nJ.js";import{o as g}from"./style-map-DdwerjMx.js";import"./service-adapter-8tADcN_b.js";import"./secret-BL9YdqVv.js";const a="forge-secret",f={title:"Components/Secret",render:o=>{const n=d(o),i=n?g(n):m,s=p(a,o);return s.textContent=o.text,i&&s.setAttribute("style",String(i)),s},component:a,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:a,exclude:["name"],controls:{variant:{control:"select",options:["blur","dots"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",allow:"",block:!1,buttonPosition:"end",showOnHover:!1}},e={},t={...l,render:()=>c`
