import{b as c,A as m}from"./iframe-D-oXrMsO.js";import{s as l,g as u,b as d,c as p}from"./utils-avWsqrTA.js";import{o as g}from"./style-map-pFN0ywPa.js";import"./service-adapter-8tADcN_b.js";import"./secret-DaYVNTSV.js";const a="forge-secret",f={title:"Components/Secret",tags:["new"],render:o=>{const n=d(o),i=n?g(n):m,s=p(a,o);return s.textContent=o.text,i&&s.setAttribute("style",String(i)),s},component:a,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:a,exclude:["name"],controls:{variant:{control:"select",options:["blur","dots","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",allow:"",block:!1,buttonPosition:"end",showOnHover:!1}},e={},t={...l,render:()=>c`
