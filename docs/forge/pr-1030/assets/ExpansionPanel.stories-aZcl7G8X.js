import{b as p,A as b}from"./iframe-D-oXrMsO.js";import{s as x,g as q,b as v}from"./utils-avWsqrTA.js";import{o as y}from"./style-map-pFN0ywPa.js";import{n as c,e as m}from"./ref-CvEmn7HF.js";import{e as $}from"./class-map-CVrJ0jIt.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DGDv3lXO.js";import"./open-icon-B4HKh9_V.js";import"./card-zmEb5KAQ.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
