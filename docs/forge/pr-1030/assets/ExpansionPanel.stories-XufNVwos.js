import{b as p,A as b}from"./iframe-i7EfaxWb.js";import{s as x,g as q,b as v}from"./utils-BnVlj7nJ.js";import{o as y}from"./style-map-6WUpEBVp.js";import{n as c,e as m}from"./ref-DPacPhkY.js";import{e as $}from"./class-map-C0YwjgWa.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CQ2WU5Iy.js";import"./open-icon-DgLSXJpZ.js";import"./card-OEi-4eQT.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
