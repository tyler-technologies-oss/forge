import{A as i,b as c}from"./iframe-CxtGcj9H.js";import{s as l,g as f,b as g}from"./utils-BnVlj7nJ.js";import{o as v}from"./style-map-DFzst3aO.js";import{I as y,p as S,t as I}from"./tyler-icons-DJIRyMjT.js";import"./service-adapter-8tADcN_b.js";import"./tab-bar-OqwD1GrK.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",$=m("forge-tab-bar-change"),T=m("forge-tab-select");y.define([S,I]);const _={title:"Components/Tabs",render:e=>{const n={...g(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const u=Object.entries(n).length?v(n):i,p=Array.from({length:e.scrollButtons?20:3}).map((h,b)=>c`<forge-tab>
