import{b as p,A as b}from"./iframe-DN09JPRV.js";import{s as x,g as q,b as v}from"./utils-Ck-gGzab.js";import{o as y}from"./style-map-DkJgP4Dk.js";import{n as c,e as m}from"./ref-dHezzNoN.js";import{e as $}from"./class-map-03pu2nb2.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BR0qgNj1.js";import"./open-icon-iNRg8G6Z.js";import"./card-By5QV1S0.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
