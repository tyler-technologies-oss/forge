import{b as p,A as b}from"./iframe-mEEp4vyl.js";import{s as x,g as q,b as v}from"./utils-C2rEPPUi.js";import{o as y}from"./style-map-CzflIghb.js";import{n as c,e as m}from"./ref-DqND-WgH.js";import{e as $}from"./class-map-BEJIzRMM.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Crn33IsB.js";import"./open-icon-C5H8Ilt3.js";import"./card-B6IaFjjN.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
