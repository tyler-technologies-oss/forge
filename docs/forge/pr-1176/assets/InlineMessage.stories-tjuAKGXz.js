import{A as l,b as r}from"./iframe-DN09JPRV.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-Ck-gGzab.js";import"./service-adapter-8tADcN_b.js";import{I as h,s as x}from"./tyler-icons-BYsm4hFB.js";import{o as y}from"./style-map-DkJgP4Dk.js";import"./inline-message-wW24XM3J.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
