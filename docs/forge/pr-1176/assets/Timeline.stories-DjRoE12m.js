import"./service-adapter-8tADcN_b.js";import"./badge-Dj9DN67U.js";import"./card-ooFRJGqH.js";import{I as u,D as h,E as b,v,F as y}from"./tyler-icons-BvDuEu60.js";import"./timestamp-gfscBUNz.js";import{b as e}from"./iframe-Hc2vxO-3.js";import{s as t,g as S,d as k}from"./utils-Ck-gGzab.js";u.define([h,b,v,y]);const d="forge-timeline",T={title:"Components/Timeline",tags:["new"],render:p=>{const g=document.createElement("forge-timeline");return k(g,p),[{content:"Project kickoff meeting completed"},{content:"Initial design mockups reviewed"},{content:"API endpoints finalized"},{content:"Code review session"}].forEach(c=>{const f=document.createElement("forge-timeline-item");f.textContent=c.content,g.appendChild(f)}),g},component:d,subcomponents:{"Timeline Item":"forge-timeline-item","Timeline Break":"forge-timeline-break",Timestamp:"forge-timestamp"},argTypes:{...S({tagName:d})},args:{}},i={},n={...t,render:()=>e`
    <forge-timeline>
      <forge-timeline-item>
