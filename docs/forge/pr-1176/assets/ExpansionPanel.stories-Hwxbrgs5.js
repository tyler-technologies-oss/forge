import{b as p,A as b}from"./iframe-BYDrRnOm.js";import{s as x,g as q,b as v}from"./utils-CxQpgtu2.js";import{o as y}from"./style-map-C3Ky7ZYb.js";import{n as c,e as m}from"./ref-S4BTpHmw.js";import{e as $}from"./class-map-BCB0Y5Ww.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BDkLHSUg.js";import"./open-icon-BkpPCj4F.js";import"./card-DU46VE8F.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
