import{b as p,A as b}from"./iframe-NVT04YET.js";import{s as x,g as q,b as v}from"./utils-DI4_RuhW.js";import{o as y}from"./style-map-CzzPsxgO.js";import{n as c,e as m}from"./ref-B3hh8NAX.js";import{e as $}from"./class-map-CxV2E8D8.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Dc932FcP.js";import"./open-icon-CJXg7N1T.js";import"./card-Cvc47MjX.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
