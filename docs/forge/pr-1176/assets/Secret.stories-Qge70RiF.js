import{b,A as _}from"./iframe-BhK0cOWW.js";import{s as x,g as S,b as v,c as q}from"./utils-CCSzXMC0.js";import{o as h}from"./style-map-BqsNIil4.js";import{n as f,e as g}from"./ref-YpT5XeTJ.js";import"./service-adapter-8tADcN_b.js";import"./secret-sNsBN_cf.js";import"./icon-button-qZQTjUiV.js";import"./focus-indicator-CudRM6ZX.js";import"./state-layer-cKdDztbm.js";import"./tyler-icons-D2d9_cUK.js";import"./button-Db24jlQk.js";import"./tooltip-DkiBleqD.js";import"./overlay-BUwiotyV.js";const y="forge-secret",k={title:"Components/Secret",tags:["new"],render:o=>{const n=v(o),s=n?h(n):_,e=q(y,o);return e.textContent=o.text,s&&e.setAttribute("style",String(s)),e},component:y,parameters:{actions:{disable:!0}},argTypes:{...S({tagName:y,exclude:["name"],controls:{variant:{control:"select",options:["blur","masked","noise"]},buttonPosition:{control:"select",options:["start","end"]}}}),text:{control:"text"}},args:{text:"Secret content here",open:!1,variant:"blur",mask:"",maskCharacter:"●",unmaskedCharacters:"",block:!1,buttonPosition:"end",showOnHover:!1}},l={},u={...x,render:()=>b`
