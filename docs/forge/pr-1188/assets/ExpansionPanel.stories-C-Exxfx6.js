import{b as p,A as b}from"./iframe-DC_N5IcN.js";import{s as x,g as q,b as v}from"./utils-DKoLLPTK.js";import{o as y}from"./style-map-I61V31om.js";import{n as c,e as m}from"./ref-BQVW4Gad.js";import{e as $}from"./class-map-C5osXHh8.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-CJIc22cs.js";import"./open-icon-DgrJm0RL.js";import"./card-NvMoFFhf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
