import{b as p,A as b}from"./iframe-DMo3MVJF.js";import{s as x,g as q,b as v}from"./utils-BAJ2NYw0.js";import{o as y}from"./style-map-CeutLtB2.js";import{n as c,e as m}from"./ref-Cf8tI1Ys.js";import{e as $}from"./class-map-B7H8eY1V.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Bhumm2Fb.js";import"./open-icon-CLpApPQ_.js";import"./card-DP576ngI.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
