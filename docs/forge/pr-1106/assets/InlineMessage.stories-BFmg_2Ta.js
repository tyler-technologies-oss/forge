import{A as l,b as r}from"./iframe-Nz47_fHD.js";import{s as g,b as p,g as u,c as f,G as v}from"./utils-Ba9gsS7G.js";import"./service-adapter-8tADcN_b.js";import{I as h,s as x}from"./tyler-icons-D4_mmXXb.js";import"./index-DTwfV0k0.js";import{o as y}from"./style-map-YtahPS12.js";import"./inline-message-DVysxEfs.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...u({tagName:t,controls:{theme:{control:{type:"select"},options:v}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
