import{b as s,A as c}from"./iframe-BXOKh2ua.js";import{s as l,g as f,b as v}from"./utils-QQyHyWEl.js";import{I as b,e as y}from"./tyler-icons-NX4jhktm.js";import"./service-adapter-8tADcN_b.js";import{o as S}from"./style-map-BijFJRqK.js";import"./avatar-DrDeWLnF.js";import{A}from"./avatar-constants-CQjzk1nU.js";import"./icon-button-LWSA5EEi.js";import"./focus-indicator-BYmmK4Oj.js";import"./state-layer-CK5iHsfr.js";const g="forge-avatar",I={title:"Components/Avatar",render:({text:r,letterCount:m,imageUrl:p,...d})=>{const i=v(d),u=i?S(i):c;return s`<forge-avatar
      style=${u}
      text=${r}
...
}`,...n.parameters?.docs?.source}}};const h=["Demo","WithImage","WithIcon","WithIconButton","CSSOnly"],j=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:n,Demo:e,WithIcon:t,WithIconButton:o,WithImage:a,__namedExportsOrder:h,default:I},Symbol.toStringTag,{value:"Module"}));export{j as A,n as C,e as D,t as W,a,o as b};
