import{b as p,A as b}from"./iframe-B_lgGbu6.js";import{s as x,g as q,b as v}from"./utils-m5ghmQjV.js";import{o as y}from"./style-map-B6MLvlAY.js";import{n as c,e as m}from"./ref-Cq9mIn0j.js";import{e as $}from"./class-map-DQUeiaZ3.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Dp73c8OX.js";import"./open-icon-C0WWHZ_p.js";import"./card-QjeOfePN.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
