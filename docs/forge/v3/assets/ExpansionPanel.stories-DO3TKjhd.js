import{b as p,A as b}from"./iframe-CO63VGWC.js";import{s as x,g as q,b as v}from"./utils-QQyHyWEl.js";import{o as y}from"./style-map-CjWqWnFZ.js";import{n as c,e as m}from"./ref-XTCHQ3p6.js";import{e as $}from"./class-map-DgG732pi.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-DwIF-HCf.js";import"./open-icon-DROAjt1T.js";import"./card-BGEzKhEk.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
