import{b as p,A as b}from"./iframe-DaYVxD-N.js";import{s as x,g as q,b as v}from"./utils-BzbOvxjB.js";import{o as y}from"./style-map-CpC5QqAq.js";import{n as c,e as m}from"./ref-CmlWGBww.js";import{e as $}from"./class-map-Dbrh4Ikb.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-Bqv2ohWY.js";import"./open-icon-DE8cNyQv.js";import"./card-Dvq0KOUA.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
