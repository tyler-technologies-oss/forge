import{b as p,A as b}from"./iframe-Y92HmdHZ.js";import{s as x,g as q,b as v}from"./utils-DbbJplVM.js";import{o as y}from"./style-map-CPyruTRu.js";import{n as c,e as m}from"./ref-C9xd_Bhv.js";import{e as $}from"./class-map-COdHIAbq.js";import"./service-adapter-8tADcN_b.js";import"./expansion-panel-BJnc3kmq.js";import"./open-icon-BWpwmz_Y.js";import"./card-De0-ErPh.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",L=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),h={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):b,i=m();function g(f){L(),i.value?.setAttribute("aria-expanded",f.detail.toString())}return p`
