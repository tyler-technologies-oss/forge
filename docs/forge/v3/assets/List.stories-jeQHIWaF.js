import{A as t,b as e}from"./iframe-Y92HmdHZ.js";import{s as O,b as V,g as z}from"./utils-DbbJplVM.js";import"./service-adapter-8tADcN_b.js";import{I as P,e as D,f as W,g as q,d as K,t as U,w as Y,x as G,y as J,z as Q,s as X}from"./tyler-icons-SWWw4qdQ.js";import{o as H}from"./style-map-CPyruTRu.js";import{e as a}from"./class-map-COdHIAbq.js";import{s as Z}from"./decorators-MNVuHF7U.js";import"./list-CSKmw5w_.js";import"./list-item-DkeO-h5u.js";import"./drawer-DDIZKTPG.js";import"./avatar-B8eTfiem.js";import"./checkbox-C1eMKEmS.js";import"./key-action-lsAysfb-.js";import"./index-5CPwzmQS.js";import"./radio-group-uL1mzLjW.js";import"./label-DSSUgOwJ.js";import"./switch-D_CS2lkl.js";import"./expansion-panel-BJnc3kmq.js";import"./open-icon-BWpwmz_Y.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",R="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=V(n),C=l?H(l):t,y=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;y.push(e`
...
}`,...v.parameters?.docs?.source}}};const ot=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","Multicolumn","CSSOnly"],Lt=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:v,Demo:h,Expandable:$,Interactive:p,Multicolumn:w,NavigationMenu:b,WithAnchor:u,__namedExportsOrder:ot,default:it},Symbol.toStringTag,{value:"Module"}));export{v as C,h as D,$ as E,p as I,Lt as L,w as M,b as N,u as W};
