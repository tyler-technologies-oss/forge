import"./lit-element-BuSzPo2N.js";import{x as w}from"./lit-html-Ox1a2bD1.js";import{g as L}from"./_commonjsHelpers-CqkleIqs.js";var b={exports:{}},v;function P(){return v||(v=1,function(d,R){(function(){function C(h,$){var c,s=0,q=h.length,l,t="",e,r,f,i,n,a,p,S,y=!0,k=!1,u;c=arguments.length>1?$:{},typeof c.indent>"u"&&(c.indent="    "),typeof c.openbrace=="string"&&(y=c.openbrace==="end-of-line"),typeof c.autosemicolon=="boolean"&&(k=c.autosemicolon);function A(o){return o===" "||o===`
...
`,i=n.Ruleset;continue}if(t+=e,e==="("&&t.charAt(t.length-2)==="l"&&t.charAt(t.length-3)==="r"&&t.charAt(t.length-4)==="u"){i=n.URL;continue}continue}if(i===n.URL&&e===")"&&t.charAt(t.length-1!=="\\")){t+=e,i=n.Expression;continue}t+=e}return t=l.join("")+t,t}d.exports=C})()}(b)),b.exports}var U=P();const j=L(U);function I(d){return R=>w`
      ${R()}
