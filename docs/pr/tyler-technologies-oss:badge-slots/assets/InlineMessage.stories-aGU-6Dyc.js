import"./lit-element-BuSzPo2N.js";import{x as r,E as l}from"./lit-html-Ox1a2bD1.js";import{g as Q,s as I,G as C,c as z,b as M}from"./utils-C9ubTmun.js";import"./feature-detection-CY6TVbRZ.js";import{I as A,s as O}from"./icon-Bqgt-0wI.js";import"./index-CiLSBptl.js";import{o as V}from"./style-map-CeIg-cuG.js";import"./inline-message-CTo_BAYA.js";const t="forge-inline-message";A.define(O);const $={title:"Components/Inline Message",render:e=>{const a=z(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...Q({tagName:t,controls:{theme:{control:{type:"select"},options:C}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...I,render:({text:e})=>r`
    ...
    `},o={parameters:{controls:{include:/^--|text|withIcon/}},args:{withIcon:!1},render:({text:e,withIcon:a,..._})=>{const m=M(_),T=m?V(m):l;return r`
...
}`,...(S=(w=o.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};const b=["Demo","WithTitle","Themed","CSSOnly"],G=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:o,Demo:n,Themed:s,WithTitle:i,__namedExportsOrder:b,default:$},Symbol.toStringTag,{value:"Module"}));export{o as C,n as D,G as I,s as T,i as W};
