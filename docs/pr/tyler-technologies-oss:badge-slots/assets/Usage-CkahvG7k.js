import{j as e,M as a}from"./blocks-t_XZofO9.js";import{useMDXComponents as s}from"./index-DitRxeht.js";import"./iframe-Cb3H7on6.js";import"./_commonjsHelpers-CqkleIqs.js";function o(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Getting Started/Usage"}),`
...
`})}),`
`,e.jsx(n.p,{children:'These are just a few of the components that Forge provides. See the "Components" section in the sidebar for more information on the components available in Forge.'})]})}function d(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{d as default};
