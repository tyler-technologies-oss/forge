import{E,x as u}from"./iframe-Bh6VOYaj.js";import{g as O,s as A,a as P}from"./utils-D_oObhyi.js";import{o as R}from"./style-map-C0bv6awB.js";import{n as _,e as h}from"./ref-CQUqGCQM.js";import{e as V}from"./class-map-uL3QuilY.js";import"./feature-detection-uS6p5jc8.js";import"./expansion-panel-ZocQEO9B.js";import"./index-CiLSBptl.js";import"./card-PrYSYVAh.js";const{action:C}=__STORYBOOK_MODULE_ACTIONS__,d="forge-expansion-panel",j=C("forge-expansion-panel-toggle"),H=C("forge-expansion-panel-animation-complete"),W={title:"Components/Expansion Panel",component:d,render:e=>{const n=P(e),o=n?R(n):E,t=h();function p(l){var c;j(),(c=t.value)==null||c.setAttribute("aria-expanded",l.detail.toString())}return u`
