import"./lit-element-BuSzPo2N.js";import{x as r}from"./lit-html-Ox1a2bD1.js";import{a as U}from"./index-B-lxVbXh.js";import{g as X,s as d,G as Y,c as j}from"./utils-C9ubTmun.js";import{p as H,r as V,d as G,h as J,g as K,c as Q,I as Z}from"./icon-Bqgt-0wI.js";import{e as oo}from"./class-map-D3FxRsP9.js";import"./feature-detection-CY6TVbRZ.js";import"./icon-button-BkG6pY8m.js";import"./focus-indicator-Cgfkaa3d.js";import"./index-CiLSBptl.js";import"./state-layer-BVsNuAhs.js";import"./circular-progress-pTvFqlis.js";import"./badge-DZcU4TLt.js";import"./label-BM0pESju.js";import"./button-CC-L5W3b.js";import"./button-toggle-group-5BDyeLck.js";import"./checkbox-CF9fzMIR.js";import"./switch-ZI6WyDhE.js";const m="forge-icon-button";Z.define([G,H,V,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=j(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=H.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=V.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=G.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
    ...
    `},s={parameters:{controls:{exclude:["toggle","on","popoverIcon"]}},render:o=>{const e=j(m,o);e.setAttribute("aria-label","Icon button with badge");const n=document.createElement("forge-icon");n.name=K.name,e.appendChild(n);const t=document.createElement("forge-badge");return t.textContent="3",t.slot="badge",e.appendChild(t),e}},f={parameters:{controls:{include:["variant","theme","disabled"]}},render:({variant:o,theme:e,disabled:n})=>r`
...
}`,...(R=(F=u.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};var N,q,z;b.parameters={...b.parameters,docs:{...(N=b.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    controls: {
...
}`,...(z=(q=b.parameters)==null?void 0:q.docs)==null?void 0:z.source}}};const to=["Demo","Variants","Toggle","Anchor","Themed","WithBadge","WithCircularProgress","WithLabel","CSSOnly"],wo=Object.freeze(Object.defineProperty({__proto__:null,Anchor:l,CSSOnly:b,Demo:a,Themed:g,Toggle:c,Variants:i,WithBadge:s,WithCircularProgress:f,WithLabel:u,__namedExportsOrder:to,default:no},Symbol.toStringTag,{value:"Module"}));export{l as A,b as C,a as D,wo as I,c as T,i as V,s as W,g as a,f as b,u as c};
