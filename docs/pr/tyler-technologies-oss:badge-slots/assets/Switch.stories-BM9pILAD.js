import"./feature-detection-CY6TVbRZ.js";import{I as m,B as g,C as p}from"./icon-Bqgt-0wI.js";import"./index-CiLSBptl.js";import"./lit-element-BuSzPo2N.js";import{x as h}from"./lit-html-Ox1a2bD1.js";import{e as u}from"./class-map-D3FxRsP9.js";import{g as _,c as b}from"./utils-C9ubTmun.js";import"./switch-ZI6WyDhE.js";m.define([g,p]);const r="forge-switch",y={title:"Components/Switch",render:c=>{var o=b(r,c);return o.textContent="off/on",o},component:r,parameters:{actions:{disable:!0}},argTypes:{..._({tagName:r,exclude:["icon","form","labels","name","on","defaultOn","selected"],controls:{labelPosition:{control:"select",options:["start","end"]}}})}},e={},s={parameters:{controls:{include:["on","dense","disabled"]}},args:{checked:!1,dense:!1,disabled:!1},render:({checked:c,dense:o,disabled:f})=>h`
...
}`,...(d=(i=s.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const w=["Demo","CSSOnly"],D=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:s,Demo:e,__namedExportsOrder:w,default:y},Symbol.toStringTag,{value:"Module"}));export{s as C,e as D,D as S};
