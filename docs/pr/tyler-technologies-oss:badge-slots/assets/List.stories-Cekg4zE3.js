import"./lit-element-BuSzPo2N.js";import{E as t,x as e}from"./lit-html-Ox1a2bD1.js";import{a as st}from"./index-B-lxVbXh.js";import{g as j,s as Z,b as tt}from"./utils-C9ubTmun.js";import{I as rt,u as at,l as lt,v as ct,c as dt,d as gt,s as mt,w as ft,x as ht,y as pt,p as bt}from"./icon-Bqgt-0wI.js";import{o as et}from"./style-map-CeIg-cuG.js";import{e as a}from"./class-map-D3FxRsP9.js";import{s as ut}from"./decorators-CiKOYuay.js";import"./feature-detection-CY6TVbRZ.js";import"./list-DCzhHkfW.js";import"./drawer-DpoxQTjp.js";import"./index-CiLSBptl.js";import"./avatar-J3yRSZ-u.js";import"./checkbox-CF9fzMIR.js";import"./label-BM0pESju.js";import"./button-CC-L5W3b.js";import"./focus-indicator-Cgfkaa3d.js";import"./state-layer-BVsNuAhs.js";import"./button-toggle-group-5BDyeLck.js";import"./icon-button-BkG6pY8m.js";import"./switch-ZI6WyDhE.js";import"./expansion-panel-D16dSnMu.js";rt.define([at,lt,ct,dt,gt,mt,ft,ht,pt,bt]);const z="forge-list",O="forge-list-item",$t="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",wt=st("forge-list-item-select"),vt={title:"Components/List",render:n=>{const w=tt(n),M=w?et(w):t,v=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${$t}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;v.push(e`
  ...
  `)],argTypes:{...j({tagName:z,exclude:["active","noninteractive"]}),variant:{control:{type:"select"},options:["anchor","button","static"]},...j({tagName:O,exclude:["active","value","noninteractive"]}),selectedValue:{control:{type:"select"},options:["list-item-1","list-item-2","list-item-3","list-item-4"]},disabled:{control:{type:"boolean"},if:{arg:"variant",eq:"button"}}},args:{variant:"static",withStartIcon:!1,withEndIcon:!1,withAvatar:!1,withStartCheckbox:!1,withEndCheckbox:!1,withStartRadio:!1,withEndRadio:!1,withStartSwitch:!1,withEndSwitch:!1,disabled:!1,dense:!1,indented:!1,twoLine:!1,threeLine:!1,wrap:!1,selected:!1}},f={},h={args:{variant:"button"}},p={args:{variant:"anchor"}},b={...Z,render:()=>e`
    ...
    `},$={render:({variant:n,indented:w,wrap:M,dense:v,disabled:i,twoLine:r,threeLine:o,withStartIcon:x,withEndIcon:_,withAvatar:_t,withStartCheckbox:y,withEndCheckbox:I,withStartRadio:L,withEndRadio:S,withStartSwitch:T,withEndSwitch:E,selectedValue:k,...nt})=>{const C=tt(nt),it=C?et(C):t,ot={"forge-list":!0,"forge-list--indented":w,"forge-list--wrap":M,"forge-list--dense":v,"forge-list--two-line":r,"forge-list--three-line":o},l=({area:s})=>e`<svg class=${a({"forge-icon":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Forge design system logo</title><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.9 3.2h-7.5c-.4 0-.7.2-.9.5l-1.6 2.9c-.3.5-.1 1.2.4 1.5.2.1.4.1.5.1h7.5c.4 0 .7-.2.9-.5l1.6-2.9c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.1-.5-.1zm-3.6 6.2H9.8c-.4 0-.8.2-1 .6l-1.6 2.7c-.2.3-.2.8 0 1.1l3.8 6.5c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l5.3-9.2c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.2-.5-.2zm-6.9-4.6c.3-.5.1-1.2-.4-1.5-.2-.1-.4-.1-.6-.1H3c-.6 0-1.1.5-1.1 1.1 0 .2.1.4.1.5l2.7 4.6.5.9c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l3.3-5.5z"/></svg>`,c=({area:s,id:m})=>e`<div class=${a({"forge-checkbox":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})}>
...
}`,...(Y=(X=$.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const xt=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","CSSOnly"],qt=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:$,Demo:f,Expandable:u,Interactive:h,NavigationMenu:b,WithAnchor:p,__namedExportsOrder:xt,default:vt},Symbol.toStringTag,{value:"Module"}));export{$ as C,f as D,u as E,h as I,qt as L,b as N,p as W};
