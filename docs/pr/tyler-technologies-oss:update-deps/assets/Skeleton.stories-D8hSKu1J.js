import{x as t,E as k}from"./iframe-BnJdS9oE.js";import{g as p,c as u,s as f,a as y}from"./utils-D7XrLKwY.js";import{e as h}from"./class-map-DvIqsSwT.js";import{o as v}from"./style-map-DVE0Z-ag.js";import"./feature-detection-BwPJgXni.js";import"./skeleton-1JRnRe4N.js";const g="forge-skeleton",x={title:"Components/Skeleton",render:e=>u(g,e),component:g,parameters:{actions:{disable:!0}},argTypes:{...p({tagName:g})},args:{}},o={},r={...f,render:()=>t`
  ...
  `},i={argTypes:{type:{options:["default","avatar","list-item","text","chip","button","form-field"],control:{type:"select"}}},args:{type:"default"},render:({type:e,...c})=>{const d=y(c),m=d?v(d):k;return t` <div class=${h({"forge-skeleton":!0,"forge-skeleton--avatar":e==="avatar","forge-skeleton--list-item":e==="list-tem","forge-skeleton--text":e==="text","forge-skeleton--chip":e==="chip","forge-skeleton--button":e==="button","forge-skeleton--form-field":e==="form-field"})} style=${m}></div> `}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"{}",...o.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
