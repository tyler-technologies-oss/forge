import{x as i}from"./iframe-CIxyDGlH.js";import{g as p,s as c,d as l}from"./utils-D7XrLKwY.js";import"./feature-detection-BwPJgXni.js";import"./meter-group-CH9UCD8_.js";import"./key-item-Djze3CF5.js";const m="forge-meter",s=t=>{t.id="meter";const e=document.createElement("label");e.htmlFor="meter",e.textContent="Label",t.appendChild(e)},d={title:"Components/Meter",render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e},component:m,subcomponents:{"Meter Group":"forge-meter-group"},argTypes:{...p({tagName:m,exclude:["percentage"],controls:{value:{control:{type:"number",step:.1}},min:{control:{type:"number",step:.1}},max:{control:{type:"number",step:.1}},low:{control:{type:"number",step:.1}},high:{control:{type:"number",step:.1}},optimum:{control:{type:"number",step:.1}},valueMode:{control:{type:"inline-radio"},options:["manual","percentage","value"]},direction:{control:{type:"inline-radio"},options:["horizontal","vertical"]},shape:{control:{type:"inline-radio"},options:["default","rounded","squared"]},innerShape:{control:{type:"inline-radio"},options:["default","inherit"]},density:{control:{type:"select"},options:["small","medium","large"]},theme:{control:{type:"select"},options:["default","primary","secondary","tertiary","success","warning","error","info"]}}})},args:{value:.5,min:0,max:1,tickmarks:!1,valueMode:"manual",direction:"horizontal",shape:"default",innerShape:"default",density:"medium",theme:"default",muted:!1}},r={},o={render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e.setAttribute("low","0.33"),e.setAttribute("high","0.67"),e.setAttribute("optimum","1"),e}},n={...c,render:t=>{const e=document.createElement("forge-meter");return l(e,t),s(e),e.setAttribute("tickmarks",""),e.style.setProperty("--forge-meter-tickmarks","9"),e}},a={argTypes:{min:{control:{type:"number",step:.1}},max:{control:{type:"number",step:.1}},tickmarks:{control:{type:"boolean"}},direction:{control:{type:"inline-radio"},options:["horizontal","vertical"]},shape:{control:{type:"inline-radio"},options:["default","rounded","squared"]},innerShape:{control:{type:"inline-radio"},options:["default","inherit"]},density:{control:{type:"select"},options:["small","medium","large"]}},args:{min:0,max:1,tickmarks:!1,direction:"horizontal",shape:"default",innerShape:"default",density:"medium"},render:t=>i`
      <forge-meter-group
        id="meter-group"
        .min=${t.min}
        .max=${t.max}
...
}`,...a.parameters?.docs?.source}}};const u=["Demo","Segmented","Tickmarks","Grouped"],h=Object.freeze(Object.defineProperty({__proto__:null,Demo:r,Grouped:a,Segmented:o,Tickmarks:n,__namedExportsOrder:u,default:d},Symbol.toStringTag,{value:"Module"}));export{r as D,a as G,h as M,o as S,n as T};
