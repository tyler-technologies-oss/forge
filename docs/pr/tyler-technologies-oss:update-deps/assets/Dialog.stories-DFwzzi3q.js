import"./feature-detection-BwPJgXni.js";import{D as o}from"./dialog-CYY7E81K.js";import"./backdrop-uKV88UE6.js";import{I as h,C as b}from"./icon-FzRol6Tl.js";import"./index-5CPwzmQS.js";import{x as y,B as S}from"./iframe-BnJdS9oE.js";import{e as E}from"./class-map-DvIqsSwT.js";import{s as T}from"./decorators-B1RYw9iA.js";import{c as C,g as D}from"./utils-D7XrLKwY.js";import"./icon-button-DpLi6_yQ.js";import"./focus-indicator-B9KMEBVK.js";import"./state-layer-CLjAHnoF.js";import"./button-Bjtey6FZ.js";import"./scaffold-CwOy6RR7.js";import"./toolbar-BtzJRWgQ.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),x=a("forge-dialog-before-close"),L=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=C("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",x),e.addEventListener("forge-dialog-move-start",L),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
