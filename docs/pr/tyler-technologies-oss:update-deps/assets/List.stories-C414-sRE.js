import{E as t,x as e}from"./iframe-CIxyDGlH.js";import{g as O,s as A,a as V}from"./utils-D7XrLKwY.js";import{I as N,u as D,l as P,v as W,c as q,d as K,s as U,w as Y,x as G,y as J,p as Q}from"./icon-FzRol6Tl.js";import{o as H}from"./style-map-l48G0zrc.js";import{e as r}from"./class-map-DSbjH6Po.js";import{s as X}from"./decorators-sF-29HcM.js";import"./feature-detection-BwPJgXni.js";import"./list-ucSdTmS4.js";import"./drawer-DSWr6wim.js";import"./index-5CPwzmQS.js";import"./avatar-DafqDS7r.js";import"./checkbox-DYAJ7rMi.js";import"./label-73doN4RE.js";import"./button-Bjtey6FZ.js";import"./focus-indicator-B9KMEBVK.js";import"./state-layer-CLjAHnoF.js";import"./button-toggle-group-C96H3ppB.js";import"./icon-button-DpLi6_yQ.js";import"./switch-WjqoziFM.js";import"./expansion-panel-BUfwVSJ6.js";const{action:Z}=__STORYBOOK_MODULE_ACTIONS__;N.define([D,P,W,q,K,U,Y,G,J,Q]);const j="forge-list",z="forge-list-item",tt="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",et=Z("forge-list-item-select"),nt={title:"Components/List",render:n=>{const w=V(n),M=w?H(w):t,v=[];for(let i=0;i<4;i++){const a=n.wrap?`List item ${i+1} ${tt}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${a}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${a}</a>`:e`<span>${a}</span>`;v.push(e`
...
}`,...$.parameters?.docs?.source}}};const it=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","CSSOnly"],Lt=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:$,Demo:f,Expandable:u,Interactive:h,NavigationMenu:b,WithAnchor:p,__namedExportsOrder:it,default:nt},Symbol.toStringTag,{value:"Module"}));export{$ as C,f as D,u as E,h as I,Lt as L,b as N,p as W};
