import{a as r,i as l,g as p,b as f,d as g,e as x}from"./constants-y3-o2nLB.js";import{t as I}from"./feature-detection-BwPJgXni.js";/**
 * @license
 ...
 */function y(c){const i=class i extends c{get form(){return this[l].form}get labels(){return this[l].labels}get name(){return this.getAttribute("name")??""}set name(t){I(this,!!t,"name",t)}[p](){return this[f]()}formDisabledCallback(t){this.disabled=t}set[g](t){const n=t==="select"?document.createElement("select"):document.createElement("input");n.setAttribute("type",t),n.name="internal",this._inputElement=n}[x](t){if(this._inputElement){if(this[l].validity.customError)return this[l].validationMessage;if(this._inputElement){const n=Object.entries(t);for(const[e,a]of n)this._inputElement[e]=a}return this._inputElement.validationMessage}}};i.formAssociated=!0;let s=i;return s}export{y as W,T as a};
