import"./feature-detection-DRCh51Sa.js";import{D as o}from"./dialog-CLmuz5Eb.js";import"./backdrop-CpAR1sZH.js";import{I as N}from"./icon-CND1_bFA.js";import"./index-CiLSBptl.js";import{x as w}from"./index-ByifSpfC.js";import"./lit-element-JplMEnZc.js";import{B as F,x as P}from"./lit-html-paDGiEfB.js";import{e as Y}from"./class-map-D55lQyt8.js";import{s as G}from"./decorators-DOnQS6BC.js";import{c as H,g as U}from"./utils-BQFuezvl.js";import{a}from"./index-Cf3axooF.js";import"./icon-button-BBeQfCZG.js";import"./focus-indicator-CcRMHyPf.js";import"./state-layer-CeKzZv66.js";import"./button-BGYCwjxN.js";import"./scaffold-D66s8WNO.js";import"./toolbar-DrgqBcwu.js";const j=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=H("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
