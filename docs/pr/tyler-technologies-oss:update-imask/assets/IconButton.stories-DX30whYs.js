import"./lit-element-JplMEnZc.js";import{x as r}from"./lit-html-paDGiEfB.js";import{a as U}from"./index-Cf3axooF.js";import{c as z,g as X,s as d,G as Y}from"./utils-BQFuezvl.js";import{t as H}from"./index-fxMNKkgx.js";import{I as Z}from"./icon-CND1_bFA.js";import{j as V,l as G,b as J,a as K,m as Q}from"./index-ByifSpfC.js";import{e as oo}from"./class-map-D55lQyt8.js";import"./feature-detection-DRCh51Sa.js";import"./icon-button-BBeQfCZG.js";import"./focus-indicator-CcRMHyPf.js";import"./index-CiLSBptl.js";import"./state-layer-CeKzZv66.js";import"./circular-progress-qTjvyVPT.js";import"./badge-Dp1fyGkw.js";import"./label-bSIdLwfs.js";import"./button-BGYCwjxN.js";import"./button-toggle-group-Bl_f3hVd.js";import"./checkbox-C0_Zuap3.js";import"./switch-C3Bp6VOE.js";const m="forge-icon-button";Z.define([H,V,G,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=z(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=V.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=G.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
