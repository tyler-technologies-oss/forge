...
implementation and provides a more convenient API for using the component which has the added benefit of also managing the component's state and behavior.`})]})}function d(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{d as default};
