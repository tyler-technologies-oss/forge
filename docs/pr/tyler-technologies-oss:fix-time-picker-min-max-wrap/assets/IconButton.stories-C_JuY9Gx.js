import{x as r}from"./iframe-DgPlgY2v.js";import{g as J,s as d,G as Q,c as j}from"./utils-Bnph8n13.js";import{p as H,r as V,d as G,h as K,g as U,c as Y,I as X}from"./icon-B8CdcxqJ.js";import{e as Z}from"./class-map-VyyRAxMT.js";import"./feature-detection-uS6p5jc8.js";import"./icon-button-DkluvO-9.js";import"./focus-indicator-IWpzSXYP.js";import"./index-CiLSBptl.js";import"./state-layer-BFwsAUDA.js";import"./circular-progress-xrl2HF46.js";import"./badge-0pfOKIjw.js";import"./label-BSASIOtP.js";import"./button-r2EMLpWm.js";import"./button-toggle-group-D5jBldBo.js";import"./checkbox-DOmkbh7U.js";import"./switch-Bt2bdQXJ.js";const{action:oo}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";X.define([G,H,V,K,U,Y]);const eo=oo("click"),no={title:"Components/Icon Button",render:o=>{const e=j(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=H.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=V.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=G.name,e.appendChild(n)}return e},component:m,argTypes:{...J({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Q},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
