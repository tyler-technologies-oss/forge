import{x as i}from"./iframe-DR51lazJ.js";import{I as a,h as s}from"./icon-B8CdcxqJ.js";import{s as n}from"./decorators-BqHlIeRn.js";import"./feature-detection-uS6p5jc8.js";import"./card-Hoc-29Ft.js";import"./button-r2EMLpWm.js";import"./focus-indicator-IWpzSXYP.js";import"./index-CiLSBptl.js";import"./state-layer-BFwsAUDA.js";import"./label-value-CaouEyrO.js";const d="forge-card{--forge-card-padding: 0;max-width:768px}.grid-container{display:grid;grid-template-columns:repeat(12,1fr);gap:var(--forge-spacing-medium);align-items:center;border-left:4px solid var(--forge-theme-primary);padding:8px}.illustration-container{display:flex}.illustration-container img{max-width:64px;grid-column:1/2}.date-request{grid-column:2/9}.view-all{grid-column:9/13;justify-self:end}";a.define(s);const l={title:"Recipes/Card/Request",decorators:[n(d)],render:()=>i`
    <forge-card>
