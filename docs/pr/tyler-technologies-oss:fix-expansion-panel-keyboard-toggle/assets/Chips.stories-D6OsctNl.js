import{I as T,g as z,h as L,i as V,j as E}from"./icon-BIwO9Z2o.js";import{E as n,x as t}from"./iframe-mS7RoxC1.js";import{o as C}from"./style-map-2A53FHV0.js";import{e as c}from"./class-map-DwN3JqLi.js";import{g,G as N,a as w}from"./utils-BIyK4qxX.js";import"./feature-detection-uS6p5jc8.js";import"./avatar-59OlvKIl.js";import"./chip-set-DXUdE59o.js";import"./focus-indicator-IWpzSXYP.js";import"./index-CiLSBptl.js";import"./state-layer-BFwsAUDA.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;T.define([z,L,V,E]);const f="forge-chip-set",m="forge-chip",P=d("forge-chip-select"),D=d("forge-chip-delete"),R=d("forge-chip-navigate"),x={title:"Components/Chips",render:e=>{const a=w(e),r=a?C(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
