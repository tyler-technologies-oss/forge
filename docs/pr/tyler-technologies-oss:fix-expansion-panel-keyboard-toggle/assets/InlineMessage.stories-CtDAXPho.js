import{x as r,E as l}from"./iframe-mS7RoxC1.js";import{g as Q,s as I,G as C,c as z,a as M}from"./utils-BIyK4qxX.js";import"./feature-detection-uS6p5jc8.js";import{I as A,r as O}from"./icon-BIwO9Z2o.js";import"./index-CiLSBptl.js";import{o as V}from"./style-map-2A53FHV0.js";import"./inline-message-By3BVHSa.js";const t="forge-inline-message";A.define(O);const $={title:"Components/Inline Message",render:e=>{const a=z(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...Q({tagName:t,controls:{theme:{control:{type:"select"},options:C}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...I,render:({text:e})=>r`
