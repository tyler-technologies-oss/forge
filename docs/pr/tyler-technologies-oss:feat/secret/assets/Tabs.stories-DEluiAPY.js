import{E as i,x as c}from"./iframe-CSGc-9i1.js";import{g as f,s as l,a as g}from"./utils-CW5S_tZJ.js";import{o as v}from"./style-map-Boc3J1bS.js";import{p as y,d as S}from"./tyler-icons-DSFxyJDy.js";import{I}from"./icon-8E01u_jy.js";import"./service-adapter-CffG5Lhq.js";import"./tab-bar-DOKWR5fP.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",$=m("forge-tab-bar-change"),T=m("forge-tab-select");I.define([y,S]);const _={title:"Components/Tabs",render:e=>{const n={...g(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const u=Object.entries(n).length?v(n):i,p=Array.from({length:e.scrollButtons?20:3}).map((A,b)=>c`<forge-tab>
...
}`,...s.parameters?.docs?.source}}};const h=["Demo","Vertical","Clustered","Scrolling","WithIcons"],V=Object.freeze(Object.defineProperty({__proto__:null,Clustered:o,Demo:t,Scrolling:a,Vertical:r,WithIcons:s,__namedExportsOrder:h,default:_},Symbol.toStringTag,{value:"Module"}));export{o as C,t as D,a as S,V as T,r as V,s as W};
