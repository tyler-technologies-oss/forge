import{I as b}from"./icon-8E01u_jy.js";import{h as $,i as y,j as S,k as A}from"./tyler-icons-DSFxyJDy.js";import{E as n,x as t}from"./iframe-DqfrXlUn.js";import{o as h}from"./style-map-DQHUlImX.js";import{e as c}from"./class-map-HKvjh5wC.js";import{g,G as _,a as u}from"./utils-CNsITwyF.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-Ca1aajUr.js";import"./chip-set-1x6dzdrY.js";import"./focus-indicator-ChhiSzD5.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
...
}`,...l.parameters?.docs?.source}}};const w=["Demo","Anchor","Avatar","CSSOnly"],B=Object.freeze(Object.defineProperty({__proto__:null,Anchor:s,Avatar:i,CSSOnly:l,Demo:o,__namedExportsOrder:w,default:C},Symbol.toStringTag,{value:"Module"}));export{s as A,B as C,o as D,i as a,l as b};
