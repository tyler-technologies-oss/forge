import{E as f,x as p}from"./iframe-DjbInO_b.js";import{g as b,s as x,a as v}from"./utils-CW5S_tZJ.js";import{o as y}from"./style-map-CmNzl15F.js";import{n as u,e as c}from"./ref-uI_3ijCe.js";import{e as q}from"./class-map-BegOB5P8.js";import"./service-adapter-CffG5Lhq.js";import"./expansion-panel-BVSc4qx-.js";import"./index-5CPwzmQS.js";import"./card-qjg9TM_m.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",$=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),L={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):f,t=c();function m(g){$(),t.value?.setAttribute("aria-expanded",g.detail.toString())}return p`
