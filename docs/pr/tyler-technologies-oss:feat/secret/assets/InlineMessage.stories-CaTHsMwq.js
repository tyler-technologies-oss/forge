import{x as r,E as l}from"./iframe-CSGc-9i1.js";import{g as p,s as g,G as u,c as f,a as v}from"./utils-CW5S_tZJ.js";import"./service-adapter-CffG5Lhq.js";import{I as h}from"./icon-8E01u_jy.js";import"./index-5CPwzmQS.js";import{s as x}from"./tyler-icons-DSFxyJDy.js";import{o as y}from"./style-map-Boc3J1bS.js";import"./inline-message-e4Sp2zCL.js";const t="forge-inline-message";h.define(x);const w={title:"Components/Inline Message",render:e=>{const a=f(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...p({tagName:t,controls:{theme:{control:{type:"select"},options:u}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...g,render:({text:e})=>r`
...
}`,...o.parameters?.docs?.source}}};const S=["Demo","WithTitle","Themed","CSSOnly"],O=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:o,Demo:n,Themed:s,WithTitle:i,__namedExportsOrder:S,default:w},Symbol.toStringTag,{value:"Module"}));export{o as C,n as D,O as I,s as T,i as W};
