import{I as b,h as $,i as y,j as S,k as A}from"./icon-Uwxy940_.js";import{E as n,x as t}from"./iframe-CxOf2Yik.js";import{o as h}from"./style-map-6UN5F9Db.js";import{e as c}from"./class-map-DPgdNXl9.js";import{g,G as _,a as u}from"./utils-CWNZ6DqN.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-BXJoD-HK.js";import"./chip-set-D9HJUKtP.js";import"./focus-indicator-6htZ7g-E.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
