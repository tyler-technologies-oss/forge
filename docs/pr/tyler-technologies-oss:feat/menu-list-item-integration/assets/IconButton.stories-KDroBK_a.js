import{x as r}from"./iframe-ud64zO_u.js";import{g as I,s as d,G as C,c as p}from"./utils-BbCJfv7X.js";import{p as v,r as h,d as y,h as _,g as S,c as $,I as w}from"./icon-kuXwuZAY.js";import{e as E}from"./class-map-C4l4StN0.js";import"./service-adapter-CffG5Lhq.js";import"./icon-button-OWCAyDQZ.js";import"./focus-indicator-CQxGFI1Q.js";import"./state-layer-gAgMwMHF.js";import"./index-5CPwzmQS.js";import"./circular-progress-_RSm0FGC.js";import"./badge-BGVJs88s.js";import"./label-BpmMwsnV.js";import"./button-Dl0vzed3.js";import"./button-toggle-group-BXa2zQOD.js";import"./checkbox-BlT3K3b7.js";import"./switch-DgrPy1JB.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";w.define([y,v,h,_,S,$]);const T=O("click"),x={title:"Components/Icon Button",render:o=>{const e=p(m,o);if(e.addEventListener("click",T),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=v.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=h.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=y.name,e.appendChild(n)}return e},component:m,argTypes:{...I({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:C},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
