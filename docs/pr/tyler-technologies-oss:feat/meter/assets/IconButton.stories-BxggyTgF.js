import"./lit-element-JplMEnZc.js";import{x as r}from"./lit-html-paDGiEfB.js";import{a as U}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as z,g as X,s as d,G as Y}from"./utils-bkiwdWVT.js";import{t as H}from"./index-fxMNKkgx.js";import{I as Z}from"./icon-B5S0VGIT.js";import{j as V,l as G,b as J,a as K,m as Q}from"./index-ByifSpfC.js";import{e as oo}from"./class-map-D55lQyt8.js";import"./feature-detection-ONR9WHvu.js";import"./icon-button-DipNuXsM.js";import"./focus-indicator-R2otSvsR.js";import"./index-BmocOEUj.js";import"./state-layer-B7GOb8iB.js";import"./circular-progress-Dxa58JUX.js";import"./badge-CzgFSHGZ.js";import"./label-CVpYv1kf.js";import"./button-vPgaRyW5.js";import"./button-toggle-group-7alPFAgU.js";import"./checkbox-e65WGDEs.js";import"./switch-BRBW-vzp.js";const m="forge-icon-button";Z.define([H,V,G,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=z(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=V.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=G.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,on:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
