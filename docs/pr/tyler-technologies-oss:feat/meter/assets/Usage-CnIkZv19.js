import{ae as e,af as a}from"./index-BoCG7zoI.js";import{u as s}from"./index-C-8hBKWm.js";import"./iframe-BG0ijkPf.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-BHYIh-Xd.js";import"./index-DrFu-skq.js";function o(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Getting Started/Usage"}),`
...
`,e.jsxs(n.p,{children:["Some Tyler Forge components provide ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/:state",rel:"nofollow",children:"custom states"}),` that enable targeting the component
in CSS under certain conditions using the `,e.jsx(n.code,{children:":state()"})," pseudo-class."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`forge-meter:state(optimum-value) {
  outline: 1px solid green;
}
`})}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:`States provide a more reliable way to find and style components based on their current state than similar features such as attributes, which are
...
`})}),`
`,e.jsx(n.p,{children:'These are just a few of the components that Forge provides. See the "Components" section in the sidebar for more information on the components available in Forge.'})]})}function m(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{m as default};
