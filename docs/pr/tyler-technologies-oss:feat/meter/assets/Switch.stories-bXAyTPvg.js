import"./feature-detection-DRCh51Sa.js";import{I as f}from"./icon-PniqSQTM.js";import"./index-BmocOEUj.js";import{w as g,x as p}from"./index-ByifSpfC.js";import"./lit-element-JplMEnZc.js";import{x as h}from"./lit-html-paDGiEfB.js";import{e as _}from"./class-map-D55lQyt8.js";import{c as u,g as b}from"./utils-Cisx8TMn.js";import"./switch-B8UkJq6I.js";f.define([g,p]);const t="forge-switch",w={title:"Components/Switch",render:r=>{var o=u(t,r);return o.textContent="off/on",o},component:t,parameters:{actions:{disable:!0}},argTypes:{...b({tagName:t,exclude:["icon","form","labels","name"],controls:{labelPosition:{control:"select",options:["start","end"]}}})}},e={},s={parameters:{controls:{include:["on","dense","disabled"]}},args:{on:!1,dense:!1,disabled:!1},render:({on:r,dense:o,disabled:m})=>h`
