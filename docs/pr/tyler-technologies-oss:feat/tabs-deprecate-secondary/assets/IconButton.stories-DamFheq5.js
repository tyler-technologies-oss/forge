import"./lit-element-CgJqSpuc.js";import{x as r}from"./lit-html-paDGiEfB.js";import{a as G}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as N,g as J,s as j,G as K}from"./utils-DzsNAH9x.js";import{t as q}from"./index-fxMNKkgx.js";import{I as Q}from"./icon-FszQmWVN.js";import{j as z,l as F,b as R,a as H,m as V}from"./index-ByifSpfC.js";import{e as U}from"./class-map-D55lQyt8.js";import"./constants-CFf81ck9.js";import"./icon-button-DxSYWoFH.js";import"./focus-indicator-DesOnyyZ.js";import"./index-BmocOEUj.js";import"./state-layer-COSQHCpS.js";import"./circular-progress-DnKst50i.js";import"./badge-CflmfcPU.js";import"./label-BLzPDfDj.js";import"./button-CVZhEkBO.js";import"./button-toggle-group-C7b9_lqU.js";import"./checkbox-D0zkkQHe.js";import"./switch-BD5yp80V.js";const m="forge-icon-button";Q.define([q,z,F,R,H,V]);const X=G("click"),Y={title:"Components/Icon Button",render:o=>{const e=N(m,o);if(e.addEventListener("click",X),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=z.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=F.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=q.name,e.appendChild(n)}return e},component:m,argTypes:{...J({tagName:m,exclude:["form","name","value","type"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:K},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,on:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...j,render:()=>r`
    ...
    `},c={parameters:{controls:{include:["variant"]}},render:({variant:o})=>r`
      <forge-icon-button .variant=${o}>
        <a href="javascript: alert('Icon button with anchor works!');" aria-label="Anchor link icon button">
          <forge-icon .name=${R.name}></forge-icon>
        </a>
      </forge-icon-button>
    ...
    `},s={parameters:{controls:{exclude:["toggle","on","popoverIcon"]}},render:o=>{const e=N(m,o);e.setAttribute("aria-label","Icon button with badge");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n);const t=document.createElement("forge-badge");return t.textContent="3",t.slot="badge",e.appendChild(t),e}},g={parameters:{controls:{include:["variant","theme","disabled"]}},render:({variant:o,theme:e,disabled:n})=>r`
...
}`,...(P=(O=g.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var L,M,W;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...standaloneStoryParams,
  render: () => {
    return html\`
      <forge-label style="display: flex; flex-direction: column; width: min-content; align-items: center;">
...
}`,...(W=(M=u.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var B,k,D;f.parameters={...f.parameters,docs:{...(B=f.parameters)==null?void 0:B.docs,source:{originalSource:`{
  parameters: {
    controls: {
