import{x as n,E as m}from"./iframe-D3U_-Q0v.js";import{g as p,s as c,r as g,c as f,a as b}from"./utils-DdcaARPV.js";import"./service-adapter-CffG5Lhq.js";import{I as v,E as y}from"./icon-Uwxy940_.js";import"./index-DTwfV0k0.js";import{s as q}from"./decorators-CwXSaQkf.js";import{e as h}from"./class-map-HDkwbH9s.js";import{o as x}from"./style-map-D-1x8AAo.js";import"./card-XBhSSRER.js";import"./icon-button-DWgEYW1A.js";import"./focus-indicator-DcugzhYf.js";import"./state-layer-BEEsPoZf.js";import"./button-D906GeCs.js";import"./scaffold-BrokB2Ba.js";import"./toolbar-U0axkpKl.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",C={title:"Components/Card",render:a=>{const s=f(i,a);return s.textContent=a.text,s},component:i,decorators:[q(S)],parameters:{actions:{disable:!0}},argTypes:{...p({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...c,render:()=>(v.define([y]),n`
      <div class="demo-card">
        <forge-card>
