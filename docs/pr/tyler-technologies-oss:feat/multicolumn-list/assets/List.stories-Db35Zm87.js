import{E as t,x as e}from"./iframe-BIyc1K6h.js";import{g as z,s as O,a as H}from"./utils-DsSoWqyO.js";import{I as P,u as D,l as W,v as q,c as K,d as U,s as Y,w as G,x as J,y as Q,p as X}from"./icon-Uwxy940_.js";import{o as F}from"./style-map-jG8Watj9.js";import{e as a}from"./class-map-j7IMjoYm.js";import{s as Z}from"./decorators-Bi00ZkgM.js";import"./service-adapter-CffG5Lhq.js";import"./list-BF8RDghp.js";import"./drawer-BsGDACAy.js";import"./index-DTwfV0k0.js";import"./avatar-BP2k9LfN.js";import"./checkbox-Dm9r62TG.js";import"./label-lXBGOXft.js";import"./button-BqmI2FOi.js";import"./focus-indicator-BDY9XSW3.js";import"./state-layer-BEEsPoZf.js";import"./button-toggle-group-CGoJPxgX.js";import"./icon-button-BBXJyImA.js";import"./switch-BNokJ9J2.js";import"./expansion-panel-BYSwwFye.js";import"./open-icon-pKbfwaP0.js";const{action:tt}=__STORYBOOK_MODULE_ACTIONS__;P.define([D,W,q,K,U,Y,G,J,Q,X]);const A="forge-list",V="forge-list-item",et="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",nt=tt("forge-list-item-select"),it={title:"Components/List",render:n=>{const l=H(n),C=l?F(l):t,x=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${et}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;x.push(e`
  ...
  `)],argTypes:{...z({tagName:A,exclude:["active","noninteractive"]}),variant:{control:{type:"select"},options:["anchor","button","static"]},...z({tagName:V,exclude:["active","value","noninteractive"]}),selectedValue:{control:{type:"select"},options:["list-item-1","list-item-2","list-item-3","list-item-4"]},disabled:{control:{type:"boolean"},if:{arg:"variant",eq:"button"}}},args:{variant:"static",withStartIcon:!1,withEndIcon:!1,withAvatar:!1,withStartCheckbox:!1,withEndCheckbox:!1,withStartRadio:!1,withEndRadio:!1,withStartSwitch:!1,withEndSwitch:!1,disabled:!1,dense:!1,indented:!1,twoLine:!1,threeLine:!1,wrap:!1,selected:!1,multicolumn:!1}},h={},p={args:{variant:"button"}},u={args:{variant:"anchor"}},b={...O,render:()=>e`
    ...
    `},w={...O,render:()=>{const n=[];for(let l=0;l<9;l++)n.push(e`
      ...
      `);return e` <forge-list multicolumn> ${n} </forge-list> `}},v={render:({variant:n,indented:l,wrap:C,dense:x,disabled:i,twoLine:r,threeLine:o,withStartIcon:_,withEndIcon:y,withAvatar:st,withStartCheckbox:I,withEndCheckbox:L,withStartRadio:S,withEndRadio:T,withStartSwitch:E,withEndSwitch:k,selectedValue:M,...R})=>{const j=H(R),B=j?F(j):t,N={"forge-list":!0,"forge-list--indented":l,"forge-list--wrap":C,"forge-list--dense":x,"forge-list--two-line":r,"forge-list--three-line":o},c=({area:s})=>e`<svg class=${a({"forge-icon":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Forge design system logo</title><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.9 3.2h-7.5c-.4 0-.7.2-.9.5l-1.6 2.9c-.3.5-.1 1.2.4 1.5.2.1.4.1.5.1h7.5c.4 0 .7-.2.9-.5l1.6-2.9c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.1-.5-.1zm-3.6 6.2H9.8c-.4 0-.8.2-1 .6l-1.6 2.7c-.2.3-.2.8 0 1.1l3.8 6.5c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l5.3-9.2c.3-.5.1-1.2-.4-1.5-.1-.1-.3-.2-.5-.2zm-6.9-4.6c.3-.5.1-1.2-.4-1.5-.2-.1-.4-.1-.6-.1H3c-.6 0-1.1.5-1.1 1.1 0 .2.1.4.1.5l2.7 4.6.5.9c.3.5 1 .7 1.5.4.2-.1.3-.2.4-.4l3.3-5.5z"/></svg>`,d=({area:s,id:f})=>e`<div class=${a({"forge-checkbox":!0,"forge-list-item__start":s==="start","forge-list-item__end":s==="end"})}>
