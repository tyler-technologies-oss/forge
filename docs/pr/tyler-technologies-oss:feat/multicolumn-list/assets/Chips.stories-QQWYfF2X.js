import{I as b,h as $,i as y,j as S,k as A}from"./icon-Uwxy940_.js";import{E as n,x as t}from"./iframe-D16noSNJ.js";import{o as h}from"./style-map-C_uT9xPL.js";import{e as c}from"./class-map-Clw0YZ_a.js";import{g,G as _,a as u}from"./utils-DsSoWqyO.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-DIR4-rkf.js";import"./chip-set-C1DvTPYU.js";import"./focus-indicator-BLwe5ycG.js";import"./state-layer-BEEsPoZf.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
