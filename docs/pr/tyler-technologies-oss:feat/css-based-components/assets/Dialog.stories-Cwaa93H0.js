import"./constants-DjE6emXm.js";import{D as o}from"./dialog-TURxzeUh.js";import"./backdrop-BKmy5m9d.js";import{I as N}from"./icon-DHpZ4R73.js";import"./index-Dh0vMUMR.js";import{x as w}from"./index-ByifSpfC.js";import{j as F,x as P}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{e as Y}from"./class-map-CDZWlD4a.js";import{s as j}from"./decorators-EVhofM2Q.js";import{c as G,g as H}from"./utils-CDvvFDpw.js";import{a}from"./chunk-454WOBUV-CM0pFb8Z.js";import"./icon-button-B5lcHsAP.js";import"./focus-indicator-BpCDYqsq.js";import"./state-layer-DkOkOFSZ.js";import"./button-CoZ69e4-.js";import"./scaffold-R2qvsZCm.js";import"./toolbar-SJpnF1yY.js";const U=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",s=>{U(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
