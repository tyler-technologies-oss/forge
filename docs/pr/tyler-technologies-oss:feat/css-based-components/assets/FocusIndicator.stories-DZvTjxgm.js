import{x as i,A as d}from"./lit-html-Bzgct6Ob.js";import{o as l}from"./style-map-D0ILlpbs.js";import{e as V}from"./class-map-CDZWlD4a.js";import{b as f,g as x}from"./utils-CDvvFDpw.js";import"./constants-DjE6emXm.js";import"./focus-indicator-BpCDYqsq.js";import"./index-Dh0vMUMR.js";import"./card-AhK8i1VF.js";const g="forge-focus-indicator",F={title:"Components/Focus Indicator",render:e=>{const t=f(e),r=t?l(t):d;return i`
    ...
    `}},a={parameters:{controls:{include:/^--|active|inward/}},render:({active:e,inward:t,...r})=>{const o=f(r),u=o?l(o):d;return i` <button type="button" class=${V({"forge-focus-indicator":!0,"forge-focus-indicator__target":!0,"forge-focus-indicator--active":e,"forge-focus-indicator--inward":t})} style=${u}>CSS-only Button</button> `}},c={parameters:{controls:{include:/^--|active|inward/}},render:({active:e,inward:t,...r})=>{const o=f(r),u=o?l(o):d;return i`
      <button type="button" class="forge-focus-indicator__target">
        CSS-only Button w/Sentinel Element
        <div class=${V({"forge-focus-indicator":!0,"forge-focus-indicator--active":e,"forge-focus-indicator--inward":t})} style=${u}></div>
      </button>
...
}`,...(h=(S=a.parameters)==null?void 0:S.docs)==null?void 0:h.source}}};var C,A,M;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
  parameters: {
    controls: {
      include: /^--|active|inward/
    }
