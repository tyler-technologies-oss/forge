import{a as d}from"./chunk-454WOBUV-CM0pFb8Z.js";import{I as T}from"./icon-DHpZ4R73.js";import{b as z,c as V,d as L,e as P}from"./index-ByifSpfC.js";import{x as t,T as o}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{o as C}from"./style-map-D0ILlpbs.js";import{e as c}from"./class-map-CDZWlD4a.js";import{b as M,g,G as E}from"./utils-DnAZaZRm.js";import"./constants-DjE6emXm.js";import"./avatar-9nkaewEO.js";import"./chip-set-zDMLJI_J.js";import"./focus-indicator-BpCDYqsq.js";import"./index-Dh0vMUMR.js";import"./state-layer-DkOkOFSZ.js";T.define([z,V,L,P]);const f="forge-chip-set",m="forge-chip",N=d("forge-chip-select"),x=d("forge-chip-delete"),D=d("forge-chip-navigate"),H={title:"Components/Chips",render:e=>{const a=M(e),r=a?C(a):o;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
    ...
    `},component:f,subcomponents:{Chip:m},argTypes:{...g({tagName:f,controls:{theme:{control:"select",options:E},type:{control:"select",options:["choice","filter","action","input","field"]}}}),...g({tagName:m,include:/^--forge-chip/}),withIcon:{control:"boolean"},iconSlot:{control:"select",options:["start","end"],if:{arg:"icon",eq:!0}}},args:{withIcon:!1,iconSlot:"end",vertical:!1,type:"action",dense:!1,disabled:!1,invalid:!1,theme:"primary"}},n={},s={parameters:{controls:{disable:!0}},render:()=>t`
    <forge-chip-set>
