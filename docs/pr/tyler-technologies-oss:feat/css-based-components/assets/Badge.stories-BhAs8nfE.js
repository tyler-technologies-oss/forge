import{x as s,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as B,g as H,s as c,b as O,G as V}from"./utils-CmNCmodr.js";import{a as _}from"./index-ByifSpfC.js";import{I as $}from"./icon-DHpZ4R73.js";import{e as C}from"./class-map-CDZWlD4a.js";import{o as W}from"./style-map-D0ILlpbs.js";import"./constants-DjE6emXm.js";import"./badge-BtnA6UF5.js";import"./icon-button-B5lcHsAP.js";import"./focus-indicator-BpCDYqsq.js";import"./index-Dh0vMUMR.js";import"./state-layer-DkOkOFSZ.js";const d="forge-badge",N={title:"Components/Badge",render:n=>{const e=B(d,n);return e.innerHTML=n.text,e},component:d,parameters:{actions:{disable:!0}},argTypes:{...H({tagName:d,controls:{theme:{control:"select",options:["default",...V,"info-primary","info-secondary"]}}})},args:{text:"Status"}},r={},o={...c,render:()=>s`
    ...
    `)},g={parameters:{controls:{exclude:["hide","strong"]}},args:{dot:!1,showIcon:!1},render:({text:n,dot:e,showIcon:E,...M})=>{const f=O(M),A=f?W(f):i;return s`
      <div class=${C({"forge-badge":!0,"forge-badge--dot":e})} style=${A}>
        ${E&&!e?s`<svg class="forge-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
}`,...(w=(I=t.parameters)==null?void 0:I.docs)==null?void 0:w.source}}};var T,P,z;g.parameters={...g.parameters,docs:{...(T=g.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      exclude: ['hide', 'strong']
    }
