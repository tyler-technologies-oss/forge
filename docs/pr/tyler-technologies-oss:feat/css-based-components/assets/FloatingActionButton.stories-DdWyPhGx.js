import{x as l,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{b as c,g as O,s as C,G as E,D as z}from"./utils-DnAZaZRm.js";import{o as d}from"./style-map-D0ILlpbs.js";import{e as B}from"./class-map-CDZWlD4a.js";import{j as F,k as H,b as M}from"./index-ByifSpfC.js";import{I as T}from"./icon-DHpZ4R73.js";import"./constants-DjE6emXm.js";import"./floating-action-button-DOqTIooE.js";import"./focus-indicator-BpCDYqsq.js";import"./index-Dh0vMUMR.js";import"./state-layer-DkOkOFSZ.js";import"./button-CoZ69e4-.js";const g="forge-fab";T.define([F,H,M]);const D={title:"Components/Floating Action Button",render:e=>{const s=c(e),o=s?d(s):i;return l`
      <forge-fab
        .theme=${e.theme}
        .density=${e.density}
    ...
    `},component:g,parameters:{actions:{disable:!0}},argTypes:{...O({tagName:g,exclude:["type","name","value","form"],controls:{theme:{control:"select",options:E},density:{control:"select",options:z},elevation:{control:"select",options:["raised","lowered"]}}})},args:{theme:"secondary",density:"medium",elevation:"raised",disabled:!1,popoverIcon:!1,dense:!1}},a={},r={render:e=>{const s=c(e),o=s?d(s):i;return l`
      <forge-fab
        .theme=${e.theme}
        .density=${e.density}
        .elevation=${e.elevation}
...
}`,...(I=(w=n.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};const j=["Demo","Extended","WithAnchor","CSSOnly"],Z=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:n,Demo:a,Extended:r,WithAnchor:t,__namedExportsOrder:j,default:D},Symbol.toStringTag,{value:"Module"}));export{n as C,a as D,r as E,Z as F,t as W};
