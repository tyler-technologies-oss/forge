import"./service-adapter-CffG5Lhq.js";import{D as o}from"./dialog-Dkd2fYmF.js";import"./backdrop-BDRZVysw.js";import{I as h,C as b}from"./icon-kuXwuZAY.js";import"./index-5CPwzmQS.js";import{x as y,B as S}from"./iframe-7ipV3BDo.js";import{e as E}from"./class-map-O7JS4q0S.js";import{s as T}from"./decorators-DnUT9gON.js";import{c as C,g as D}from"./utils-Cqbxq2Mi.js";import"./icon-button-53qOUJgX.js";import"./focus-indicator-DjsWD5XE.js";import"./state-layer-gAgMwMHF.js";import"./button-DlJOcJKO.js";import"./scaffold-BrokB2Ba.js";import"./toolbar-U0axkpKl.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,O=a("forge-dialog-close"),x=a("forge-dialog-before-close"),L=a("forge-dialog-move-start"),$=a("forge-dialog-move"),_=a("forge-dialog-move-end"),A=a("forge-dialog-fullscreen-change"),M=f=>{h.define(b);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=C("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{O(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",x),e.addEventListener("forge-dialog-move-start",L),e.addEventListener("forge-dialog-move",$),e.addEventListener("forge-dialog-move-end",_),e.addEventListener("forge-dialog-fullscreen-change",A),t.appendChild(e);const u=y`
    <forge-scaffold>
