import{I as b,h as $,i as y,j as S,k as A}from"./icon-kuXwuZAY.js";import{E as n,x as t}from"./iframe-C8CAg5pz.js";import{o as h}from"./style-map-BmRnyMZq.js";import{e as c}from"./class-map-D-q0eu3S.js";import{g,G as _,a as u}from"./utils-Bt9nZ5bj.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-Br8JLK6g.js";import"./chip-set-BHY9eWaK.js";import"./focus-indicator-Blh11crr.js";import"./state-layer-gAgMwMHF.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
