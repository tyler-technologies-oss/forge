import{I as T,g as z,h as L,i as V,j as E}from"./icon-ANstxuR5.js";import{E as n,x as t}from"./iframe-Bc1Hm-RY.js";import{o as C}from"./style-map-CtA_Sft_.js";import{e as c}from"./class-map-CxXSBXU-.js";import{g,G as N,a as w}from"./utils-BHhJX03F.js";import"./feature-detection-CY6TVbRZ.js";import"./avatar-D3wG7IUD.js";import"./chip-set-DGCYej-e.js";import"./focus-indicator-Cgfkaa3d.js";import"./index-CiLSBptl.js";import"./state-layer-BVsNuAhs.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;T.define([z,L,V,E]);const f="forge-chip-set",m="forge-chip",P=d("forge-chip-select"),D=d("forge-chip-delete"),R=d("forge-chip-navigate"),x={title:"Components/Chips",render:e=>{const a=w(e),r=a?C(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
