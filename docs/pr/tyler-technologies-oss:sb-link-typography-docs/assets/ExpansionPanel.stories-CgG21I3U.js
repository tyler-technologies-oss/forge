import{E,x as u}from"./iframe-CmPrhNEs.js";import{g as O,s as A,a as P}from"./utils-gw6R9s7u.js";import{o as R}from"./style-map-CJX1Xp8j.js";import{n as _,e as h}from"./ref-lEc37PHb.js";import{e as V}from"./class-map-CguuqOih.js";import"./feature-detection-CY6TVbRZ.js";import"./expansion-panel-D_Sh7JhR.js";import"./index-CiLSBptl.js";import"./card-DdwiOD4f.js";const{action:C}=__STORYBOOK_MODULE_ACTIONS__,d="forge-expansion-panel",j=C("forge-expansion-panel-toggle"),H=C("forge-expansion-panel-animation-complete"),W={title:"Components/Expansion Panel",component:d,render:e=>{const n=P(e),o=n?R(n):E,t=h();function p(l){var c;j(),(c=t.value)==null||c.setAttribute("aria-expanded",l.detail.toString())}return u`
