import{x as n}from"./iframe-rNJ7j0IZ.js";import{g as l}from"./utils-gw6R9s7u.js";import"./feature-detection-CY6TVbRZ.js";import"./color-picker-DRlhz61G.js";const{action:p}=__STORYBOOK_MODULE_ACTIONS__,r="forge-color-picker",s=p("forge-color-picker-change"),i={title:"Components/Color Picker",render:o=>n`
      <forge-color-picker
        .value=${o.value}
