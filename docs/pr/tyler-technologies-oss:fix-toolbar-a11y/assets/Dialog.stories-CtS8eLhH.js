import"./feature-detection-ONR9WHvu.js";import{D as o}from"./dialog-B9LsXUuI.js";import"./backdrop-BIqxiwQa.js";import{I as N}from"./icon-B5S0VGIT.js";import"./index-BmocOEUj.js";import{x as w}from"./index-ByifSpfC.js";import"./lit-element-JplMEnZc.js";import{B as F,x as P}from"./lit-html-paDGiEfB.js";import{e as Y}from"./class-map-D55lQyt8.js";import{s as G}from"./decorators-DOnQS6BC.js";import{c as H,g as U}from"./utils-DFGIFZhS.js";import{a}from"./chunk-D5ZWXAHU-CGElDDNX.js";import"./icon-button-DfODsaKD.js";import"./focus-indicator-R2otSvsR.js";import"./state-layer-B7GOb8iB.js";import"./button-vPgaRyW5.js";import"./scaffold-BAruaYLU.js";import"./toolbar-Lhya2ayG.js";const j=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=H("forge-dialog",f);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
