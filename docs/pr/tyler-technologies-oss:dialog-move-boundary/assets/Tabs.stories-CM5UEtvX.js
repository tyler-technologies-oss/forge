import{E as i,x as c}from"./iframe-B8WMZnyd.js";import{g as P,s as l,a as D}from"./utils-CtrDDikH.js";import{o as E}from"./style-map-Bt9_FUTU.js";import{I as V,p as j,d as k}from"./icon-B8CdcxqJ.js";import"./feature-detection-uS6p5jc8.js";import"./tab-bar-Bhq4Ed9L.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",W=O("forge-tab-bar-change"),w=O("forge-tab-select");V.define([j,k]);const F={title:"Components/Tabs",render:e=>{const n={...D(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const B=Object.entries(n).length?E(n):i,x=Array.from({length:e.scrollButtons?20:3}).map((M,C)=>c`<forge-tab>
