import"./feature-detection-uS6p5jc8.js";import{D as o}from"./dialog-5FLDrlCd.js";import"./backdrop-BZvWLwDX.js";import{I as N,C as B}from"./icon-B8CdcxqJ.js";import"./index-CiLSBptl.js";import{x as w,B as Y}from"./iframe-BBIpcTp1.js";import{e as U}from"./class-map-yp5PN1HA.js";import{s as F}from"./decorators-BfeqqAiL.js";import{c as G,g as H}from"./utils-DdTQ0mv3.js";import"./icon-button-DkluvO-9.js";import"./focus-indicator-IWpzSXYP.js";import"./state-layer-BFwsAUDA.js";import"./button-r2EMLpWm.js";import"./scaffold-CGyusmPL.js";import"./toolbar-Byb6kcao.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,j=a("forge-dialog-close"),K=a("forge-dialog-before-close"),Q=a("forge-dialog-move-start"),V=a("forge-dialog-move"),Z=a("forge-dialog-move-end"),J=a("forge-dialog-fullscreen-change"),W=f=>{N.define(B);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",K),e.addEventListener("forge-dialog-move-start",Q),e.addEventListener("forge-dialog-move",V),e.addEventListener("forge-dialog-move-end",Z),e.addEventListener("forge-dialog-fullscreen-change",J),t.appendChild(e);const u=w`
    <forge-scaffold>
  ...
  `;return Y(u,e),t},X="forge-dialog:not([fullscreen]) forge-scaffold{--forge-scaffold-width: 500px}forge-dialog forge-scaffold{height:auto}forge-dialog forge-scaffold h1{margin:0}forge-dialog forge-scaffold>[slot=body]{padding:var(--forge-spacing-medium)}";N.define([B]);const ee="forge-dialog",oe={title:"Components/Dialog",render:W,component:"forge-dialog",decorators:[F(X)],argTypes:{...H({tagName:ee,exclude:["trigger","triggerElement"],controls:{mode:{control:"select",options:["modal","inline-modal","nonmodal"]},type:{control:"select",options:["dialog","alertdialog"]},animationType:{control:"select",options:["none","zoom","fade","slide"]},preset:{control:"select",options:["dialog","left-sheet","right-sheet","top-sheet","bottom-sheet"]},sizeStrategy:{control:"select",options:["content","container-inline","container-block"]},positionStrategy:{control:"select",options:["viewport","container"]},placement:{control:"select",options:["custom","center","top","right","bottom","left","top-right","top-left","bottom-right","bottom-left"]},moveBoundary:{control:"select",options:["viewport","none"]},fullscreenThreshold:{control:"number"}}})},args:{open:!1,persistent:!1,fullscreen:!1,fullscreenThreshold:o.defaults.FULLSCREEN_THRESHOLD,moveable:!1,moveBoundary:o.defaults.MOVE_BOUNDARY,mode:o.defaults.MODE,type:o.defaults.TYPE,label:"My dialog title",description:"My dialog description",animationType:o.defaults.ANIMATION_TYPE,preset:o.defaults.PRESET,sizeStrategy:o.defaults.SIZE_STRATEGY,positionStrategy:o.defaults.POSITION_STRATEGY,placement:o.defaults.PLACEMENT}},l={},n={args:{preset:"right-sheet"}},i={args:{preset:"left-sheet"}},c={args:{preset:"top-sheet"}},d={args:{preset:"bottom-sheet"}},g={args:{fullscreen:!0}},m={parameters:{controls:{mode:{control:"select",options:["modal","nonmodal"]},placement:{control:"select",options:["center","top","top-right","top-left","right","left","bottom","bottom-right","bottom-left"]},preset:{control:"select",options:["dialog","top-sheet","bottom-sheet","left-sheet","right-sheet"]},fullscreen:{control:"boolean"},animationType:{control:"select",options:["none","zoom","fade","slide"]}}},args:{fullscreen:!1,mode:"modal",placement:"center",preset:"dialog",animationType:"zoom"},render:({fullscreen:f,mode:t,placement:r,preset:e,animationType:u})=>{const s=()=>{const p=document.getElementById("css-dialog");if(p.open){p.close();return}t==="modal"?p.showModal():p.show()},P=U({"forge-dialog":!0,"forge-dialog--fullscreen":!!f,[`forge-dialog--${t}`]:!0,[`forge-dialog--${r}`]:!0,[`forge-dialog--${e}`]:!0,[`forge-dialog--${u}`]:!0});return w`
...
}`,...(L=(x=c.parameters)==null?void 0:x.docs)==null?void 0:L.source}}};var _,$,A;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    preset: 'bottom-sheet'
  }
}`,...(A=($=d.parameters)==null?void 0:$.docs)==null?void 0:A.source}}};var M,q,I;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    fullscreen: true
  }
}`,...(I=(q=g.parameters)==null?void 0:q.docs)==null?void 0:I.source}}};var R,k,z;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    controls: {
      mode: {
        control: 'select',
