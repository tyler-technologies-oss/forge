import{x as s}from"./iframe-Dk6FLRDb.js";import{g as d}from"./utils-QLgq-F6h.js";import"./feature-detection-uS6p5jc8.js";import"./calendar-DKVitxlb.js";import"./index-CiLSBptl.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,a="forge-calendar",c=o("forge-calendar-date-select"),i=o("forge-calendar-focus-change"),y=o("forge-calendar-month-change"),u=o("forge-calendar-view-change"),m={title:"Components/Calendar",render:e=>s`<forge-calendar
      .month=${e.month}
      .year=${e.year}
      .mode=${e.mode}
      .readonly=${e.readonly}
