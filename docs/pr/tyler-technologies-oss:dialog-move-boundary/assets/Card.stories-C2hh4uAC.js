import{x as n,E as M}from"./iframe-Cx4Okfpz.js";import{g as L,s as x,r as V,c as O,a as N}from"./utils-QLgq-F6h.js";import"./feature-detection-uS6p5jc8.js";import{I as _,E as A}from"./icon-B8CdcxqJ.js";import"./index-CiLSBptl.js";import{s as T}from"./decorators-_7uZejnl.js";import{e as P}from"./class-map-BPYW0bNY.js";import{o as $}from"./style-map-AKwNSFV_.js";import"./card-B7XCcl1a.js";import"./icon-button-C-UNXlAt.js";import"./focus-indicator-BeibAi2h.js";import"./state-layer-C7sW6v-0.js";import"./button-DEhPRUdY.js";import"./scaffold-CGyusmPL.js";import"./toolbar-Byb6kcao.js";const w=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",E={title:"Components/Card",render:a=>{const s=O(i,a);return s.textContent=a.text,s},component:i,decorators:[T(w)],parameters:{actions:{disable:!0}},argTypes:{...L({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...x,render:()=>(_.define([A]),n`
      <div class="demo-card">
        <forge-card>
