import{I as T,h as z,i as L,j as V,k as E}from"./icon-B8CdcxqJ.js";import{E as n,x as t}from"./iframe-BwqQa4Dw.js";import{o as C}from"./style-map-Do58X9PR.js";import{e as c}from"./class-map-D8zP2MeT.js";import{g,G as N,a as w}from"./utils-CtrDDikH.js";import"./feature-detection-uS6p5jc8.js";import"./avatar-BTa5tMHP.js";import"./chip-set-DJEem7sd.js";import"./focus-indicator-BeibAi2h.js";import"./index-CiLSBptl.js";import"./state-layer-C7sW6v-0.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;T.define([z,L,V,E]);const f="forge-chip-set",m="forge-chip",P=d("forge-chip-select"),D=d("forge-chip-delete"),R=d("forge-chip-navigate"),x={title:"Components/Chips",render:e=>{const a=w(e),r=a?C(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
