import"./feature-detection-uS6p5jc8.js";import{D as o}from"./dialog-D3BzxWt2.js";import"./backdrop-BZvWLwDX.js";import{I as N,C as B}from"./icon-B8CdcxqJ.js";import"./index-CiLSBptl.js";import{x as w,B as Y}from"./iframe-Dk6FLRDb.js";import{e as U}from"./class-map-CFV1iACR.js";import{s as F}from"./decorators-Dji3UuyW.js";import{c as G,g as H}from"./utils-QLgq-F6h.js";import"./icon-button-CvGVrMJL.js";import"./focus-indicator-13Sfphtk.js";import"./state-layer-CDmGOVud.js";import"./button-BApUEgZW.js";import"./scaffold-CGyusmPL.js";import"./toolbar-Byb6kcao.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,j=a("forge-dialog-close"),K=a("forge-dialog-before-close"),Q=a("forge-dialog-move-start"),V=a("forge-dialog-move"),Z=a("forge-dialog-move-end"),J=a("forge-dialog-fullscreen-change"),W=f=>{N.define(B);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",K),e.addEventListener("forge-dialog-move-start",Q),e.addEventListener("forge-dialog-move",V),e.addEventListener("forge-dialog-move-end",Z),e.addEventListener("forge-dialog-fullscreen-change",J),t.appendChild(e);const u=w`
    <forge-scaffold>
