import"./lit-element-B3QVTycr.js";import{x as r}from"./lit-html-CuBe1DX_.js";import{a as U}from"./index-B-lxVbXh.js";import{g as X,s as d,G as Y,c as j}from"./utils-CiMlxpQp.js";import{t as H}from"./index-fxMNKkgx.js";import{I as Z}from"./icon-DNSPAaK0.js";import{n as V,p as G,f as J,e as K,c as Q}from"./index-RsKXMDm2.js";import{e as oo}from"./class-map-CuXcqkpw.js";import"./feature-detection-C61kIZu7.js";import"./icon-button-BgvK8Gih.js";import"./focus-indicator-B_9E-jM6.js";import"./index-CiLSBptl.js";import"./state-layer-DA2sYK0k.js";import"./circular-progress-CbpfkaY8.js";import"./badge-DmYwJsoi.js";import"./label-BftBTwPr.js";import"./button-DOA_SM9C.js";import"./button-toggle-group-JMDAjILZ.js";import"./checkbox-BwLNDz7l.js";import"./switch-B2m0S8OE.js";const m="forge-icon-button";Z.define([H,V,G,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=j(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=V.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=G.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
