import{x as i}from"./iframe-BPVRo90Q.js";import{I as a,g as n}from"./icon-B8CdcxqJ.js";import{s}from"./decorators-9b8GWfCK.js";import"./feature-detection-uS6p5jc8.js";import"./card-ENvRU7hx.js";import"./button-r2EMLpWm.js";import"./focus-indicator-IWpzSXYP.js";import"./index-CiLSBptl.js";import"./state-layer-BFwsAUDA.js";import"./icon-button-DkluvO-9.js";import"./toolbar-Byb6kcao.js";const c="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";a.define(n);const l={title:"Recipes/Card/Profile",decorators:[s(c)],render:()=>i`
    <forge-card>
      <div class="container">
        <div class="avatar">
