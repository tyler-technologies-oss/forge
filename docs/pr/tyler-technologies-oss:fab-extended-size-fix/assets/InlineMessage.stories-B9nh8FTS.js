import{x as r,E as l}from"./iframe-CQyu4TFV.js";import{g as Q,s as I,G as C,c as z,a as M}from"./utils-B9OMirVp.js";import"./feature-detection-uS6p5jc8.js";import{I as A,s as O}from"./icon-B8CdcxqJ.js";import"./index-CiLSBptl.js";import{o as V}from"./style-map-BPqcbbNu.js";import"./inline-message-By3BVHSa.js";const t="forge-inline-message";A.define(O);const $={title:"Components/Inline Message",render:e=>{const a=z(t,e);return a.textContent=e.text,a},component:t,parameters:{actions:{disable:!0}},argTypes:{...Q({tagName:t,controls:{theme:{control:{type:"select"},options:C}}})},args:{text:"Qui nulla anim sunt eiusmod eiusmod id esse veniam proident ea adipisicing ad exercitation."}},n={},i={...I,render:({text:e})=>r`
