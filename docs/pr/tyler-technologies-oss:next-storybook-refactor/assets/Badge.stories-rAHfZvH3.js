import{x as n}from"./lit-element-Dm2J4qPi.js";import{c as x,g as T,s as t,I as P,t as v,G as E}from"./icon--dhVb1sq.js";import"./badge-CTWHoWVq.js";import"./icon-button-CG-m1vmm.js";import"./base-button-adapter-Bhma5vOK.js";const g="forge-badge",_={title:"Components/Badge",render:s=>{const d=x(g,s);return d.innerHTML=s.text,d},component:g,parameters:{actions:{disable:!0}},argTypes:{...T({tagName:g,controls:{theme:{control:"select",options:["default",...E,"info-primary","info-secondary"]}}})},args:{text:"Status"}},e={},r={...t,render:()=>n`
