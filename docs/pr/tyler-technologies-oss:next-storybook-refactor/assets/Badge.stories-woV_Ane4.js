import{x as n}from"./lit-element-Dm2J4qPi.js";import{c as x,g as T,s as t,I as P,t as v,G as E}from"./base-button-adapter-BJTwNuZc.js";import"./badge-C-O8ip87.js";import"./icon-button-BCNqjlCf.js";const g="forge-badge",_={title:"Components/Badge",render:s=>{const d=x(g,s);return d.innerHTML=s.text,d},component:g,parameters:{actions:{disable:!0}},argTypes:{...T({tagName:g,controls:{theme:{control:"select",options:["default",...E,"info-primary","info-secondary"]}}})},args:{text:"Status"}},e={},r={...t,render:()=>n`
...
}`,...(I=(S=a.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};const W=["Demo","Themed","Strong","WithIconButton"],D=Object.freeze(Object.defineProperty({__proto__:null,Demo:e,Strong:o,Themed:r,WithIconButton:a,__namedExportsOrder:W,default:_},Symbol.toStringTag,{value:"Module"}));export{D as B,e as D,o as S,r as T,a as W};
