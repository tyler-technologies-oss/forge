import{j as x,x as P}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as l}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as k}from"./index-B45drbLj.js";import{I as z}from"./icon-Dm0CukSC.js";import{c as M,g as Y}from"./constants-DTwaRlry.js";import"./icon-button-Y_KnGTLZ.js";import"./focus-indicator-DwdAdTD9.js";import"./index-Dh0vMUMR.js";import"./state-layer--5FTkFQc.js";import"./button-DlzgyknD.js";import{D as o}from"./dialog-CsRnzEB4.js";import"./backdrop-CTwSgwGC.js";import"./scaffold-DJMe_f4o.js";import"./toolbar-Dnz17KD3.js";/* empty css                         */const j=l("forge-dialog-close"),F=l("forge-dialog-before-close"),G=l("forge-dialog-move-start"),q=l("forge-dialog-move"),B=l("forge-dialog-move-end"),$=I=>{z.define(k);const d=document.createElement("div"),c=document.createElement("forge-button");c.variant="raised",c.innerText="Open dialog",c.addEventListener("click",()=>e.open=!0),d.appendChild(c);const e=M("forge-dialog",I);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",R=>{j(R),e.open=!1}),e.addEventListener("forge-dialog-before-close",F),e.addEventListener("forge-dialog-move-start",G),e.addEventListener("forge-dialog-move",q),e.addEventListener("forge-dialog-move-end",B),d.appendChild(e);const N=P`
