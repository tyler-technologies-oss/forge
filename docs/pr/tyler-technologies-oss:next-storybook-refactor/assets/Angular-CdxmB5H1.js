import{j as e}from"./jsx-runtime-96wpHg1G.js";import{u as s}from"./index-CZL70qjL.js";import"./blocks-ao6QdvSq.js";import{M as r}from"./index-gvDPNhJG.js";import"./iframe-CVh6z9b8.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./chunk-QN4WKJDJ-Bf_F3oir.js";import"./index-DXimoRZY.js";import"./index-DvzDrELh.js";import"./index-DrFu-skq.js";function t(o){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Frameworks/Angular"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { ForgeButtonComponent } from '@tylertech/forge-angular';

@Component({
  standalone: true,
  selector: 'app-my-component',
  template: '<forge-button>Click me</forge-button>',
  imports: [ForgeButtonComponent]
})
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/dist/typography/forge-typography';
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/dist/theme/forge-theme';
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`.my-custom-class {
...
and are automaticaly themed properly when the theme changes.`}),`
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.a,{href:"?path=/docs/guides-theming--docs",children:"Theming"})," guide for more information on theming with Forge and loading the built-in dark theme."]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/dist/forge-tokens';
`})}),`
...
`]}),`
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.a,{href:"?path=/docs/design-tokens--docs",children:"Design Tokens"})," documentation for more information on the available tokens."]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/dist/table/forge-table';
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`::ng-deep {
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/dist/forge';
`})}),`
`,e.jsx(n.h2,{id:"using-icons",children:"Using Icons"}),`
`,e.jsxs(n.p,{children:["Using icons within your Angular application is as simple as using the ",e.jsx(n.code,{children:"<forge-icon>"})," component. You can import the ",e.jsx(n.code,{children:"ForgeIconModule"})," from the ",e.jsx(n.code,{children:"@tylertech/forge-angular"})," package to use the icon component."]}),`
...
`,e.jsx(n.p,{children:`This is a topic that is often confused when working with custom elements in Angular. When you bind to a property on a custom element, you
are binding to the property of the element itself, not the attribute.`}),`
`,e.jsxs(n.p,{children:["For example, when you bind to the ",e.jsx(n.code,{children:"value"})," property of a ",e.jsx(n.code,{children:"<forge-slider>"}),` component, you are binding to the property of the component, not
the attribute of the element.`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<forge-slider [value]="sliderValue"></forge-slider>
`})}),`
`,e.jsxs(n.p,{children:[`This is important to understand because when you bind to a property, you are binding to the component's internal state, not the attribute
of the element. This is why you use square brackets `,e.jsx(n.code,{children:"[]"})," to bind to properties."]}),`
`,e.jsx(n.p,{children:"You can however"}),`
`,e.jsx(n.h2,{id:"custom_elements_schema",children:"CUSTOM_ELEMENTS_SCHEMA"}),`
`,e.jsxs(n.p,{children:["While not recommended, if you prefer not to use the adapter, you can easily disable the Angular compiler from throwing errors by adding the ",e.jsx(n.code,{children:"CUSTOM_ELEMENTS_SCHEMA"})," to your component or module's ",e.jsx(n.code,{children:"schemas"})," array:"]}),`
