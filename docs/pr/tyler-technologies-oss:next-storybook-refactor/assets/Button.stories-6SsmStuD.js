import{x as c}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as W,a as A,s as B,G as E}from"./constants-CGWcLB8c.js";import{t as k}from"./circular-progress-px5fgHMq.js";import{I as C}from"./icon-B2DiaQ_2.js";import"./button-DztSu_ZC.js";import"./focus-indicator-DNk0lbfG.js";import"./index-kSD1OPJ4.js";import"./state-layer-DJXhf8TO.js";const u="forge-button",R={title:"Components/Button",render:r=>{const t=W(u,r);return t.textContent=r.text,t},component:u,argTypes:{...A({tagName:u,exclude:["form","name","value"],controls:{variant:{control:{type:"select"},options:["text","outlined","filled","raised","link"]},theme:{control:{type:"select"},options:E}}}),text:{control:"text"}},args:{text:"Button",variant:"text",pill:!1,theme:"primary",type:"button",disabled:!1,popoverIcon:!1,dense:!1,fullWidth:!1}},e={},n={...B,render:()=>c`
...
}`,...(O=(L=i.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};const j=["Demo","Variants","Anchor","Themed","WithIcon","WithCircularProgress"],q=Object.freeze(Object.defineProperty({__proto__:null,Anchor:o,Demo:e,Themed:a,Variants:n,WithCircularProgress:i,WithIcon:s,__namedExportsOrder:j,default:R},Symbol.toStringTag,{value:"Module"}));export{o as A,q as B,e as D,a as T,n as V,s as W,i as a};
