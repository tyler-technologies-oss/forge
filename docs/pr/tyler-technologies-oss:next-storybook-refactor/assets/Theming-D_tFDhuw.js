...
`,e.jsxs(n.p,{children:["To view a complete set of the color tokens that are available for theming, please view the ",e.jsx(n.a,{href:"?path=/docs/design-tokens-theme--docs",children:"theme tokens"}),"."]}),`
...
`,e.jsx(n.p,{children:`Customizing the theme for a specific comonponent can be done much the same way, but you will have to review the documentation for that specific component to know
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-scss",children:`@use '@tylertech/forge/styles/forge-dark';
`})}),`
`,e.jsxs(n.blockquote,{children:[`
...
`]}),`
`,e.jsxs(n.p,{children:[`The dark theme uses the Sass mixins mentioned above to generate the proper CSS custom property overrides. As y  ou can see below, we just apply
the styles to the `,e.jsx(n.code,{children:":root"})," selector:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-css",children:`@use '@tylertech/forge/styles/theme/theme-dark';
