import{j as x,x as P}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as l}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{f as k}from"./index-xLNEZWib.js";import{I as z}from"./icon-CbXHM6zD.js";import{c as M,g as Y}from"./constants-P8PPbvcA.js";import"./icon-button-BHFGZu_q.js";import"./focus-indicator-DiRJm8Fd.js";import"./index-Dh0vMUMR.js";import"./state-layer-D1kPUhtW.js";import"./button-DUm6tzq_.js";import{D as o}from"./dialog-CCrjpfFk.js";import"./backdrop-zSkSTcz4.js";import"./scaffold-DB667SiN.js";import"./toolbar-FB9uncb7.js";/* empty css                         */const j=l("forge-dialog-close"),F=l("forge-dialog-before-close"),G=l("forge-dialog-move-start"),q=l("forge-dialog-move"),B=l("forge-dialog-move-end"),$=I=>{z.define(k);const d=document.createElement("div"),c=document.createElement("forge-button");c.variant="raised",c.innerText="Open dialog",c.addEventListener("click",()=>e.open=!0),d.appendChild(c);const e=M("forge-dialog",I);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",R=>{j(R),e.open=!1}),e.addEventListener("forge-dialog-before-close",F),e.addEventListener("forge-dialog-move-start",G),e.addEventListener("forge-dialog-move",q),e.addEventListener("forge-dialog-move-end",B),d.appendChild(e);const N=P`
