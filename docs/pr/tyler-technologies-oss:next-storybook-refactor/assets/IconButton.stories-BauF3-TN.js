import{x as f}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as G}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{c as W,g as M,s as B,G as q}from"./constants-BUdimubM.js";import{t as N}from"./index-fxMNKkgx.js";import{I as z}from"./icon-DXhnJPk9.js";import{b as D,c as F,d as R,a as j,e as V}from"./index-mTd1prAy.js";import"./icon-button-DCjW2QNR.js";import"./focus-indicator-Cg33mmfZ.js";import"./index-Dh0vMUMR.js";import"./state-layer-C7V9cEd6.js";import"./circular-progress-Ca1OnXUR.js";import"./badge-BYmPL116.js";import"./label-D51t6prh.js";import"./button-6btJ9eG4.js";import"./checkbox-FePnQJrm.js";import"./switch-HYIcOIfy.js";const m="forge-icon-button";z.define([N,D,F,R,j,V]);const H=G("click"),J={title:"Components/Icon Button",render:e=>{const o=W(m,e);if(o.addEventListener("click",H),e.toggle){o.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=D.name,n.slot="on",o.appendChild(n);const r=document.createElement("forge-icon");r.name=F.name,o.appendChild(r)}else{o.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=N.name,o.appendChild(n)}return o},component:m,argTypes:{...M({tagName:m,exclude:["form","name","value","type"],controls:{variant:{control:{type:"select"},options:["icon","outlined","filled","raised"]},theme:{control:{type:"select"},options:q},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"primary",disabled:!1,dense:!1,toggle:!1,on:!1,shape:"circular",density:"large",popoverIcon:!1}},t={},a={...B,render:()=>f`
    ...
    `},s={parameters:{controls:{exclude:["toggle","on","popoverIcon"]}},render:e=>{const o=W(m,e);o.setAttribute("aria-label","Icon button with badge");const n=document.createElement("forge-icon");n.name=j.name,o.appendChild(n);const r=document.createElement("forge-badge");return r.textContent="3",r.slot="badge",o.appendChild(r),o}},l={parameters:{controls:{include:["variant","theme","disabled"]}},render:({variant:e,theme:o,disabled:n})=>f`
...
}`,...(k=(L=g.parameters)==null?void 0:L.docs)==null?void 0:k.source}}};const K=["Demo","Variants","Anchor","Themed","WithBadge","WithCircularProgress","WithLabel"],me=Object.freeze(Object.defineProperty({__proto__:null,Anchor:i,Demo:t,Themed:c,Variants:a,WithBadge:s,WithCircularProgress:l,WithLabel:g,__namedExportsOrder:K,default:J},Symbol.toStringTag,{value:"Module"}));export{i as A,t as D,me as I,c as T,a as V,s as W,l as a,g as b};
