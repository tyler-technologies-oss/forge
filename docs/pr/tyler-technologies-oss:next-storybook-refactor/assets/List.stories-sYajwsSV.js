import{x as e,T as i}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as R}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{a as _,g,s as C}from"./utils-BrN94tQ9.js";import{I as N}from"./icon-V4IE3JYq.js";import{k as V,b as F,l as M,j as P,m as D,n as H,o as W,p as q,f as z}from"./index-CDQrnaq1.js";import{t as B}from"./index-fxMNKkgx.js";import{o as G}from"./style-map-D0ILlpbs.js";import{s as J}from"./decorators-B79PnA5z.js";import"./list-Cu4wzbUs.js";import"./drawer-BAcOpRM_.js";import"./index-Dh0vMUMR.js";import"./avatar-BXavy-1u.js";import"./checkbox-BZl9IGGg.js";import"./label-DREoufrJ.js";import"./button-D5XxdyZ6.js";import"./focus-indicator-By3BQe1w.js";import"./state-layer-b0IlkqgO.js";import"./button-toggle-group-D0JifxTm.js";import"./icon-button-CZlBA0tM.js";import"./switch-DljXu9M_.js";import"./expansion-panel-DyVyzPAv.js";N.define([V,F,M,P,B,D,H,W,q,z]);const d="forge-list",p="forge-list-item",K="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",Q=R("forge-list-item-select"),U={title:"Components/List",render:t=>{const m=_(t),O=m?G(m):i,c=[];for(let o=0;o<4;o++){const f=t.wrap?`List item ${o+1} ${K}`:`List item ${o+1}`,A=t.variant==="button"?e`<button type="button" .disabled=${t.disabled}>${f}</button>`:t.variant==="anchor"?e`<a href="javascript: void(0);">${f}</a>`:e`<span>${f}</span>`;c.push(e`
        <forge-list-item
          value="list-item-${o+1}"
          ?selected=${o===0&&t.selected}>
          ${t.withAvatar?e`<forge-avatar slot="start" style="--forge-avatar-background: var(--forge-theme-text-medium);"><forge-icon name="folder"></forge-icon></forge-avatar>`:i}
          ...
          ${t.withStartSwitch?e`<forge-switch slot="start" aria-label=${`List Item ${o+1} Start Switch`}></forge-switch>`:i}
          ${A}
...
}`,...(T=(S=a.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var E,k,j;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  ...standaloneStoryParams,
  render: () => {
    return html\`
      <forge-list>
...
}`,...(j=(k=l.parameters)==null?void 0:k.docs)==null?void 0:j.source}}};const X=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable"],yt=Object.freeze(Object.defineProperty({__proto__:null,Demo:n,Expandable:l,Interactive:r,NavigationMenu:a,WithAnchor:s,__namedExportsOrder:X,default:U},Symbol.toStringTag,{value:"Module"}));export{n as D,l as E,r as I,yt as L,a as N,s as W};
