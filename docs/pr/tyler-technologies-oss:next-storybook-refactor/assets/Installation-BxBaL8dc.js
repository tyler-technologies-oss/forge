import{j as e}from"./jsx-runtime-DP2E-MBL.js";import{u as t}from"./index-Dheik_QU.js";import{M as i}from"./index-BVXLmIo1.js";import"./iframe-Bdgs1-Zk.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./chunk-QN4WKJDJ-Bf_F3oir.js";import"./index-DXimoRZY.js";import"./index-DvzDrELh.js";import"./index-DrFu-skq.js";function o(s){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Getting Started/Installation"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Ex. ",e.jsx(n.code,{children:"table/forge-table.css"}),": Contains the pre-built CSS classes to support the ",e.jsx(n.code,{children:"<forge-table>"})," component."]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"esm/"}),": Contains the bundled and code-split ESM JavaScript sources (includes dependencies). This is for distribution on the Forge CDN, or for self-hosting Forge."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"lib.js"}),": The pre-built Forge JavaScript library. Contains all Forge components and utilities in a single bundle (including dependencies)."]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"styles/"}),": Contains all Sass stylesheets as a copy directly from the library. This allows you to utilize the same Sass utilities that Forge does within your own application and/or library."]}),`
