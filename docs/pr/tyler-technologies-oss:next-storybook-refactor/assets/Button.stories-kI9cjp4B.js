import{x as i}from"./lit-element-CiOxWxgJ.js";import{c as h,t as $,s as T}from"./utils-DeKcpcPg.js";import{I as x,t as k}from"./base-button-adapter-k-xx2cLe.js";import"./button-HGqsUQD5.js";const s="forge-button",I={title:"Components/Button",render:t=>{const a=h(s,t);return a.innerHTML=t.text,a},component:s,parameters:{controls:{exclude:/^(start|end|click|root|focus-indicator|state-layer)$/i}},argTypes:{...$(s),text:{control:"text"}},args:{text:"Button"}},n={},r={...T,render:()=>i`
