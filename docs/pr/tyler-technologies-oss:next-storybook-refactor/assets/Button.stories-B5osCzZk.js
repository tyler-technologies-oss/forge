import{x as c}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as W,g as A,s as B,G as E}from"./constants-P8PPbvcA.js";import{t as k}from"./index-fxMNKkgx.js";import{I as C}from"./icon-CbXHM6zD.js";import"./button-DUm6tzq_.js";import"./focus-indicator-DiRJm8Fd.js";import"./index-Dh0vMUMR.js";import"./state-layer-D1kPUhtW.js";import"./circular-progress-C1ZEqExM.js";const u="forge-button",R={title:"Components/Button",render:r=>{const t=W(u,r);return t.textContent=r.text,t},component:u,argTypes:{...A({tagName:u,exclude:["form","name","value"],controls:{variant:{control:{type:"select"},options:["text","outlined","filled","raised","link"]},theme:{control:{type:"select"},options:E}}}),text:{control:"text"}},args:{text:"Button",variant:"text",pill:!1,theme:"primary",type:"button",disabled:!1,popoverIcon:!1,dense:!1,fullWidth:!1}},e={},n={...B,render:()=>c`
