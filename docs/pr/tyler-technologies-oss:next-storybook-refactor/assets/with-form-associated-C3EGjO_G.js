import{n as i,o as r,t as g,p as x,q as f,u as I,v as _}from"./constants-CYeMfgsl.js";/**
 * @license
 ...
 */function v(o){const a=class a extends o{get form(){return this[r].form}get labels(){return this[r].labels}get name(){return this.getAttribute("name")??""}set name(e){g(this,!!e,"name",e)}[x](){return this[f]()}formDisabledCallback(e){this.disabled=e}set[I](e){const n=e==="select"?document.createElement("select"):document.createElement("input");n.setAttribute("type",e),n.name="internal",this._inputElement=n}[_](e){if(this._inputElement)return this[r].validity.customError?this[r].validationMessage:(Object.entries(e).forEach(([n,t])=>this._inputElement[n]=t),this._inputElement.validationMessage)}};a.formAssociated=!0;let s=a;return s}export{v as W,T as a};
