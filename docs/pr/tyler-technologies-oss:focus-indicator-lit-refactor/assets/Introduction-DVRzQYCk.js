...
`,e.jsxs(n.p,{children:["To learn more about theming see the ",e.jsx(n.a,{href:"?path=/docs/getting-started-theming--docs",children:"Theming documentation"}),"."]})]})}function c(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{c as default};
