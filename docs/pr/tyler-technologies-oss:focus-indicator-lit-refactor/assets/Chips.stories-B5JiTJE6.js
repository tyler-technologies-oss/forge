import{I as T,h as z,i as L,j as V,k as E}from"./icon-eJOvSyyv.js";import{E as n,x as t}from"./iframe-Dusku7t3.js";import{o as C}from"./style-map-C8mGDCe8.js";import{e as c}from"./class-map-wMyEh-aY.js";import{g,G as N,a as w}from"./utils-D0zOu5id.js";import"./service-adapter-BykFeYYZ.js";import"./avatar-0EdaxfI5.js";import"./chip-set-CIrW0t-F.js";import"./focus-indicator-B6EU3cOJ.js";import"./state-layer-BRTtEqto.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;T.define([z,L,V,E]);const f="forge-chip-set",m="forge-chip",P=d("forge-chip-select"),D=d("forge-chip-delete"),R=d("forge-chip-navigate"),x={title:"Components/Chips",render:e=>{const a=w(e),r=a?C(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
...
}`,...(j=(O=l.parameters)==null?void 0:O.docs)==null?void 0:j.source}}};const B=["Demo","Anchor","Avatar","CSSOnly"],W=Object.freeze(Object.defineProperty({__proto__:null,Anchor:s,Avatar:i,CSSOnly:l,Demo:o,__namedExportsOrder:B,default:x},Symbol.toStringTag,{value:"Module"}));export{s as A,W as C,o as D,i as a,l as b};
