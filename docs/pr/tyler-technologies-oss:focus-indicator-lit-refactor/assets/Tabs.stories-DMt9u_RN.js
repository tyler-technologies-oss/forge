import{E as i,x as c}from"./iframe-Cqs95LDf.js";import{g as P,s as l,a as D}from"./utils-D0zOu5id.js";import{o as E}from"./style-map-CqUpN2Mv.js";import{I as V,p as j,d as k}from"./icon-eJOvSyyv.js";import"./service-adapter-BykFeYYZ.js";import"./tab-bar-BDbR4ock.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",W=O("forge-tab-bar-change"),w=O("forge-tab-select");V.define([j,k]);const F={title:"Components/Tabs",render:e=>{const n={...D(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const B=Object.entries(n).length?E(n):i,x=Array.from({length:e.scrollButtons?20:3}).map((M,C)=>c`<forge-tab>
