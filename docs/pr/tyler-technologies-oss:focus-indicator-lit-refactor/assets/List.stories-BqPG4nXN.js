import{E as t,x as e}from"./iframe-B_AFpbKZ.js";import{g as O,s as Z,a as tt}from"./utils-D0zOu5id.js";import{I as st,u as at,l as rt,v as lt,c as ct,d as dt,s as gt,w as mt,x as ft,y as ht,p as pt}from"./icon-eJOvSyyv.js";import{o as et}from"./style-map-D63BE21Z.js";import{e as r}from"./class-map-B28AMhZr.js";import{s as bt}from"./decorators-CTyTE-Ei.js";import"./service-adapter-BykFeYYZ.js";import"./list-BKcKppFQ.js";import"./drawer-CMJX_VXP.js";import"./index-CiLSBptl.js";import"./avatar-DD7NlKxa.js";import"./checkbox-BwaxslW8.js";import"./label-8C4joo3A.js";import"./button-BjTHYlPk.js";import"./focus-indicator-CyTlhlQD.js";import"./state-layer-BRTtEqto.js";import"./button-toggle-group-BkTZIXUI.js";import"./icon-button-U4pg755t.js";import"./switch-BxEMfYtZ.js";import"./expansion-panel-BBO7eYZa.js";const{action:ut}=__STORYBOOK_MODULE_ACTIONS__;st.define([at,rt,lt,ct,dt,gt,mt,ft,ht,pt]);const j="forge-list",z="forge-list-item",$t="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",wt=ut("forge-list-item-select"),vt={title:"Components/List",render:n=>{const w=tt(n),M=w?et(w):t,v=[];for(let i=0;i<4;i++){const a=n.wrap?`List item ${i+1} ${$t}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${a}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${a}</a>`:e`<span>${a}</span>`;v.push(e`
