import"./service-adapter-BykFeYYZ.js";import{D as o}from"./dialog-bZFrz6KW.js";import"./backdrop-BqEK3-r8.js";import{I as N,C as w}from"./icon-eJOvSyyv.js";import"./index-CiLSBptl.js";import{x as B,B as Y}from"./iframe-B36M3axR.js";import{e as F}from"./class-map-C0mkysGf.js";import{s as U}from"./decorators-DpQOWl7X.js";import{c as G,g as H}from"./utils-JcRLWv5w.js";import"./icon-button-CofNeE0G.js";import"./focus-indicator-u5r21UtO.js";import"./state-layer-BRTtEqto.js";import"./button-C9kCF3a-.js";import"./scaffold-DGBqen_X.js";import"./toolbar-Bv8KpWT6.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,j=a("forge-dialog-close"),K=a("forge-dialog-before-close"),Q=a("forge-dialog-move-start"),Z=a("forge-dialog-move"),J=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",K),e.addEventListener("forge-dialog-move-start",Q),e.addEventListener("forge-dialog-move",Z),e.addEventListener("forge-dialog-move-end",J),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=B`
    <forge-scaffold>
