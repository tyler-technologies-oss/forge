import{x as i}from"./iframe-BL13dRo5.js";import{I as a,h as s}from"./icon-eJOvSyyv.js";import{s as n}from"./decorators-uPZHYzeA.js";import"./service-adapter-BykFeYYZ.js";import"./card-CVF6hqjN.js";import"./button-B31EV2cV.js";import"./focus-indicator-DFzG-d7S.js";import"./state-layer-BRTtEqto.js";import"./index-CiLSBptl.js";import"./label-value-D_q4g7yi.js";const d="forge-card{--forge-card-padding: 0;max-width:768px}.grid-container{display:grid;grid-template-columns:repeat(12,1fr);gap:var(--forge-spacing-medium);align-items:center;border-left:4px solid var(--forge-theme-primary);padding:8px}.illustration-container{display:flex}.illustration-container img{max-width:64px;grid-column:1/2}.date-request{grid-column:2/9}.view-all{grid-column:9/13;justify-self:end}";a.define(s);const l={title:"Recipes/Card/Request",decorators:[n(d)],render:()=>i`
    <forge-card>
