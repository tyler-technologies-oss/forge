import{x as n}from"./iframe-B_AFpbKZ.js";import{e as R}from"./class-map-B28AMhZr.js";import{g as j,s as F,G as N,c as D}from"./utils-D0zOu5id.js";import{I as B,h as M,d as V}from"./icon-eJOvSyyv.js";import"./service-adapter-BykFeYYZ.js";import"./button-BjTHYlPk.js";import"./focus-indicator-CyTlhlQD.js";import"./state-layer-BRTtEqto.js";import"./index-CiLSBptl.js";import"./circular-progress-CZq2hNtE.js";const d="forge-button",G={title:"Components/Button",render:e=>{const t=D(d,e);return t.textContent=e.text,t},component:d,argTypes:{...j({tagName:d,exclude:["form","name","value"],controls:{variant:{control:{type:"select"},options:["text","outlined","tonal","filled","raised","link"]},theme:{control:{type:"select"},options:N}}}),text:{control:"text"}},args:{text:"Button",variant:"text",pill:!1,theme:"primary",type:"button",disabled:!1,popoverIcon:!1,dense:!1,fullWidth:!1}},r={},o={...F,render:()=>n`
