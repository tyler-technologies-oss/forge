import{E as d,x as i}from"./iframe-B36M3axR.js";import{o as l}from"./style-map-Df0nJbme.js";import{e as _}from"./class-map-C0mkysGf.js";import{g as x,a as f}from"./utils-JcRLWv5w.js";import"./service-adapter-BykFeYYZ.js";import"./focus-indicator-u5r21UtO.js";import"./card-qr7KxZ6b.js";const g="forge-focus-indicator",F={title:"Components/Focus Indicator",render:e=>{const t=f(e),r=t?l(t):d;return i`
    ...
    `}},a={parameters:{controls:{include:/^--|active|inward/}},render:({active:e,inward:t,...r})=>{const s=f(r),u=s?l(s):d;return i` <button type="button" class=${_({"forge-focus-indicator":!0,"forge-focus-indicator__target":!0,"forge-focus-indicator--active":e,"forge-focus-indicator--inward":t})} style=${u}>CSS-only Button</button> `}},c={parameters:{controls:{include:/^--|active|inward/}},render:({active:e,inward:t,...r})=>{const s=f(r),u=s?l(s):d;return i`
    ...
    `}};var m,p,y;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(y=(p=o.parameters)==null?void 0:p.docs)==null?void 0:y.source}}};var v,w,b;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    controls: {
...
}`,...(V=(M=c.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};const O=["Demo","WithCard","CSSOnly","CSSOnlyWithSentinel"],k=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:a,CSSOnlyWithSentinel:c,Demo:o,WithCard:n,__namedExportsOrder:O,default:F},Symbol.toStringTag,{value:"Module"}));export{a as C,o as D,k as F,n as W};
