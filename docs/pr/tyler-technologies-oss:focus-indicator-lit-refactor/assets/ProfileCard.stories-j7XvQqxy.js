import{x as i}from"./iframe-B_AFpbKZ.js";import{I as a,g as n}from"./icon-eJOvSyyv.js";import{s}from"./decorators-CTyTE-Ei.js";import"./service-adapter-BykFeYYZ.js";import"./card-DWXijWME.js";import"./button-BjTHYlPk.js";import"./focus-indicator-CyTlhlQD.js";import"./state-layer-BRTtEqto.js";import"./icon-button-U4pg755t.js";import"./index-CiLSBptl.js";import"./toolbar-Bv8KpWT6.js";const c="forge-card{--forge-card-padding: 0;width:300px}.container{display:flex;justify-content:center;justify-items:center;flex-direction:column;align-content:center;align-items:center;margin-block-end:var(--forge-spacing-medium)}.container h2{margin:0}.avatar img{width:100px;height:100px;border-radius:50%;margin-block-start:var(--forge-spacing-medium);margin-block-end:var(--forge-spacing-xsmall)}.location{margin-block-end:var(--forge-spacing-medium)}.overflow{overflow:hidden;text-overflow:ellipsis;width:180px;text-align:center;white-space:nowrap}";a.define(n);const l={title:"Recipes/Card/Profile",decorators:[s(c)],render:()=>i`
    <forge-card>
      <div class="container">
        <div class="avatar">
