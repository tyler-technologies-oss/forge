import"./feature-detection-CY6TVbRZ.js";import{D as o}from"./dialog-BAjKLc2i.js";import"./backdrop-Bv12Tb1U.js";import{I as N,B}from"./icon-ANstxuR5.js";import"./index-CiLSBptl.js";import{x as w,B as Y}from"./iframe-BYnq_mNZ.js";import{e as F}from"./class-map-6MdRJEg3.js";import{s as U}from"./decorators-DcOnSkfu.js";import{c as G,g as H}from"./utils-Dc8t8QJe.js";import"./icon-button-BWhggrld.js";import"./focus-indicator-Cgfkaa3d.js";import"./state-layer-BVsNuAhs.js";import"./button-DKtxCkrw.js";import"./scaffold-BjMvQLbF.js";import"./toolbar-CJj-iw1_.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,j=a("forge-dialog-close"),K=a("forge-dialog-before-close"),Q=a("forge-dialog-move-start"),Z=a("forge-dialog-move"),J=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(B);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",K),e.addEventListener("forge-dialog-move-start",Q),e.addEventListener("forge-dialog-move",Z),e.addEventListener("forge-dialog-move-end",J),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=w`
    <forge-scaffold>
