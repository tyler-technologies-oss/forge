import"./feature-detection-C61kIZu7.js";import{D as o}from"./dialog-BLRCFhDt.js";import"./backdrop-UaagznG1.js";import{I as N}from"./icon-DNSPAaK0.js";import"./index-CiLSBptl.js";import{A as w}from"./index-RsKXMDm2.js";import"./lit-element-B3QVTycr.js";import{x as P,B as F}from"./lit-html-CuBe1DX_.js";import{e as Y}from"./class-map-CuXcqkpw.js";import{s as G}from"./decorators-CBntP_d2.js";import{c as H,g as U}from"./utils-DwiQLFey.js";import{a}from"./index-B-lxVbXh.js";import"./icon-button-DJSm0po0.js";import"./focus-indicator-DydcbRnf.js";import"./state-layer-Y8UVngaT.js";import"./button-7EoU3XJS.js";import"./scaffold-CWDbFKLY.js";import"./toolbar-CM1YCrRV.js";const j=a("forge-dialog-close"),Q=a("forge-dialog-before-close"),Z=a("forge-dialog-move-start"),J=a("forge-dialog-move"),K=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=H("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",Q),e.addEventListener("forge-dialog-move-start",Z),e.addEventListener("forge-dialog-move",J),e.addEventListener("forge-dialog-move-end",K),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=P`
    <forge-scaffold>
