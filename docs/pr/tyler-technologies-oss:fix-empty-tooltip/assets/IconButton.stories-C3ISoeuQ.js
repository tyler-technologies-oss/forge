import{x as r}from"./iframe-Dee3S32I.js";import{g as J,s as d,G as Q,c as j}from"./utils-CSNOpiZH.js";import{o as H,q as V,d as G,g as K,f as U,c as Y,I as X}from"./icon-ANstxuR5.js";import{e as Z}from"./class-map-BrYAB3dH.js";import"./feature-detection-CY6TVbRZ.js";import"./icon-button-BWhggrld.js";import"./focus-indicator-Cgfkaa3d.js";import"./index-CiLSBptl.js";import"./state-layer-BVsNuAhs.js";import"./circular-progress-pTvFqlis.js";import"./badge-DBC8huTv.js";import"./label-BleHo323.js";import"./button-DKtxCkrw.js";import"./button-toggle-group-5BDyeLck.js";import"./checkbox-CF9fzMIR.js";import"./switch-ZI6WyDhE.js";const{action:oo}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";X.define([G,H,V,K,U,Y]);const eo=oo("click"),no={title:"Components/Icon Button",render:o=>{const e=j(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=H.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=V.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=G.name,e.appendChild(n)}return e},component:m,argTypes:{...J({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Q},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
