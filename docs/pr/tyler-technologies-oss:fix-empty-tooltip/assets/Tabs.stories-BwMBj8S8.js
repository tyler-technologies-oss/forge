import{E as i,x as c}from"./iframe-Dee3S32I.js";import{g as P,s as l,a as D}from"./utils-CSNOpiZH.js";import{o as E}from"./style-map-SO1rO9WO.js";import{I as V,o as j,d as k}from"./icon-ANstxuR5.js";import"./feature-detection-CY6TVbRZ.js";import"./tab-bar-B8_HM8Do.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",W=O("forge-tab-bar-change"),w=O("forge-tab-select");V.define([j,k]);const F={title:"Components/Tabs",render:e=>{const n={...D(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const B=Object.entries(n).length?E(n):i,x=Array.from({length:e.scrollButtons?20:3}).map((M,C)=>c`<forge-tab>
