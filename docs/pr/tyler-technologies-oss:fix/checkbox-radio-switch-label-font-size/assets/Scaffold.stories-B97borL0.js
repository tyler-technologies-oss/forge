import"./lit-element-CgJqSpuc.js";import{x as m,E as n}from"./lit-html-paDGiEfB.js";import{b as f,g as b}from"./utils-CbH-gv82.js";import{o as v}from"./style-map-C9nPWcxA.js";import{e as _}from"./class-map-D55lQyt8.js";import{s as y}from"./decorators-DJTA_amK.js";import"./constants-CFf81ck9.js";import"./scaffold-CJaNXwdy.js";const q=".scaffold-example{--forge-scaffold-height: 500px;--forge-scaffold-width: 100%}.scaffold-example div[slot],.forge-scaffold>div[class^=forge-scaffold__]{border:2px dashed var(--forge-theme-outline-low);display:flex;flex-direction:column;justify-content:center;align-items:center;padding:var(--forge-spacing-xsmall);margin:var(--forge-spacing-xsmall);box-sizing:border-box}",t="forge-scaffold",h={title:"Components/Scaffold",render:e=>{const a=f(e),o=a?v(a):n;return m`
    ...
    `},component:t,parameters:{actions:{disable:!0}},decorators:[y(q)],argTypes:{...b({tagName:t})},args:{viewport:!1}},i={},s={render:({viewport:e,...a})=>{const o=f(a),g=o?v(o):n;return m`
...
}`,...(p=(u=s.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};const S=["Demo","CSSOnly"],$=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:s,Demo:i,__namedExportsOrder:S,default:h},Symbol.toStringTag,{value:"Module"}));export{s as C,i as D,$ as S};
