import{E as f,x as p}from"./iframe-BFlAyfIN.js";import{g as b,s as x,a as v}from"./utils-C83vs9tY.js";import{o as y}from"./style-map-D7msSEwu.js";import{n as u,e as c}from"./ref-DlSra2Tq.js";import{e as q}from"./class-map-BLl4-78s.js";import"./service-adapter-CffG5Lhq.js";import"./expansion-panel-CtPm9dI4.js";import"./index-5CPwzmQS.js";import"./card-CWlH3rqb.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",$=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),L={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):f,t=c();function m(g){$(),t.value?.setAttribute("aria-expanded",g.detail.toString())}return p`
