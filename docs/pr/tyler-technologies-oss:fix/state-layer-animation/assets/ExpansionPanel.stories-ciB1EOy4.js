import{E as f,x as p}from"./iframe-BhvJVctQ.js";import{g as b,s as x,a as v}from"./utils-CZJYXYdK.js";import{o as y}from"./style-map-COM3iFUN.js";import{n as u,e as c}from"./ref-DestHB6B.js";import{e as q}from"./class-map-u-5b570j.js";import"./service-adapter-CffG5Lhq.js";import"./expansion-panel-CtPm9dI4.js";import"./index-5CPwzmQS.js";import"./card-D93fsX6v.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__,l="forge-expansion-panel",$=d("forge-expansion-panel-toggle"),T=d("forge-expansion-panel-animation-complete"),L={title:"Components/Expansion Panel",component:l,render:e=>{const n=v(e),o=n?y(n):f,t=c();function m(g){$(),t.value?.setAttribute("aria-expanded",g.detail.toString())}return p`
