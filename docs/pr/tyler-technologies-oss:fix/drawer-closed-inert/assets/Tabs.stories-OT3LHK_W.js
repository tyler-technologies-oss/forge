import{E as i,x as c}from"./iframe-Zi_yFChD.js";import{g as f,s as l,a as g}from"./utils-BfYLGoHh.js";import{o as v}from"./style-map-CwoYj-4x.js";import{I as y,p as S,d as I}from"./icon-kuXwuZAY.js";import"./service-adapter-CffG5Lhq.js";import"./tab-bar-YjT6if8r.js";const{action:m}=__STORYBOOK_MODULE_ACTIONS__,d="forge-tab-bar",$=m("forge-tab-bar-change"),T=m("forge-tab-select");y.define([S,I]);const _={title:"Components/Tabs",render:e=>{const n={...g(e)};e.vertical?n["max-width"]="200px":e.scrollButtons&&(n["max-width"]="500px");const u=Object.entries(n).length?v(n):i,p=Array.from({length:e.scrollButtons?20:3}).map((A,b)=>c`<forge-tab>
