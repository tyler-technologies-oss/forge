import"./feature-detection-uS6p5jc8.js";import{D as o}from"./dialog-DvvDkIKd.js";import"./backdrop-BZvWLwDX.js";import{I as N,C as w}from"./icon-B8CdcxqJ.js";import"./index-CiLSBptl.js";import{x as B,B as Y}from"./iframe-B40K0EzB.js";import{e as F}from"./class-map-DUdILVCN.js";import{s as U}from"./decorators-Cu0TqKuG.js";import{c as G,g as H}from"./utils-UeWn3HvG.js";import"./icon-button-C-UNXlAt.js";import"./focus-indicator-BeibAi2h.js";import"./state-layer-C7sW6v-0.js";import"./button-DEhPRUdY.js";import"./scaffold-CGyusmPL.js";import"./toolbar-Byb6kcao.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,j=a("forge-dialog-close"),K=a("forge-dialog-before-close"),Q=a("forge-dialog-move-start"),Z=a("forge-dialog-move"),J=a("forge-dialog-move-end"),V=a("forge-dialog-fullscreen-change"),W=f=>{N.define(w);const t=document.createElement("div"),r=document.createElement("forge-button");r.variant="raised",r.innerText="Open dialog",r.addEventListener("click",()=>e.open=!0),t.appendChild(r);const e=G("forge-dialog",f);e.label="My dialog title",e.description="My dialog description",e.addEventListener("forge-dialog-close",s=>{j(s),e.open=!1}),e.addEventListener("forge-dialog-before-close",K),e.addEventListener("forge-dialog-move-start",Q),e.addEventListener("forge-dialog-move",Z),e.addEventListener("forge-dialog-move-end",J),e.addEventListener("forge-dialog-fullscreen-change",V),t.appendChild(e);const u=B`
    <forge-scaffold>
