import{x as r}from"./iframe-DvzYYDEL.js";import{g as I,s as d,G as C,c as p}from"./utils-bIwC1Fgv.js";import{p as v,r as h,d as y,h as _,g as S,c as $,I as w}from"./icon-kuXwuZAY.js";import{e as E}from"./class-map-DCN2OvKU.js";import"./service-adapter-CffG5Lhq.js";import"./icon-button-CWJaRG64.js";import"./focus-indicator-CYY3hsVP.js";import"./state-layer-gAgMwMHF.js";import"./index-5CPwzmQS.js";import"./circular-progress-_RSm0FGC.js";import"./badge-BfXCcutD.js";import"./label-lXbLGIq1.js";import"./button-7Bd6sVjk.js";import"./button-toggle-group-DdGWRdPb.js";import"./checkbox-B6Kt8dNp.js";import"./switch-DbSCLUhy.js";const{action:O}=__STORYBOOK_MODULE_ACTIONS__,m="forge-icon-button";w.define([y,v,h,_,S,$]);const T=O("click"),x={title:"Components/Icon Button",render:o=>{const e=p(m,o);if(e.addEventListener("click",T),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=v.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=h.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=y.name,e.appendChild(n)}return e},component:m,argTypes:{...I({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:C},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
