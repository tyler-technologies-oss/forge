import{x as n,E as m}from"./iframe-DvzYYDEL.js";import{g as p,s as c,r as g,c as f,a as b}from"./utils-bIwC1Fgv.js";import"./service-adapter-CffG5Lhq.js";import{I as v,E as y}from"./icon-kuXwuZAY.js";import"./index-5CPwzmQS.js";import{s as q}from"./decorators-BAn2eNHG.js";import{e as h}from"./class-map-DCN2OvKU.js";import{o as x}from"./style-map-VLlXInVT.js";import"./card-BOq2mWLY.js";import"./icon-button-CWJaRG64.js";import"./focus-indicator-CYY3hsVP.js";import"./state-layer-gAgMwMHF.js";import"./button-7Bd6sVjk.js";import"./scaffold-BrokB2Ba.js";import"./toolbar-U0axkpKl.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",i="forge-card",C={title:"Components/Card",render:a=>{const s=f(i,a);return s.textContent=a.text,s},component:i,decorators:[q(S)],parameters:{actions:{disable:!0}},argTypes:{...p({tagName:i})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},r={...c,render:()=>(v.define([y]),n`
      <div class="demo-card">
        <forge-card>
