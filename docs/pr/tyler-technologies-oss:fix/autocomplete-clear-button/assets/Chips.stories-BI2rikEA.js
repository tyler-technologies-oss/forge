import{I as b,h as $,i as y,j as S,k as A}from"./icon-kuXwuZAY.js";import{E as n,x as t}from"./iframe-DFzVZZcU.js";import{o as h}from"./style-map-CEjQg-09.js";import{e as c}from"./class-map-O4CmAr6B.js";import{g,G as _,a as u}from"./utils-D7E3BSWv.js";import"./service-adapter-CffG5Lhq.js";import"./avatar-DsoEyNWn.js";import"./chip-set-C5H64dDx.js";import"./focus-indicator-C_d3jG0d.js";import"./state-layer-gAgMwMHF.js";const{action:d}=__STORYBOOK_MODULE_ACTIONS__;b.define([$,y,S,A]);const f="forge-chip-set",m="forge-chip",I=d("forge-chip-select"),O=d("forge-chip-delete"),j=d("forge-chip-navigate"),C={title:"Components/Chips",render:e=>{const a=u(e),r=a?h(a):n;return t`
      <forge-chip-set
        .vertical=${e.vertical}
        .type=${e.type}
        .dense=${e.dense}
