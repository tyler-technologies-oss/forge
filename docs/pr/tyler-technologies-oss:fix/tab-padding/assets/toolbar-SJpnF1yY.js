import{C as v,o as h,B as c,p as g,b as p}from"./constants-DjE6emXm.js";const _=`${v}toolbar`,l={INVERTED:"inverted"},f={...l},b={TOOLBAR:"forge-toolbar"},m={TOOLBAR:`.${b.TOOLBAR}`,BEFORE_START:"slot[name=before-start]",START_SLOT:"slot[name=start]",CENTER_SLOT:"slot[name=center]",END_SLOT:"slot[name=end]",AFTER_END:"slot[name=after-end]"},s={elementName:_,observedAttributes:l,attributes:f,classes:b,selectors:m},u=`<template>
