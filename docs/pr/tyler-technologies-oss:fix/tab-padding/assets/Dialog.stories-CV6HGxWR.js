import{j as x,x as P}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{a as t}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{y as k}from"./index-CIZ3m0iD.js";import{I as z}from"./icon-DjINFoyU.js";import{c as F,g as M}from"./utils-BJOK626P.js";import"./constants-DjE6emXm.js";import"./icon-button-B2LQlK1e.js";import"./focus-indicator-BPFZRBe9.js";import"./index-Dh0vMUMR.js";import"./state-layer-D8bHAvjj.js";import"./button-BZEZMHKM.js";import{D as o}from"./dialog-CJzGa9rz.js";import"./backdrop-BKmy5m9d.js";import"./scaffold-R2qvsZCm.js";import"./toolbar-SJpnF1yY.js";import{s as Y}from"./decorators-EVhofM2Q.js";const j=t("forge-dialog-close"),G=t("forge-dialog-before-close"),q=t("forge-dialog-move-start"),w=t("forge-dialog-move"),B=t("forge-dialog-move-end"),H=t("forge-dialog-fullscreen-change"),$=I=>{z.define(k);const d=document.createElement("div"),c=document.createElement("forge-button");c.variant="raised",c.innerText="Open dialog",c.addEventListener("click",()=>e.open=!0),d.appendChild(c);const e=F("forge-dialog",I);e.setAttribute("aria-labelledby","dialog-title"),e.setAttribute("aria-describedby","dialog-message"),e.addEventListener("forge-dialog-close",N=>{j(N),e.open=!1}),e.addEventListener("forge-dialog-before-close",G),e.addEventListener("forge-dialog-move-start",q),e.addEventListener("forge-dialog-move",w),e.addEventListener("forge-dialog-move-end",B),e.addEventListener("forge-dialog-fullscreen-change",H),d.appendChild(e);const R=P`
    <forge-scaffold>
