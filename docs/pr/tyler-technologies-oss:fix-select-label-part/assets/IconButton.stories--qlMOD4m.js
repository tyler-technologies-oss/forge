import"./lit-element-B3QVTycr.js";import{x as r}from"./lit-html-CuBe1DX_.js";import{a as U}from"./index-B-lxVbXh.js";import{g as X,s as d,G as Y,c as j}from"./utils-Do5MGSMS.js";import{t as H}from"./index-fxMNKkgx.js";import{I as Z}from"./icon-DNSPAaK0.js";import{n as V,p as G,f as J,e as K,c as Q}from"./index-RsKXMDm2.js";import{e as oo}from"./class-map-CuXcqkpw.js";import"./feature-detection-C61kIZu7.js";import"./icon-button-DJSm0po0.js";import"./focus-indicator-DydcbRnf.js";import"./index-CiLSBptl.js";import"./state-layer-Y8UVngaT.js";import"./circular-progress-CbpfkaY8.js";import"./badge-B8aS-qp1.js";import"./label-W_tr_-w0.js";import"./button-7EoU3XJS.js";import"./button-toggle-group-BIaWvq7W.js";import"./checkbox-CZ4HhXrD.js";import"./switch-CVhsVTET.js";const m="forge-icon-button";Z.define([H,V,G,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=j(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=V.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=G.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
