import"./feature-detection-DRCh51Sa.js";import{I as m}from"./icon-B5R9pr_c.js";import"./index-BgGCUUFB.js";import{w as g,x as p}from"./index-CbZAylpk.js";import"./lit-element-JplMEnZc.js";import{x as h}from"./lit-html-paDGiEfB.js";import{e as u}from"./class-map-D55lQyt8.js";import{c as _,g as b}from"./utils-CrLe_RCC.js";import"./switch-O6nuM4w_.js";m.define([g,p]);const r="forge-switch",w={title:"Components/Switch",render:c=>{var o=_(r,c);return o.textContent="off/on",o},component:r,parameters:{actions:{disable:!0}},argTypes:{...b({tagName:r,exclude:["icon","form","labels","name","on","defaultOn","selected"],controls:{labelPosition:{control:"select",options:["start","end"]}}})}},e={},s={parameters:{controls:{include:["on","dense","disabled"]}},args:{checked:!1,dense:!1,disabled:!1},render:({checked:c,dense:o,disabled:f})=>h`
