import"./lit-element-JplMEnZc.js";import{x as r}from"./lit-html-paDGiEfB.js";import{a as U}from"./index-Cf3axooF.js";import{c as z,g as X,s as d,G as Y}from"./utils-DlykE8tv.js";import{t as H}from"./index-fxMNKkgx.js";import{I as Z}from"./icon-B5R9pr_c.js";import{j as V,l as G,b as J,a as K,m as Q}from"./index-CbZAylpk.js";import{e as oo}from"./class-map-D55lQyt8.js";import"./feature-detection-DRCh51Sa.js";import"./icon-button-nddYOp-w.js";import"./focus-indicator-CFAnWQXZ.js";import"./index-BgGCUUFB.js";import"./state-layer-DCupnvce.js";import"./circular-progress-qTjvyVPT.js";import"./badge-Dp1fyGkw.js";import"./label-DRSqqPa2.js";import"./button-BRfTMEeh.js";import"./button-toggle-group-Dvk8YwvA.js";import"./checkbox-qSS9ySuf.js";import"./switch-BhcBCb-7.js";const m="forge-icon-button";Z.define([H,V,G,J,K,Q]);const eo=U("click"),no={title:"Components/Icon Button",render:o=>{const e=z(m,o);if(e.addEventListener("click",eo),o.toggle){e.setAttribute("aria-label","Toggle icon button demo");const n=document.createElement("forge-icon");n.name=V.name,n.slot="on",e.appendChild(n);const t=document.createElement("forge-icon");t.name=G.name,e.appendChild(t)}else{e.setAttribute("aria-label","Icon button demo");const n=document.createElement("forge-icon");n.name=H.name,e.appendChild(n)}return e},component:m,argTypes:{...X({tagName:m,exclude:["form","name","value","type","on"],controls:{variant:{control:{type:"select"},options:["icon","outlined","tonal","filled","raised"]},theme:{control:{type:"select"},options:Y},shape:{control:{type:"select"},options:["circular","squared"]},density:{control:{type:"select"},options:["small","medium","large"]}}})},args:{variant:"icon",theme:"default",disabled:!1,dense:!1,toggle:!1,pressed:!1,shape:"circular",density:"large",popoverIcon:!1}},a={},i={...d,render:()=>r`
