...
recommended to use the browser default root font size for your page because it allows for the best accessibility and usability for your users.`})]})}function p(o={}){const{wrapper:t}={...n(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(s,{...o})}):s(o)}export{p as default};
