import"./lit-element-JplMEnZc.js";import{x as e,E as t}from"./lit-html-paDGiEfB.js";import{a as st}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{b as Z,g as j,s as tt}from"./utils-BgrpGqCf.js";import{I as rt}from"./icon-Ctzrqx63.js";import{o as at,f as lt,p as ct,m as dt,n as gt,q as mt,r as ft,s as ht,j as pt}from"./index-CbZAylpk.js";import{t as bt}from"./index-fxMNKkgx.js";import{o as et}from"./style-map-C9nPWcxA.js";import{e as a}from"./class-map-D55lQyt8.js";import{s as ut}from"./decorators-DOnQS6BC.js";import"./feature-detection-ONR9WHvu.js";import"./list-DjbLwyYT.js";import"./drawer-DOB-rO-k.js";import"./index-BgGCUUFB.js";import"./avatar-Du1LPt_G.js";import"./checkbox-BMGViPZ8.js";import"./label-0TgDsZHI.js";import"./button-ClwhnaJK.js";import"./focus-indicator-I_IrwQSK.js";import"./state-layer-CxIpCmDW.js";import"./button-toggle-group-SI6kj2fb.js";import"./icon-button-D5fTQ0k5.js";import"./switch-BTIWsPYn.js";import"./expansion-panel-D4IeG1MC.js";import"./open-icon-BJwmkNNX.js";rt.define([at,lt,ct,dt,bt,gt,mt,ft,ht,pt]);const z="forge-list",O="forge-list-item",$t="with a long title that spans the seven seas and beyond. It is said it would take a 100 lifetimes to read if you dared to set wrap to true. But only time will tell if this is a talltale or truth be told. May the brave have the courage to toggle such a powerful control.",wt=st("forge-list-item-select"),vt={title:"Components/List",render:n=>{const w=Z(n),M=w?et(w):t,v=[];for(let i=0;i<4;i++){const r=n.wrap?`List item ${i+1} ${$t}`:`List item ${i+1}`,o=n.variant==="button"?e`<button type="button" .disabled=${n.disabled}>${r}</button>`:n.variant==="anchor"?e`<a href="javascript: void(0);">${r}</a>`:e`<span>${r}</span>`;v.push(e`
...
}`,...(Y=(X=$.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const xt=["Demo","Interactive","WithAnchor","NavigationMenu","Expandable","CSSOnly"],Kt=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:$,Demo:f,Expandable:u,Interactive:h,NavigationMenu:b,WithAnchor:p,__namedExportsOrder:xt,default:vt},Symbol.toStringTag,{value:"Module"}));export{$ as C,f as D,u as E,h as I,Kt as L,b as N,p as W};
