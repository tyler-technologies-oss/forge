import"./lit-element-JplMEnZc.js";import{x as u,E as _}from"./lit-html-paDGiEfB.js";import{a as S}from"./index-Cf3axooF.js";import{b as A,g as P,s as R}from"./utils-DlykE8tv.js";import{o as V}from"./style-map-C9nPWcxA.js";import{n as C,e as E}from"./ref-DJjbfkOF.js";import{e as j}from"./class-map-D55lQyt8.js";import"./feature-detection-DRCh51Sa.js";import"./expansion-panel-oNIhRwS4.js";import"./open-icon-jld-uG32.js";import"./index-BgGCUUFB.js";import"./card-C10NOeAn.js";const d="forge-expansion-panel",H=S("forge-expansion-panel-toggle"),O=S("forge-expansion-panel-animation-complete"),W={title:"Components/Expansion Panel",component:d,render:e=>{const n=A(e),o=n?V(n):_,t=E();function p(l){var c;H(),(c=t.value)==null||c.setAttribute("aria-expanded",l.detail.toString())}return u`
    ...
    `},argTypes:{...P({tagName:d,controls:{orientation:{control:"select",options:["horizontal","vertical"]},animationType:{control:"select",options:["default","none"]}}})},args:{open:!1,orientation:"vertical",animationType:"default"}},r={},i={render:({open:e,animationType:n,orientation:o})=>u`
      <forge-card>
    ...
    `},a={...R,render:()=>u`<button id="button-id">Toggle</button>
      <forge-card>
