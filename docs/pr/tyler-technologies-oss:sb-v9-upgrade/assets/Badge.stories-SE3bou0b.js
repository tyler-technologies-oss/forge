import{x as s,E as i}from"./iframe-CE3HZkEz.js";import{g as B,s as c,G as H,c as O,a as V}from"./utils-CEkw6ujh.js";import{I as _,f as $}from"./icon-Bh1zyXYd.js";import{e as C}from"./class-map-BA_CGoG4.js";import{o as W}from"./style-map-Det8BwjZ.js";import"./feature-detection-CY6TVbRZ.js";import"./badge-QkD6UQwd.js";import"./icon-button-CuEKyh48.js";import"./focus-indicator-Cgfkaa3d.js";import"./index-CiLSBptl.js";import"./state-layer-BVsNuAhs.js";const d="forge-badge",N={title:"Components/Badge",render:n=>{const e=O(d,n);return e.innerHTML=n.text,e},component:d,parameters:{actions:{disable:!0}},argTypes:{...B({tagName:d,controls:{theme:{control:"select",options:["default",...H,"info-primary","info-secondary"]}}})},args:{text:"Status",dot:!1,theme:"default",strong:!1,hide:!1}},r={},o={...c,render:()=>s`
    ...
    `}};var m,l,b;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(b=(l=r.parameters)==null?void 0:l.docs)==null?void 0:b.source}}};var h,p,y;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(y=(p=o.parameters)==null?void 0:p.docs)==null?void 0:y.source}}};var u,S,v;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...standaloneStoryParams,
  args: {
    strong: true
  },
...
}`,...(P=(E=g.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};const D=["Demo","Themed","Strong","WithIconButton","CSSOnly"],Y=Object.freeze(Object.defineProperty({__proto__:null,CSSOnly:g,Demo:r,Strong:a,Themed:o,WithIconButton:t,__namedExportsOrder:D,default:N},Symbol.toStringTag,{value:"Module"}));export{Y as B,g as C,r as D,a as S,o as T,t as W};
