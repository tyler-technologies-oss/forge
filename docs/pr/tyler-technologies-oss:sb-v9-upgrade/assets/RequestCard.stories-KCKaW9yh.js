import{x as i}from"./iframe-CE3HZkEz.js";import{I as a,g as s}from"./icon-Bh1zyXYd.js";import{s as n}from"./decorators-B95OLgQg.js";import"./feature-detection-CY6TVbRZ.js";import"./card-jmrzVywe.js";import"./button-CLmfPElC.js";import"./focus-indicator-Cgfkaa3d.js";import"./index-CiLSBptl.js";import"./state-layer-BVsNuAhs.js";import"./label-value-BHIrdMWh.js";const d="forge-card{--forge-card-padding: 0;max-width:768px}.grid-container{display:grid;grid-template-columns:repeat(12,1fr);gap:var(--forge-spacing-medium);align-items:center;border-left:4px solid var(--forge-theme-primary);padding:8px}.illustration-container{display:flex}.illustration-container img{max-width:64px;grid-column:1/2}.date-request{grid-column:2/9}.view-all{grid-column:9/13;justify-self:end}";a.define(s);const l={title:"Recipes/Card/Request",decorators:[n(d)],render:()=>i`
    <forge-card>
