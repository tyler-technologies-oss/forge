import{x as u}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as x,g as b,s as f}from"./utils-CpphmWLJ.js";import"./constants-BMnwgo1j.js";import"./expansion-panel-C_fBVTc2.js";const n="forge-open-icon",v={title:"Components/Open Icon",render:g=>x(n,g),component:n,parameters:{actions:{disable:!0}},argTypes:{...b({tagName:n,controls:{orientation:{type:"string",control:"select",options:["vertical","horizontal","vertical-half","horizontal-half"]},rotation:{type:"string",control:"select",options:["full","half"]}}})},args:{orientation:"vertical"}},e={},o={...f,render:()=>u`
