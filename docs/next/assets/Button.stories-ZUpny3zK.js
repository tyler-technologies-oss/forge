import{x as c}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as W,g as A,s as B,G as E}from"./utils-CpphmWLJ.js";import{t as k}from"./index-fxMNKkgx.js";import{I as C}from"./icon-Sxf3JEPH.js";import"./constants-BMnwgo1j.js";import"./button-DKp5JmaL.js";import"./focus-indicator-WHVXAnYX.js";import"./index-Dh0vMUMR.js";import"./state-layer-DfBT0h4a.js";import"./circular-progress-DYf5A7E9.js";const u="forge-button",R={title:"Components/Button",render:r=>{const t=W(u,r);return t.textContent=r.text,t},component:u,argTypes:{...A({tagName:u,exclude:["form","name","value"],controls:{variant:{control:{type:"select"},options:["text","outlined","filled","raised","link"]},theme:{control:{type:"select"},options:E}}}),text:{control:"text"}},args:{text:"Button",variant:"text",pill:!1,theme:"primary",type:"button",disabled:!1,popoverIcon:!1,dense:!1,fullWidth:!1}},e={},n={...B,render:()=>c`
    ...
    `};var g,l,d;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:"{}",...(d=(l=e.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};var m,f,b;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(b=(f=n.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var p,v,h;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`{
  parameters: {
    controls: {
      include: ['variant']
    }
...
}`,...(O=(L=i.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};const j=["Demo","Variants","Anchor","Themed","WithIcon","WithCircularProgress"],K=Object.freeze(Object.defineProperty({__proto__:null,Anchor:o,Demo:e,Themed:a,Variants:n,WithCircularProgress:i,WithIcon:s,__namedExportsOrder:j,default:R},Symbol.toStringTag,{value:"Module"}));export{o as A,K as B,e as D,a as T,n as V,s as W,i as a};
