import{x as c}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{g as f}from"./utils-CpphmWLJ.js";import"./constants-BMnwgo1j.js";import"./view-switcher-C333nOaf.js";import"./tab-bar-DnLVwjsc.js";import"./state-layer-DfBT0h4a.js";import{n as p,e as b}from"./ref-BorTy8X1.js";import{s as d}from"./decorators-B79PnA5z.js";const o="forge-view{width:100%;height:200px;border:2px dashed grey;display:flex;justify-content:center;align-items:center}forge-tab-bar{margin-bottom:12px}",t="forge-view-switcher",l={title:"Components/View Switcher",render:s=>{const r=b();function m(g){r.value!==void 0&&(r.value.index=g.detail.index)}return c`
    <forge-tab-bar 
      active-tab="0" 
