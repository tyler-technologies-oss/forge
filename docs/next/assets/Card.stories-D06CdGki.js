import{x as g}from"./lit-element-BOOoordI.js";import"./lit-html-BWgXkSvR.js";import{c as q,g as v,s as b}from"./utils-D8HxbzAZ.js";import"./constants-BMnwgo1j.js";import{I as y}from"./icon-CiIDkczu.js";import"./index-Dh0vMUMR.js";import{u as h}from"./index-CWt9cj6R.js";import"./card-Cja0MT5V.js";import"./icon-button-HggojrXv.js";import"./focus-indicator-WHVXAnYX.js";import"./state-layer-CoXZFfb6.js";import"./button-CvtGTUrx.js";import"./scaffold-BBmmvCn_.js";import"./toolbar-ByH3IRVo.js";import{s as x}from"./decorators-CJfHUot4.js";const S=".demo-card{max-width:400px}.demo-card .forge-card-header-container{display:flex;justify-content:space-between;align-items:center}.demo-card .forge-card-header-container h3{margin:0}.demo-card .forge-card-footer{display:flex;justify-content:flex-end;gap:var(--forge-spacing-medium)}.scaffold-card{width:400px;--forge-card-padding: 0;--forge-card-height: 300px}.card-content{padding:16px;margin:0}",r="forge-card",M={title:"Components/Card",render:i=>{const a=q(r,i);return a.textContent=i.text,a},component:r,decorators:[x(S)],parameters:{actions:{disable:!0}},argTypes:{...v({tagName:r})},args:{raised:!1,text:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias quas sed aliquid cumque sunt iste ad, alias quod adipisci? Nulla, libero necessitatibus enim sint nesciunt provident excepturi dolorum pariatur illum?"}},e={},t={...b,render:()=>(y.define([h]),g`
      <div class="demo-card">
        <forge-card>
